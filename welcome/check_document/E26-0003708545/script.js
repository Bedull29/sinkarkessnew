document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708545') {
                const d = {
                    nama_pemilik: 'SARIFAH FITRIANS***',
                    nomor_paspor: 'Passport  X8507249',
                    tanggal_lahir: '1993-12-29',
                    no_dokumen: 'E26-0003708545',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708545.png',
