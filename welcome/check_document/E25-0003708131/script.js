document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708131') {
                const d = {
                    nama_pemilik: 'SABIAH SAP***',
                    nomor_paspor: 'Passport  X8130424',
                    tanggal_lahir: '1960-10-30',
                    no_dokumen: 'E25-0003708131',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708131.png',
