document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708922') {
                const d = {
                    nama_pemilik: 'SITI MAR***',
                    nomor_paspor: 'Passport  X8131799',
                    tanggal_lahir: '1993-03-09',
                    no_dokumen: 'E26-0003708922',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708922.png',
