document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708195') {
                const d = {
                    nama_pemilik: 'MUHAMMAD IHSAN NURHIDA***',
                    nomor_paspor: 'Passport  E5444051',
                    tanggal_lahir: '2006-03-15',
                    no_dokumen: 'E25-0003708195',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708195.png',
