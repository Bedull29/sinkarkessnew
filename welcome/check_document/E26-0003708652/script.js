document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708652') {
                const d = {
                    nama_pemilik: 'USWATUN HASANAH A***',
                    nomor_paspor: 'Passport  X8507913',
                    tanggal_lahir: '2006-12-19',
                    no_dokumen: 'E26-0003708652',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708652.png',
