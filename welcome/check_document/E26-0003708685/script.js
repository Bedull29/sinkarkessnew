document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708685') {
                const d = {
                    nama_pemilik: 'MASUDAH HAMSANI SAB***',
                    nomor_paspor: 'Passport  X8397578',
                    tanggal_lahir: '1972-02-03',
                    no_dokumen: 'E26-0003708685',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708685.png',
