document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708294') {
                const d = {
                    nama_pemilik: 'MUHAMMAD AB***',
                    nomor_paspor: 'Passport  X6931512',
                    tanggal_lahir: '2000-04-24',
                    no_dokumen: 'E25-0003708294',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708294.png',
