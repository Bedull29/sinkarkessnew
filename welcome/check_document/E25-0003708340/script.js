document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708340') {
                const d = {
                    nama_pemilik: 'LATIFAH PARIHIN HASBU***',
                    nomor_paspor: 'Passport  X1625816',
                    tanggal_lahir: '1987-08-01',
                    no_dokumen: 'E25-0003708340',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708340.png',
