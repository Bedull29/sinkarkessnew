document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708602') {
                const d = {
                    nama_pemilik: 'AMAH MASDAR A***',
                    nomor_paspor: 'Passport  X8501549',
                    tanggal_lahir: '1958-02-01',
                    no_dokumen: 'E26-0003708602',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708602.png',
