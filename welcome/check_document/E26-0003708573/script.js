document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708573') {
                const d = {
                    nama_pemilik: 'SYAHRUL JALADRI A***',
                    nomor_paspor: 'Passport  X8504677',
                    tanggal_lahir: '1975-06-02',
                    no_dokumen: 'E26-0003708573',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708573.png',
