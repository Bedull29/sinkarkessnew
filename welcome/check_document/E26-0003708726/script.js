document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708726') {
                const d = {
                    nama_pemilik: 'SUCIPTO JUM***',
                    nomor_paspor: 'Passport  X7136098',
                    tanggal_lahir: '1975-10-06',
                    no_dokumen: 'E26-0003708726',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708726.png',
