document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708245') {
                const d = {
                    nama_pemilik: 'RIZQI AMALIA ZI***',
                    nomor_paspor: 'Passport  E8734201',
                    tanggal_lahir: '1993-10-10',
                    no_dokumen: 'E25-0003708245',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708245.png',
