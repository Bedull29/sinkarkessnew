document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708351') {
                const d = {
                    nama_pemilik: 'TINI SUHA***',
                    nomor_paspor: 'Passport  X8354219',
                    tanggal_lahir: '1974-04-13',
                    no_dokumen: 'E25-0003708351',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708351.png',
