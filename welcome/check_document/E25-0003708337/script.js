document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708337') {
                const d = {
                    nama_pemilik: 'ZURIAH MAZENIH N***',
                    nomor_paspor: 'Passport  X7304296',
                    tanggal_lahir: '1964-05-02',
                    no_dokumen: 'E25-0003708337',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708337.png',
