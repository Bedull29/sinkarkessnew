document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708757') {
                const d = {
                    nama_pemilik: 'NEDRIL KAMIDIN U***',
                    nomor_paspor: 'Passport  C8651708',
                    tanggal_lahir: '1962-11-19',
                    no_dokumen: 'E26-0003708757',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-06-17',
                    valid_until: '2029-07-01',
                    faskes: 'Klinik Kimia Farma Soeta Payakumbuh',
                    dokter: 'ddr. Putri Syeli',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708757.png',
