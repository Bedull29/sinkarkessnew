document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708551') {
                const d = {
                    nama_pemilik: 'RUSMANI MANHARI DUL***',
                    nomor_paspor: 'Passport  X8921775',
                    tanggal_lahir: '1960-11-15',
                    no_dokumen: 'E26-0003708551',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708551.png',
