document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708420') {
                const d = {
                    nama_pemilik: 'TAGOR ENDAR PO***',
                    nomor_paspor: 'Passport  E6405951',
                    tanggal_lahir: '1983-12-23',
                    no_dokumen: 'E25-0003708420',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708420.png',
