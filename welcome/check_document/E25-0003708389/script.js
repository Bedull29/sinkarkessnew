document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708389') {
                const d = {
                    nama_pemilik: 'KASEMO KAS***',
                    nomor_paspor: 'Passport  X8514059',
                    tanggal_lahir: '1960-01-01',
                    no_dokumen: 'E25-0003708389',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708389.png',
