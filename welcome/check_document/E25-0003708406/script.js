document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708406') {
                const d = {
                    nama_pemilik: 'ALFIAN NUGR***',
                    nomor_paspor: 'Passport  X3070164',
                    tanggal_lahir: '1984-09-22',
                    no_dokumen: 'E25-0003708406',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708406.png',
