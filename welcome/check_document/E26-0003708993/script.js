document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708993') {
                const d = {
                    nama_pemilik: 'NORSIDAH ANANG BASRI A***',
                    nomor_paspor: 'Passport  X8505384',
                    tanggal_lahir: '1978-05-05',
                    no_dokumen: 'E26-0003708993',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708993.png',
