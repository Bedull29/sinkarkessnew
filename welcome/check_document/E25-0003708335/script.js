document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708335') {
                const d = {
                    nama_pemilik: 'HAWAA KHALISA HUMAIR***',
                    nomor_paspor: 'Passport  X8389109',
                    tanggal_lahir: '2025-01-29',
                    no_dokumen: 'E25-0003708335',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708335.png',
