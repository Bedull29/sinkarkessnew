document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708848') {
                const d = {
                    nama_pemilik: 'MUJIATI ATM***',
                    nomor_paspor: 'Passport  E7310124',
                    tanggal_lahir: '1967-02-13',
                    no_dokumen: 'E26-0003708848',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2024-07-31',
                    valid_until: '2027-08-14',
                    faskes: 'KLINIK ASY SYAAFI',
                    dokter: 'PUSPA WIDIYAWATI, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708848.png',
