document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708736') {
                const d = {
                    nama_pemilik: 'SISWANTO PONI***',
                    nomor_paspor: 'Passport  X7132623',
                    tanggal_lahir: '1983-05-14',
                    no_dokumen: 'E26-0003708736',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708736.png',
