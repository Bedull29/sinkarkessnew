document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708203') {
                const d = {
                    nama_pemilik: 'SUTANTI KA***',
                    nomor_paspor: 'Passport  X6295637',
                    tanggal_lahir: '1974-12-03',
                    no_dokumen: 'E25-0003708203',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708203.png',
