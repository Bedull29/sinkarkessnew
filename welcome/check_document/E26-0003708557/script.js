document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708557') {
                const d = {
                    nama_pemilik: 'NUR AYNI H ALI E***',
                    nomor_paspor: 'Passport  X9297593',
                    tanggal_lahir: '1966-05-09',
                    no_dokumen: 'E26-0003708557',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708557.png',
