document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708371') {
                const d = {
                    nama_pemilik: 'KHAIRUDDIN MUHAMMAD N***',
                    nomor_paspor: 'Passport  X1925870',
                    tanggal_lahir: '1968-02-26',
                    no_dokumen: 'E25-0003708371',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708371.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-03-24',
