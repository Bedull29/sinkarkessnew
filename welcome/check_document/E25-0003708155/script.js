document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708155') {
                const d = {
                    nama_pemilik: 'HERLAMBANG ASMAT DE***',
                    nomor_paspor: 'Passport  C9949992',
                    tanggal_lahir: '1975-06-13',
                    no_dokumen: 'E25-0003708155',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708155.png',
