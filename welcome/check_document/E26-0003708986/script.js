document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708986') {
                const d = {
                    nama_pemilik: 'ASHIL MARIE THA***',
                    nomor_paspor: 'Passport  X1789616',
                    tanggal_lahir: '1999-07-26',
                    no_dokumen: 'E26-0003708986',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-06-24',
                    valid_until: '2029-06-24',
                    faskes: 'Klinik Griya Husada',
                    dokter: 'dr. Fakhri Haidar Anis',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708986.png',
                    // Second table data (Meningitis)
                    jenis_vaksin2: '',
                    tanggal_vaksin2: '',
                    batch2: '',
                    valid_until2: ''
                ...
                // Populate Second Table (Meningitis)
                setText('res_vaksin2_nama', d.jenis_vaksin2);
                setText('res_vaksin2_tanggal', formatDate(d.tanggal_vaksin2));
                setText('res_vaksin2_batch', d.batch2);
                setText('res_vaksin2_booster', formatDate(d.valid_until2));
