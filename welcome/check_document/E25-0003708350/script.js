document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708350') {
                const d = {
                    nama_pemilik: 'KHOTIB BA***',
                    nomor_paspor: 'Passport  X7802867',
                    tanggal_lahir: '1975-05-17',
                    no_dokumen: 'E25-0003708350',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708350.png',
