document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708782') {
                const d = {
                    nama_pemilik: 'CUCUE SATRI KUT***',
                    nomor_paspor: 'Passport  X8375683',
                    tanggal_lahir: '1983-05-02',
                    no_dokumen: 'E26-0003708782',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708782.png',
