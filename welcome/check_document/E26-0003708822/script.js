document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708822') {
                const d = {
                    nama_pemilik: 'NOR ASIKIN MAS***',
                    nomor_paspor: 'Passport  X6693042',
                    tanggal_lahir: '1955-08-21',
                    no_dokumen: 'E26-0003708822',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708822.png',
