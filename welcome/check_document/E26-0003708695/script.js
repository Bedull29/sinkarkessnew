document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708695') {
                const d = {
                    nama_pemilik: 'SIYEM IRO R***',
                    nomor_paspor: 'Passport  X7136099',
                    tanggal_lahir: '1958-04-01',
                    no_dokumen: 'E26-0003708695',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708695.png',
