document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708170') {
                const d = {
                    nama_pemilik: 'KYKI DARM***',
                    nomor_paspor: 'Passport  X8061207',
                    tanggal_lahir: '1987-09-09',
                    no_dokumen: 'E25-0003708170',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708170.png',
