document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709383') {
                const d = {
                    nama_pemilik: 'MUHAMMAD RAIS AL QA***',
                    nomor_paspor: 'Passport  E4571***',
                    tanggal_lahir: '2014-010-17',
                    no_dokumen: 'E26-0003709383',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709383.png',

                    // Influenza data
                    jenis_vaksin2: 'INFLUENZA',
                    tanggal_vaksin2: '2026-09-03',
                    valid_until2: '2027-09-03'
                };
                ...
                setText('res_tanggal_polio', formatDate('2026-09-03'));
                setText('res_valid_polio', formatDate('2027-09-03'));
