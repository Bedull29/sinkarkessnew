document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708632') {
                const d = {
                    nama_pemilik: 'SAIDAH AJI KAL***',
                    nomor_paspor: 'Passport  E4982794',
                    tanggal_lahir: '1970-01-07',
                    no_dokumen: 'E26-0003708632',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708632.png',
