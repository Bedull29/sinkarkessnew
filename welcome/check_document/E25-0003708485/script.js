document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708485') {
                const d = {
                    nama_pemilik: 'AISYA PUTRI HANI***',
                    nomor_paspor: 'Passport  E9272614',
                    tanggal_lahir: '2010-12-05',
                    no_dokumen: 'E25-0003708485',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2025-01-08',
                    valid_until: '2028-01-08',
                    faskes: 'KLINIK KIMIA FARMA DIPONEGORO PALANGKA RAYA',
                    dokter: 'dr. Devina Aulia Aziza',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708485.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-05-23',
                    valid_until2: '2029-05-23',
