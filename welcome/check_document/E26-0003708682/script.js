document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708682') {
                const d = {
                    nama_pemilik: 'LISDA KUSUMA RAMD***',
                    nomor_paspor: 'Passport  C9772125',
                    tanggal_lahir: '1991-03-26',
                    no_dokumen: 'E26-0003708682',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708682.png',
