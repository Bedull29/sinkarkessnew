document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708817') {
                const d = {
                    nama_pemilik: 'ERIK RUSDI***',
                    nomor_paspor: 'Passport  X7937571',
                    tanggal_lahir: '1994-06-08',
                    no_dokumen: 'E26-0003708817',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708817.png',
