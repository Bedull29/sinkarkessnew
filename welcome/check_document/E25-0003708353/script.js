document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708353') {
                const d = {
                    nama_pemilik: 'MUHAMMAD RAMAD***',
                    nomor_paspor: 'Passport  X8867790',
                    tanggal_lahir: '1999-12-28',
                    no_dokumen: 'E25-0003708353',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708353.png',
