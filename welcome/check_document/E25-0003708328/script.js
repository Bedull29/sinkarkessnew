document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708328') {
                const d = {
                    nama_pemilik: 'ISLAHUL U***',
                    nomor_paspor: 'Passport  X8327702',
                    tanggal_lahir: '2001-12-21',
                    no_dokumen: 'E25-0003708328',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708328.png',
