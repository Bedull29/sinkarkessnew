document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708272') {
                const d = {
                    nama_pemilik: 'SITI HAIRUNISA AH***',
                    nomor_paspor: 'Passport  X7315290',
                    tanggal_lahir: '1979-09-18',
                    no_dokumen: 'E25-0003708272',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708272.png',
