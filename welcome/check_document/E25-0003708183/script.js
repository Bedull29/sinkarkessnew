document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708183') {
                const d = {
                    nama_pemilik: 'JARIAH HA***',
                    nomor_paspor: 'Passport  X6963824',
                    tanggal_lahir: '1953-01-05',
                    no_dokumen: 'E25-0003708183',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708183.png',
