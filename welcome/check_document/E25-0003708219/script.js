document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708219') {
                const d = {
                    nama_pemilik: 'TOYIMA ABDUL KA***',
                    nomor_paspor: 'Passport  E6950781',
                    tanggal_lahir: '1962-02-19',
                    no_dokumen: 'E25-0003708219',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2024-02-29',
                    valid_until: '2027-03-14',
                    faskes: 'RS Ketergantungan Obat Jakarta',
                    dokter: 'DR. ADEIKA MIETA RAHAYU',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708219.png',
