document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708236') {
                const d = {
                    nama_pemilik: 'ISMADI ABDULLAH S***',
                    nomor_paspor: 'Passport  X8185112',
                    tanggal_lahir: '1987-03-08',
                    no_dokumen: 'E25-0003708236',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-12-01',
                    valid_until: '2029-12-01',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708236.png',
