document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708748') {
                const d = {
                    nama_pemilik: 'HAMDAN AINI A***',
                    nomor_paspor: 'Passport  X8397598',
                    tanggal_lahir: '1964-03-14',
                    no_dokumen: 'E26-0003708748',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708748.png',
