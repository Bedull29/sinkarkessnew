document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708261') {
                const d = {
                    nama_pemilik: 'SUMARNO SARIDI',
                    nomor_paspor: 'Passport  X8700645',
                    tanggal_lahir: '1967-08-14',
                    no_dokumen: 'E25-0003708261',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708261.png',
