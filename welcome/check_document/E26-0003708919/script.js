document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708919') {
                const d = {
                    nama_pemilik: 'SUGIYEM DUL ROH***',
                    nomor_paspor: 'Passport  X9562881',
                    tanggal_lahir: '1963-07-12',
                    no_dokumen: 'E26-0003708919',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708919.png',
