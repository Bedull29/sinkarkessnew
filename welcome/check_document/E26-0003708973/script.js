document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708973') {
                const d = {
                    nama_pemilik: 'PARIDAH ILMI AS***',
                    nomor_paspor: 'Passport  X9775778',
                    tanggal_lahir: '1960-03-10',
                    no_dokumen: 'E26-0003708973',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708973.png',
