document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708221') {
                const d = {
                    nama_pemilik: 'SARLINDA M NA***',
                    nomor_paspor: 'Passport  X7061221',
                    tanggal_lahir: '1982-07-11',
                    no_dokumen: 'E25-0003708221',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708221.png',
