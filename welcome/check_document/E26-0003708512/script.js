document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708512') {
                const d = {
                    nama_pemilik: 'MARNO SARIWA***',
                    nomor_paspor: 'Passport  X8964886',
                    tanggal_lahir: '1956-04-14',
                    no_dokumen: 'E26-0003708512',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708512.png',
