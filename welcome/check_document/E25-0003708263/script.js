document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708263') {
                const d = {
                    nama_pemilik: 'CHODIJAH AMAT NAS***',
                    nomor_paspor: 'Passport  C9922091',
                    tanggal_lahir: '1967-08-12',
                    no_dokumen: 'E25-0003708263',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708263.png',
