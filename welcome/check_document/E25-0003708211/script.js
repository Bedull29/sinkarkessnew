document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708211') {
                const d = {
                    nama_pemilik: 'ETI MAW***',
                    nomor_paspor: 'Passport  X7937587',
                    tanggal_lahir: '1955-01-01',
                    no_dokumen: 'E25-0003708211',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708211.png',
