document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708496') {
                const d = {
                    nama_pemilik: 'FAHRAINI DJA***',
                    nomor_paspor: 'Passport  E6687626',
                    tanggal_lahir: '1981-09-03',
                    no_dokumen: 'E25-0003708496',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-06-03',
                    valid_until: '2029-06-03',
                    faskes: 'Klinik Cempaka Lima',
                    dokter: 'dr. Arifdian',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708496.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-06-03',
                    valid_until2: '2027-06-03'
                };
