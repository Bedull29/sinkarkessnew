document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709381') {
                const d = {
                    nama_pemilik: 'RTS NADIEN FAIZA AZI***',
                    nomor_paspor: 'Passport  X9604***',
                    tanggal_lahir: '2006-03-25',
                    no_dokumen: 'E26-0003709381',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709381.png',
