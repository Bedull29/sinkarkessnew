document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708628') {
                const d = {
                    nama_pemilik: 'ARPAH RU***',
                    nomor_paspor: 'Passport  X8507180',
                    tanggal_lahir: '1971-07-01',
                    no_dokumen: 'E26-0003708628',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708628.png',
