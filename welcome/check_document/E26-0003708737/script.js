document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708737') {
                const d = {
                    nama_pemilik: 'SARMI PAI***',
                    nomor_paspor: 'Passport  X7132644',
                    tanggal_lahir: '1961-07-13',
                    no_dokumen: 'E26-0003708737',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708737.png',
