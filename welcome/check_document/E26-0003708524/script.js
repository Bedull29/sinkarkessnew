document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708524') {
                const d = {
                    nama_pemilik: 'DAVID ZULKARNAIN ASTA***',
                    nomor_paspor: 'Passport  X9032554',
                    tanggal_lahir: '2009-02-04',
                    no_dokumen: 'E26-0003708524',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708524.png',
