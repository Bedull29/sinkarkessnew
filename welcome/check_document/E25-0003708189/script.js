document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708189') {
                const d = {
                    nama_pemilik: 'RAZUWI RAZ***',
                    nomor_paspor: 'Passport  X8184332',
                    tanggal_lahir: '1977-07-01',
                    no_dokumen: 'E25-0003708189',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708189.png',
