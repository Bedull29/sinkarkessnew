document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708463') {
                const d = {
                    nama_pemilik: 'FATIMAH MUHIT KAR***',
                    nomor_paspor: 'Passport  X8156787',
                    tanggal_lahir: '1962-03-13',
                    no_dokumen: 'E25-0003708463',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708463.png',
