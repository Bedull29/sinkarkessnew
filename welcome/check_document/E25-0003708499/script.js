document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708499') {
                const d = {
                    nama_pemilik: 'NUGROHO PURWO CAR***',
                    nomor_paspor: 'Passport  X8519104',
                    tanggal_lahir: '2005-05-09',
                    no_dokumen: 'E25-0003708499',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-06-05',
                    valid_until: '2029-06-05',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708499.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-06-05',
                    valid_until2: '2027-06-05'
                };
