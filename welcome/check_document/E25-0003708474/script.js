document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708474') {
                const d = {
                    nama_pemilik: 'HADINAN SUHAIMI HA***',
                    nomor_paspor: 'Passport  X9009276',
                    tanggal_lahir: '1985-12-20',
                    no_dokumen: 'E25-0003708474',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708474.png',
