document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708260') {
                const d = {
                    nama_pemilik: 'IPAYANTI MA***',
                    nomor_paspor: 'Passport  X8700646',
                    tanggal_lahir: '1979-12-07',
                    no_dokumen: 'E25-0003708260',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708260.png',
