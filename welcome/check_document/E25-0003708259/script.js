document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708259') {
                const d = {
                    nama_pemilik: 'NENI HERAW***',
                    nomor_paspor: 'Passport  X7309343',
                    tanggal_lahir: '1982-03-10',
                    no_dokumen: 'E25-0003708259',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708259.png',
