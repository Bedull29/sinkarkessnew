document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708251') {
                const d = {
                    nama_pemilik: 'HANDRIYANTI HASBI AH***',
                    nomor_paspor: 'Passport  E1125554',
                    tanggal_lahir: '1976-08-11',
                    no_dokumen: 'E25-0003708251',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708251.png',
