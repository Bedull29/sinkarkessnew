document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708349') {
                const d = {
                    nama_pemilik: 'YAYAH SUHA***',
                    nomor_paspor: 'Passport  X7802907',
                    tanggal_lahir: '1981-07-02',
                    no_dokumen: 'E25-0003708349',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708349.png',
