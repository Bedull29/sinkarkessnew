document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708231') {
                const d = {
                    nama_pemilik: 'MARIANI HARA***',
                    nomor_paspor: 'Passport  C9762775',
                    tanggal_lahir: '1973-08-10',
                    no_dokumen: 'E25-0003708231',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708231.png',
