document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708638') {
                const d = {
                    nama_pemilik: 'ADI FAHR***',
                    nomor_paspor: 'Passport  X8506958',
                    tanggal_lahir: '1981-10-05',
                    no_dokumen: 'E26-0003708638',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708638.png',
