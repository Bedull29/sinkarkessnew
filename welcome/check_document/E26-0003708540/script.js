document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708540') {
                const d = {
                    nama_pemilik: 'ERNAWATI MOHAMAD TARM***',
                    nomor_paspor: 'Passport  X8507799',
                    tanggal_lahir: '1977-01-01',
                    no_dokumen: 'E26-0003708540',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708540.png',
