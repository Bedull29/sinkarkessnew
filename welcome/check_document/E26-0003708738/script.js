document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708738') {
                const d = {
                    nama_pemilik: 'PONIJAN B***',
                    nomor_paspor: 'Passport  X7132630',
                    tanggal_lahir: '1971-07-10',
                    no_dokumen: 'E26-0003708738',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708738.png',
