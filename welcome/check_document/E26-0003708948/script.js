document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708948') {
                const d = {
                    nama_pemilik: 'MATHARI MIS***',
                    nomor_paspor: 'Passport  X9130799',
                    tanggal_lahir: '1966-07-01',
                    no_dokumen: 'E26-0003708948',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708948.png',
