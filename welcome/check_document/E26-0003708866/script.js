document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708866') {
                const d = {
                    nama_pemilik: 'JONIH SUPRIA***',
                    nomor_paspor: 'Passport  X7942543',
                    tanggal_lahir: '1974-02-05',
                    no_dokumen: 'E26-0003708866',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708866.png',
