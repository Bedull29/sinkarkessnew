document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708842') {
                const d = {
                    nama_pemilik: 'MAHYUNI A***',
                    nomor_paspor: 'Passport  E9922801',
                    tanggal_lahir: '1957-05-07',
                    no_dokumen: 'E26-0003708842',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708842.png',
