document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708223') {
                const d = {
                    nama_pemilik: 'DARMASYIAH MUHAM***',
                    nomor_paspor: 'Passport  X8063282',
                    tanggal_lahir: '1958-10-10',
                    no_dokumen: 'E25-0003708223',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708223.png',
