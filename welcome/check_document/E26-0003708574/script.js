document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708574') {
                const d = {
                    nama_pemilik: 'MISNA IRIANI DARS***',
                    nomor_paspor: 'Passport  X8504678',
                    tanggal_lahir: '1976-05-02',
                    no_dokumen: 'E26-0003708574',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708574.png',
