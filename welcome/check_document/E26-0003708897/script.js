document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708897') {
                const d = {
                    nama_pemilik: 'MARY***',
                    nomor_paspor: 'Passport  X9260972',
                    tanggal_lahir: '1968-07-01',
                    no_dokumen: 'E26-0003708897',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708897.png',
