document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708871') {
                const d = {
                    nama_pemilik: 'MUHAMMAD NAZARULLAH ZAKA***',
                    nomor_paspor: 'Passport  X9260628',
                    tanggal_lahir: '1970-02-25',
                    no_dokumen: 'E26-0003708871',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708871.png',
