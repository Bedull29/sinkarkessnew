document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708793') {
                const d = {
                    nama_pemilik: 'AMIRULLAH RA***',
                    nomor_paspor: 'Passport  X9700541',
                    tanggal_lahir: '1996-01-16',
                    no_dokumen: 'E26-0003708793',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708793.png',
