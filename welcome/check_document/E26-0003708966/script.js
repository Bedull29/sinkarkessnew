document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708966') {
                const d = {
                    nama_pemilik: 'RENDY OKARI***',
                    nomor_paspor: 'Passport  X7819433',
                    tanggal_lahir: '1986-10-16',
                    no_dokumen: 'E26-0003708966',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708966.png',
