document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708521') {
                const d = {
                    nama_pemilik: 'SITI AIS***',
                    nomor_paspor: 'Passport  X8464798',
                    tanggal_lahir: '1959-11-29',
                    no_dokumen: 'E26-0003708521',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708521.png',
