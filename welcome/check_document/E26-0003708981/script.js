document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708981') {
                const d = {
                    nama_pemilik: 'JURAINI MA***',
                    nomor_paspor: 'Passport  X8506616',
                    tanggal_lahir: '1965-08-01',
                    no_dokumen: 'E26-0003708981',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708981.png',
