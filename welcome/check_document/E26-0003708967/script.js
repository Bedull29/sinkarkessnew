document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708967') {
                const d = {
                    nama_pemilik: 'HAMDANI KAD***',
                    nomor_paspor: 'Passport  E7309949',
                    tanggal_lahir: '1958-08-11',
                    no_dokumen: 'E26-0003708967',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708967.png',
