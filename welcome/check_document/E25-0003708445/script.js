document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708445') {
                const d = {
                    nama_pemilik: 'MARLIHAH MUCHAMMAD ISM***',
                    nomor_paspor: 'Passport  X9050432',
                    tanggal_lahir: '1970-02-01',
                    no_dokumen: 'E25-0003708445',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-05-09',
                    valid_until: '2029-05-09',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708445.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-05-09',
                    valid_until2: '2027-05-09'
                };
