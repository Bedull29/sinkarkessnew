document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708722') {
                const d = {
                    nama_pemilik: 'SUPIYAH MART***',
                    nomor_paspor: 'Passport  X7136205',
                    tanggal_lahir: '1972-01-01',
                    no_dokumen: 'E26-0003708722',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708722.png',
