document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708355') {
                const d = {
                    nama_pemilik: 'FLORYANDAR***',
                    nomor_paspor: 'Passport  E8943366',
                    tanggal_lahir: '1970-01-15',
                    no_dokumen: 'E25-0003708355',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708355.png',
