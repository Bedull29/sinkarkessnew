document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708589') {
                const d = {
                    nama_pemilik: 'AHMAD KUS***',
                    nomor_paspor: 'Passport  C9180739',
                    tanggal_lahir: '1963-06-05',
                    no_dokumen: 'E26-0003708589',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708589.png',
