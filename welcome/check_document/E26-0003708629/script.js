document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708629') {
                const d = {
                    nama_pemilik: 'RUSMIATI YUN***',
                    nomor_paspor: 'Passport  X8507650',
                    tanggal_lahir: '1988-07-01',
                    no_dokumen: 'E26-0003708629',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708629.png',
