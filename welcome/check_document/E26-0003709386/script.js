document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709386') {
                const d = {
                    nama_pemilik: 'MUHAMMAD HAMZAH AL R***',
                    nomor_paspor: 'Passport  E0642***',
                    tanggal_lahir: '2021-11-10',
                    no_dokumen: 'E26-0003709386',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709386.png',
