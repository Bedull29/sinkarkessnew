document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708649') {
                const d = {
                    nama_pemilik: 'MASRAH BUST***',
                    nomor_paspor: 'Passport  X8507898',
                    tanggal_lahir: '1952-11-17',
                    no_dokumen: 'E26-0003708649',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708649.png',
