document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708749') {
                const d = {
                    nama_pemilik: 'SITI ZAI***',
                    nomor_paspor: 'Passport  E5987235',
                    tanggal_lahir: '1981-10-28',
                    no_dokumen: 'E26-0003708749',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708749.png',
