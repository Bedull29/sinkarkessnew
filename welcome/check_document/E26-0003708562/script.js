document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708562') {
                const d = {
                    nama_pemilik: 'ROSDIWATI SAUDIN J***',
                    nomor_paspor: 'Passport  E7194835',
                    tanggal_lahir: '1982-10-24',
                    no_dokumen: 'E26-0003708562',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708562.png',
