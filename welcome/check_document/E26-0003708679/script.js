document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708679') {
                const d = {
                    nama_pemilik: 'AINUN SU***',
                    nomor_paspor: 'Passport  X8506489',
                    tanggal_lahir: '1972-05-06',
                    no_dokumen: 'E26-0003708679',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708679.png',
