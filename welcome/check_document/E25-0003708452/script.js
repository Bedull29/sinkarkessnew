document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708452') {
                const d = {
                    nama_pemilik: 'M YUSUP MA***',
                    nomor_paspor: 'Passport  X8318771',
                    tanggal_lahir: '1971-03-12',
                    no_dokumen: 'E25-0003708452',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708452.png',
