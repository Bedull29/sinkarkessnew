document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708956') {
                const d = {
                    nama_pemilik: 'ASMAWATI A***',
                    nomor_paspor: 'Passport  X8490241',
                    tanggal_lahir: '1983-04-03',
                    no_dokumen: 'E26-0003708956',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708956.png',
