document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708831') {
                const d = {
                    nama_pemilik: 'SITI AISAH MUSLI***',
                    nomor_paspor: 'Passport  E0859379',
                    tanggal_lahir: '1969-09-13',
                    no_dokumen: 'E26-0003708831',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708831.png',
