document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708426') {
                const d = {
                    nama_pemilik: 'FARIS NUR AMB***',
                    nomor_paspor: 'Passport  E9398921',
                    tanggal_lahir: '2007-02-08',
                    no_dokumen: 'E25-0003708426',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708426.png',
