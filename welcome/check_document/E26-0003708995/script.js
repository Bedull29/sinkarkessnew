document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708995') {
                const d = {
                    nama_pemilik: 'RABIAH AMJAH A***',
                    nomor_paspor: 'Passport  X8505682',
                    tanggal_lahir: '1965-08-13',
                    no_dokumen: 'E26-0003708995',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708995.png',
