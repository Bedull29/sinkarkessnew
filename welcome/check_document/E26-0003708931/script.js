document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708931') {
                const d = {
                    nama_pemilik: 'TARWAN DULAH MUN***',
                    nomor_paspor: 'Passport  X9562883',
                    tanggal_lahir: '1965-03-17',
                    no_dokumen: 'E26-0003708931',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708931.png',
