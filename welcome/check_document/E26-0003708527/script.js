document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708527') {
                const d = {
                    nama_pemilik: 'ISNADI MUCHY***',
                    nomor_paspor: 'Passport  X9030888',
                    tanggal_lahir: '1953-10-29',
                    no_dokumen: 'E26-0003708527',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708527.png',
