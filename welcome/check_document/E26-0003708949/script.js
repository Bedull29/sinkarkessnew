document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708949') {
                const d = {
                    nama_pemilik: 'SUHAYYAH MUHAM***',
                    nomor_paspor: 'Passport  X9512140',
                    tanggal_lahir: '1973-05-15',
                    no_dokumen: 'E26-0003708949',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708949.png',
