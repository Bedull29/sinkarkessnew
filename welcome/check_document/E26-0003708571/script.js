document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708571') {
                const d = {
                    nama_pemilik: 'UNI WANINGSIH SUTAR***',
                    nomor_paspor: 'Passport  E1944512',
                    tanggal_lahir: '1972-07-19',
                    no_dokumen: 'E26-0003708571',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708571.png',
