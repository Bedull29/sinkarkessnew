document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708659') {
                const d = {
                    nama_pemilik: 'DARSONO ATENG FA***',
                    nomor_paspor: 'Passport  X7942425',
                    tanggal_lahir: '1970-01-01',
                    no_dokumen: 'E26-0003708659',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708659.png',
