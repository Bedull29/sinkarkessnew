document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708890') {
                const d = {
                    nama_pemilik: 'AFRI YA***',
                    nomor_paspor: 'Passport  X9260967',
                    tanggal_lahir: '1987-04-04',
                    no_dokumen: 'E26-0003708890',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708890.png',
