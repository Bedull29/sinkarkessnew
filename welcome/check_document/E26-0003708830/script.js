document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708830') {
                const d = {
                    nama_pemilik: 'MUHAMMAD ALDI SAMS***',
                    nomor_paspor: 'Passport  X6693099',
                    tanggal_lahir: '2004-02-23',
                    no_dokumen: 'E26-0003708830',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708830.png',
