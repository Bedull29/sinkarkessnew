document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708143') {
                const d = {
                    nama_pemilik: 'HERU MUFLIHUDIN SYA***',
                    nomor_paspor: 'Passport  E1875812',
                    tanggal_lahir: '1984-12-18',
                    no_dokumen: 'E25-0003708143',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708143.png',
