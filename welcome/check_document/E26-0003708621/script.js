document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708621') {
                const d = {
                    nama_pemilik: 'HAIRANI HA***',
                    nomor_paspor: 'Passport  X8507144',
                    tanggal_lahir: '1966-06-29',
                    no_dokumen: 'E26-0003708621',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708621.png',
