document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708248') {
                const d = {
                    nama_pemilik: 'ASEP KURNIA***',
                    nomor_paspor: 'Passport  X8542359',
                    tanggal_lahir: '1978-09-16',
                    no_dokumen: 'E25-0003708248',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708248.png',
