document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708315') {
                const d = {
                    nama_pemilik: 'UBAID AL AF***',
                    nomor_paspor: 'Passport  X6663257',
                    tanggal_lahir: '2010-06-15',
                    no_dokumen: 'E25-0003708315',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708315.png',
