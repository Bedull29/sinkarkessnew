document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708680') {
                const d = {
                    nama_pemilik: 'OLIH SOLIHIN BAN***',
                    nomor_paspor: 'Passport  X2791445',
                    tanggal_lahir: '1955-07-06',
                    no_dokumen: 'E26-0003708680',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708680.png',
