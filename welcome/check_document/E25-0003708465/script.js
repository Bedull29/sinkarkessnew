document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708465') {
                const d = {
                    nama_pemilik: 'RINAE SADIN MAK***',
                    nomor_paspor: 'Passport  X9008395',
                    tanggal_lahir: '1981-04-05',
                    no_dokumen: 'E25-0003708465',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708465.png',
