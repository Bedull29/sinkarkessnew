document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708808') {
                const d = {
                    nama_pemilik: 'SAMMALA SAM***',
                    nomor_paspor: 'Passport  X8577569',
                    tanggal_lahir: '1953-12-31',
                    no_dokumen: 'E26-0003708808',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708808.png',
