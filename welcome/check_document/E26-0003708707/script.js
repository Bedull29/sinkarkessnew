document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708707') {
                const d = {
                    nama_pemilik: 'SULISIAH SAREN***',
                    nomor_paspor: 'Passport  X7136213',
                    tanggal_lahir: '1971-02-22',
                    no_dokumen: 'E26-0003708707',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708707.png',
