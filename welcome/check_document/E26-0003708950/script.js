document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708950') {
                const d = {
                    nama_pemilik: 'TUTI HARY***',
                    nomor_paspor: 'Passport  X7946112',
                    tanggal_lahir: '1967-08-08',
                    no_dokumen: 'E26-0003708950',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708950.png',
