document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708971') {
                const d = {
                    nama_pemilik: 'VIDDY RAMDH***',
                    nomor_paspor: 'Passport  X8505533',
                    tanggal_lahir: '1991-03-23',
                    no_dokumen: 'E26-0003708971',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708971.png',
