document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708686') {
                const d = {
                    nama_pemilik: 'LIA SAG***',
                    nomor_paspor: 'Passport  X8397681',
                    tanggal_lahir: '2003-05-14',
                    no_dokumen: 'E26-0003708686',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708686.png',
