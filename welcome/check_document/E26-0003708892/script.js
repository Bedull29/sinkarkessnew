document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708892') {
                const d = {
                    nama_pemilik: 'ALAWI***',
                    nomor_paspor: 'Passport  X9260998',
                    tanggal_lahir: '1948-07-01',
                    no_dokumen: 'E26-0003708892',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708892.png',
