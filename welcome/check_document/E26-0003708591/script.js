document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708591') {
                const d = {
                    nama_pemilik: 'SYAHRAN M ASRA NAW***',
                    nomor_paspor: 'Passport  C9876770',
                    tanggal_lahir: '1958-08-31',
                    no_dokumen: 'E26-0003708591',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708591.png',
