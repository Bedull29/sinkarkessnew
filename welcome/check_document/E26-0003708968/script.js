document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708968') {
                const d = {
                    nama_pemilik: 'NASIMAN MU***',
                    nomor_paspor: 'Passport  X8383182',
                    tanggal_lahir: '1958-06-06',
                    no_dokumen: 'E26-0003708968',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708968.png',
