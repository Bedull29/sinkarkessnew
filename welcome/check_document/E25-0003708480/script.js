document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708480') {
                const d = {
                    nama_pemilik: 'ALIYAH AMRANI WA***',
                    nomor_paspor: 'Passport  X9009018',
                    tanggal_lahir: '1984-03-20',
                    no_dokumen: 'E25-0003708480',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708480.png',
