document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708941') {
                const d = {
                    nama_pemilik: 'SULHAN SAHA***',
                    nomor_paspor: 'Passport  X9701732',
                    tanggal_lahir: '1970-07-01',
                    no_dokumen: 'E26-0003708941',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708941.png',
