document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708960') {
                const d = {
                    nama_pemilik: 'HOIRUL ABIDIN SIRE***',
                    nomor_paspor: 'Passport  X8681230',
                    tanggal_lahir: '1989-09-21',
                    no_dokumen: 'E26-0003708960',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708960.png',
