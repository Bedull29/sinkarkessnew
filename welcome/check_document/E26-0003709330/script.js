document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709330') {
                const d = {
                    nama_pemilik: 'IMAN TAU***',
                    nomor_paspor: 'Passport  X9725***',
                    tanggal_lahir: '1977-12-06',
                    no_dokumen: 'E26-0003709330',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709330.png',
