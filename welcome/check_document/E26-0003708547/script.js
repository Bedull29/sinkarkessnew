document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708547') {
                const d = {
                    nama_pemilik: 'ERNI SETIAW***',
                    nomor_paspor: 'Passport  X8776916',
                    tanggal_lahir: '1981-01-19',
                    no_dokumen: 'E26-0003708547',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708547.png',
