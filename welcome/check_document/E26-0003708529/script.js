document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708529') {
                const d = {
                    nama_pemilik: 'YUTIMAH SUCH***',
                    nomor_paspor: 'Passport  X8465367',
                    tanggal_lahir: '1963-06-20',
                    no_dokumen: 'E26-0003708529',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-06-11',
                    valid_until: '2029-06-11',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708529.png',
