document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708918') {
                const d = {
                    nama_pemilik: 'ROMLAH SAR***',
                    nomor_paspor: 'Passport  X9562945',
                    tanggal_lahir: '1968-09-03',
                    no_dokumen: 'E26-0003708918',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708918.png',
