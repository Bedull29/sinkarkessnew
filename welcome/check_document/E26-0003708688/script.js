document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708688') {
                const d = {
                    nama_pemilik: 'RANIA LEVINA HUMA***',
                    nomor_paspor: 'Passport  X8168312',
                    tanggal_lahir: '2018-07-09',
                    no_dokumen: 'E26-0003708688',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708688.png',
