document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709378') {
                const d = {
                    nama_pemilik: 'DJAMI DJONO DJAKI***',
                    nomor_paspor: 'Passport  X9121***',
                    tanggal_lahir: '1949-06-30',
                    no_dokumen: 'E26-0003709378',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709378.png',
