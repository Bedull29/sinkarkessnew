document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708663') {
                const d = {
                    nama_pemilik: 'EVA MUGI RAH***',
                    nomor_paspor: 'Passport  X7944016',
                    tanggal_lahir: '1992-02-20',
                    no_dokumen: 'E26-0003708663',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708663.png',
