document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708167') {
                const d = {
                    nama_pemilik: 'SITI MASYIT***',
                    nomor_paspor: 'Passport  X8061817',
                    tanggal_lahir: '1989-10-27',
                    no_dokumen: 'E25-0003708167',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708167.png',
