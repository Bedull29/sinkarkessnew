document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708479') {
                const d = {
                    nama_pemilik: 'RAMLAH IMUN DAH***',
                    nomor_paspor: 'Passport  E9272606',
                    tanggal_lahir: '1960-06-07',
                    no_dokumen: 'E25-0003708479',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708479.png',
