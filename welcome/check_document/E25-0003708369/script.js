document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708369') {
                const d = {
                    nama_pemilik: 'RIZNA PUSPAS***',
                    nomor_paspor: 'Passport  E2024190',
                    tanggal_lahir: '1995-07-22',
                    no_dokumen: 'E25-0003708369',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2024-10-11',
                    valid_until: '2027-10-25',
                    faskes: 'KLINIK WORKS',
                    dokter: 'dr. JOSE HADY PUTERA CLINIC MEDICAL DOCTOR',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708369.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-02-26',
                    valid_until2: '2027-02-26',
