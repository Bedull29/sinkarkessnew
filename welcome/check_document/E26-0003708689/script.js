document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708689') {
                const d = {
                    nama_pemilik: 'LIYA KRISTIY***',
                    nomor_paspor: 'Passport  E5064364',
                    tanggal_lahir: '1989-08-31',
                    no_dokumen: 'E26-0003708689',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708689.png',
