document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708449') {
                const d = {
                    nama_pemilik: 'AISYA NURFAZZILLA FANSY***',
                    nomor_paspor: 'Passport  E7093793',
                    tanggal_lahir: '2012-02-12',
                    no_dokumen: 'E25-0003708449',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-05-17',
                    valid_until: '2029-05-17',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708449.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-05-17',
                    valid_until2: '2027-05-17'
                };
