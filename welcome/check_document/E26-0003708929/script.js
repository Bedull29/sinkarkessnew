document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708929') {
                const d = {
                    nama_pemilik: 'SURATMI RA***',
                    nomor_paspor: 'Passport  X8255051',
                    tanggal_lahir: '1972-07-16',
                    no_dokumen: 'E26-0003708929',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708929.png',
