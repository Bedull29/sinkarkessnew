document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708751') {
                const d = {
                    nama_pemilik: 'MARYUDI SLAMET RIY***',
                    nomor_paspor: 'Passport  X9559841',
                    tanggal_lahir: '1958-03-08',
                    no_dokumen: 'E26-0003708751',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708751.png',
