document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708470') {
                const d = {
                    nama_pemilik: 'MUHAMMAD BADRUDDIN ZAINUL HA***',
                    nomor_paspor: 'Passport  C9404673',
                    tanggal_lahir: '1987-05-09',
                    no_dokumen: 'E25-0003708470',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708470.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-05-23',
                    valid_until2: '2027-05-23'
                };
