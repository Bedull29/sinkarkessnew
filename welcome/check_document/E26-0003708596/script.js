document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708596') {
                const d = {
                    nama_pemilik: 'ALIAH ACIL ANT***',
                    nomor_paspor: 'Passport  E8004315',
                    tanggal_lahir: '1971-07-05',
                    no_dokumen: 'E26-0003708596',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708596.png',
