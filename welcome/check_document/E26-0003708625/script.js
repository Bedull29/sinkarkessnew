document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708625') {
                const d = {
                    nama_pemilik: 'FITRIATI ASM***',
                    nomor_paspor: 'Passport  X8507588',
                    tanggal_lahir: '1971-11-18',
                    no_dokumen: 'E26-0003708625',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708625.png',
