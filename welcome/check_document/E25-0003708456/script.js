document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708456') {
                const d = {
                    nama_pemilik: 'MUHAMMAD AL FATIH FANSY***',
                    nomor_paspor: 'Passport  E7093789',
                    tanggal_lahir: '2018-05-11',
                    no_dokumen: 'E25-0003708456',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-05-18',
                    valid_until: '2029-05-18',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708456.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-05-18',
                    valid_until2: '2027-05-18'
                };
