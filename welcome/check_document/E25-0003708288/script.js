document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708288') {
                const d = {
                    nama_pemilik: 'ALI SHOHIBUL W***',
                    nomor_paspor: 'Passport  C8938407',
                    tanggal_lahir: '2012-05-12',
                    no_dokumen: 'E25-0003708288',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2022-03-21',
                    valid_until: '2022-04-04',
                    faskes: 'KLINIK PRATAMA YAKRIJA',
                    dokter: 'dr.IBNU ZAMSA',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708288.png',
