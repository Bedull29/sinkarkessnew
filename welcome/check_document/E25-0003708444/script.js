document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708444') {
                const d = {
                    nama_pemilik: 'SAIDAH SA***',
                    nomor_paspor: 'Passport  X7849797',
                    tanggal_lahir: '1969-03-02',
                    no_dokumen: 'E25-0003708444',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708444.png',
