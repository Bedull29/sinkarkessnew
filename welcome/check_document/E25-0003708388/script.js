document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708388') {
                const d = {
                    nama_pemilik: 'TARSIYEM SI***',
                    nomor_paspor: 'Passport  X8514211',
                    tanggal_lahir: '1948-07-08',
                    no_dokumen: 'E25-0003708388',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708388.png',
