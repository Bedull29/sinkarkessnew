document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708395') {
                const d = {
                    nama_pemilik: 'MARATUN ARB***',
                    nomor_paspor: 'Passport  X8530092',
                    tanggal_lahir: '1980-01-28',
                    no_dokumen: 'E25-0003708395',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708395.png',
