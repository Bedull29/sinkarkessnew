document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708721') {
                const d = {
                    nama_pemilik: 'SRIYANI MAR***',
                    nomor_paspor: 'Passport  X7136220',
                    tanggal_lahir: '1979-08-21',
                    no_dokumen: 'E26-0003708721',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708721.png',
