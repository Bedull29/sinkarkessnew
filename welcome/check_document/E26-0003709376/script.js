document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709376') {
                const d = {
                    nama_pemilik: 'SUNAWIYA SAR***',
                    nomor_paspor: 'Passport  Y0082***',
                    tanggal_lahir: '1941-05-10',
                    no_dokumen: 'E26-0003709376',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709376.png',
