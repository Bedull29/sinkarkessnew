document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708458') {
                const d = {
                    nama_pemilik: 'PARMIN YITNO SUMA***',
                    nomor_paspor: 'Passport  X9055811',
                    tanggal_lahir: '1973-12-12',
                    no_dokumen: 'E25-0003708458',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708458.png',
