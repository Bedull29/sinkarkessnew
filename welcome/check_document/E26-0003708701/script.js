document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708701') {
                const d = {
                    nama_pemilik: 'DAUD DAMSIR YU***',
                    nomor_paspor: 'Passport  X7136296',
                    tanggal_lahir: '1966-02-01',
                    no_dokumen: 'E26-0003708701',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708701.png',
