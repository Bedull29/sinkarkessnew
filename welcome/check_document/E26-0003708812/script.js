document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708812') {
                const d = {
                    nama_pemilik: 'TASIN DAENG MAL***',
                    nomor_paspor: 'Passport  X8578615',
                    tanggal_lahir: '1963-12-11',
                    no_dokumen: 'E26-0003708812',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708812.png',
