document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708214') {
                const d = {
                    nama_pemilik: 'CUCU SUDRAJAT BAS***',
                    nomor_paspor: 'Passport  X4541669',
                    tanggal_lahir: '1958-08-12',
                    no_dokumen: 'E25-0003708214',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708214.png',
