document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708635') {
                const d = {
                    nama_pemilik: 'NOR IZATIL HAS***',
                    nomor_paspor: 'Passport  X8507157',
                    tanggal_lahir: '2002-06-02',
                    no_dokumen: 'E26-0003708635',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708635.png',
