document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708179') {
                const d = {
                    nama_pemilik: 'HUSNIAH JAKFAR AH***',
                    nomor_paspor: 'Passport  E4425594',
                    tanggal_lahir: '1971-08-10',
                    no_dokumen: 'E25-0003708179',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708179.png',
