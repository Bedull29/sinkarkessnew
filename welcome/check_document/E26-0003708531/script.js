document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708531') {
                const d = {
                    nama_pemilik: 'FAEYSA KHAD***',
                    nomor_paspor: 'Passport  E6244127',
                    tanggal_lahir: '2014-08-19',
                    no_dokumen: 'E26-0003708531',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2024-07-01',
                    valid_until: '2027-07-15',
                    faskes: 'KLINIK DR.ANY S MEDICA,CENTRAL OF JAVA PURWODADI -GROBOGAN',
                    dokter: 'DR ANY SULISTYANINGKRUM,MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708531.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-06-11',
                    valid_until2: '2027-06-11',
                    faskes2: 'Klinik Utama CT-Klinik',
                    dokter2: 'MASAYU PRAKASITA, MD',
                ...
                // Polio Faskes & Dokter
                const faskesDokter2 = (d.faskes2 || '-') + '<br>' + (d.dokter2 || '-');
                const faskesEl2 = document.getElementById('res_vaksin2_faskes');
                if (faskesEl2) faskesEl2.innerHTML = faskesDokter2;
