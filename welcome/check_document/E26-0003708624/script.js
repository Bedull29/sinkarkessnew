document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708624') {
                const d = {
                    nama_pemilik: 'MAWARNI ASM***',
                    nomor_paspor: 'Passport  X8507587',
                    tanggal_lahir: '1974-04-11',
                    no_dokumen: 'E26-0003708624',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708624.png',
