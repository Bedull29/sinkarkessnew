document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708674') {
                const d = {
                    nama_pemilik: 'MUHAMMAD FIRMAN ALAMS***',
                    nomor_paspor: 'Passport  C9768819',
                    tanggal_lahir: '2006-08-29',
                    no_dokumen: 'E26-0003708674',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2024-12-01',
                    valid_until: '2027-12-15',
                    faskes: 'KLINIK ARAFA',
                    dokter: 'DR H FAISAL SOEPARIANTO, M.SI',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708674.png',
