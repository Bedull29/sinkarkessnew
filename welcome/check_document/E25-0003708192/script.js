document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708192') {
                const d = {
                    nama_pemilik: 'TINAMI TAY***',
                    nomor_paspor: 'Passport  X7152901',
                    tanggal_lahir: '1963-07-01',
                    no_dokumen: 'E25-0003708192',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708192.png',
