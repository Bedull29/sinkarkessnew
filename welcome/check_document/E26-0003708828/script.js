document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708828') {
                const d = {
                    nama_pemilik: 'SYIFA KAMILA AZZA***',
                    nomor_paspor: 'Passport  E9922573',
                    tanggal_lahir: '2009-06-20',
                    no_dokumen: 'E26-0003708828',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708828.png',
