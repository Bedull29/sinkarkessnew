document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708378') {
                const d = {
                    nama_pemilik: 'NALA DHIYA KHA***',
                    nomor_paspor: 'Passport  E1701900',
                    tanggal_lahir: '2010-04-11',
                    no_dokumen: 'E25-0003708378',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708378png',
