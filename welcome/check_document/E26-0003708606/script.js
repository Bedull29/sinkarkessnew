document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708606') {
                const d = {
                    nama_pemilik: 'PARIDA ARI***',
                    nomor_paspor: 'Passport  X8375501',
                    tanggal_lahir: '1985-04-28',
                    no_dokumen: 'E26-0003708606',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708606.png',
