document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708565') {
                const d = {
                    nama_pemilik: 'AWAT KARW***',
                    nomor_paspor: 'Passport  X8976809',
                    tanggal_lahir: '1965-05-08',
                    no_dokumen: 'E26-0003708565',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708565.png',
