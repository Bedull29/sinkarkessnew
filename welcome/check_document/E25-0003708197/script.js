document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708197') {
                const d = {
                    nama_pemilik: 'YENI HERDIANI SAUN SUTI***',
                    nomor_paspor: 'Passport  E0469844',
                    tanggal_lahir: '1977-06-08',
                    no_dokumen: 'E25-0003708197',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708197.png',
