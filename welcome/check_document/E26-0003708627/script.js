document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708627') {
                const d = {
                    nama_pemilik: 'FATMAH KA***',
                    nomor_paspor: 'Passport  X8507589',
                    tanggal_lahir: '1982-03-27',
                    no_dokumen: 'E26-0003708627',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708627.png',
