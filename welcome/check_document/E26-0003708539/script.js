document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708539') {
                const d = {
                    nama_pemilik: 'NIKEM MARN***',
                    nomor_paspor: 'Passport  X8470392',
                    tanggal_lahir: '1973-07-21',
                    no_dokumen: 'E26-0003708539',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708539.png',
