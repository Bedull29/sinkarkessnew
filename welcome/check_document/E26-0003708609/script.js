document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708609') {
                const d = {
                    nama_pemilik: 'QAIREN MALIKA AZZA***',
                    nomor_paspor: 'Passport  X8375510',
                    tanggal_lahir: '2013-03-27',
                    no_dokumen: 'E26-0003708609',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708609.png',
