document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708488') {
                const d = {
                    nama_pemilik: 'SRI PURWANING***',
                    nomor_paspor: 'Passport  X9306280',
                    tanggal_lahir: '1981-08-09',
                    no_dokumen: 'E25-0003708488',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-05-28',
                    valid_until: '2029-05-28',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708488.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-05-28',
                    valid_until2: '2027-05-28'
                };
