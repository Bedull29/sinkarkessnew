document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709358') {
                const d = {
                    nama_pemilik: 'ASRI WAHY***',
                    nomor_paspor: 'Passport  C9046***',
                    tanggal_lahir: '1992-05-31',
                    no_dokumen: 'E26-0003709358',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709358.png',
