document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709357') {
                const d = {
                    nama_pemilik: 'ZAINUDIN SULAIMAN HU***',
                    nomor_paspor: 'Passport  C9046***',
                    tanggal_lahir: '1990-11-01',
                    no_dokumen: 'E26-0003709357',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709357.png',
