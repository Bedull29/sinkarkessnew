document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708237') {
                const d = {
                    nama_pemilik: 'FATHAHILLAH AL QAUT***',
                    nomor_paspor: 'Passport  E6231343',
                    tanggal_lahir: '2007-02-18',
                    no_dokumen: 'E25-0003708237',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708237.png',
