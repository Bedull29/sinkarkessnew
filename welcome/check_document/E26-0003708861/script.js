document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708861') {
                const d = {
                    nama_pemilik: 'NANDANG HO***',
                    nomor_paspor: 'Passport  X7944743',
                    tanggal_lahir: '1960-02-18',
                    no_dokumen: 'E26-0003708861',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708861.png',
