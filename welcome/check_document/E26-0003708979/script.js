document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708979') {
                const d = {
                    nama_pemilik: 'HAMIDAH HAMR***',
                    nomor_paspor: 'Passport  X8507234',
                    tanggal_lahir: '1973-03-10',
                    no_dokumen: 'E26-0003708979',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708979.png',
