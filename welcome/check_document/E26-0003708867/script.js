document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708867') {
                const d = {
                    nama_pemilik: 'YURNI BAS***',
                    nomor_paspor: 'Passport  E9922570',
                    tanggal_lahir: '1955-12-12',
                    no_dokumen: 'E26-0003708867',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708867.png',
