document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709355') {
                const d = {
                    nama_pemilik: 'EKA PURWA***',
                    nomor_paspor: 'Passport  E8440***',
                    tanggal_lahir: '2008-03-31',
                    no_dokumen: 'E26-0003709355',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709355.png',
