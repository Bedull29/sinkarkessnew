document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709341') {
                const d = {
                    nama_pemilik: 'SIDIK HERDIYANS***',
                    nomor_paspor: 'Passport  C9314***',
                    tanggal_lahir: '1999-06-28',
                    no_dokumen: 'E26-0003709341',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709341.png',
