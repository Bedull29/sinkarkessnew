document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708732') {
                const d = {
                    nama_pemilik: 'SAKIYEM SARI***',
                    nomor_paspor: 'Passport  X7132575',
                    tanggal_lahir: '1969-04-12',
                    no_dokumen: 'E26-0003708732',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708732.png',
