document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708541') {
                const d = {
                    nama_pemilik: 'RIZKA RAMADH***',
                    nomor_paspor: 'Passport  X8507291',
                    tanggal_lahir: '2016-06-22',
                    no_dokumen: 'E26-0003708541',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708541.png',
