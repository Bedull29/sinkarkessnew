document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708365') {
                const d = {
                    nama_pemilik: 'SASHA NURAISYAH BAMB***',
                    nomor_paspor: 'Passport  X3640010',
                    tanggal_lahir: '1994-11-01',
                    no_dokumen: 'E25-0003708365',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708365.png',
