document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708285') {
                const d = {
                    nama_pemilik: 'LISWATI SUYARMAN WAKI***',
                    nomor_paspor: 'Passport  X3518609',
                    tanggal_lahir: '1982-09-08',
                    no_dokumen: 'E25-0003708285',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708285.png',
