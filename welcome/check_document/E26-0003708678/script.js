document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708678') {
                const d = {
                    nama_pemilik: 'ASRANI S***',
                    nomor_paspor: 'Passport  X8506492',
                    tanggal_lahir: '1969-01-08',
                    no_dokumen: 'E26-0003708678',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708678.png',
