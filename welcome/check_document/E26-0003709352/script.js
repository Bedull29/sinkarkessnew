document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709352') {
                const d = {
                    nama_pemilik: 'YUANSAH MAP NA***',
                    nomor_paspor: 'Passport  X9742***',
                    tanggal_lahir: '1979-09-15',
                    no_dokumen: 'E26-0003709352',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-07-16',
                    valid_until: '2029-07-16',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709352.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-07-16',
                    valid_until2: '2027-07-16'
                };
