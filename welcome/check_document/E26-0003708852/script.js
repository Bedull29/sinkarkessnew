document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708852') {
                const d = {
                    nama_pemilik: 'SRF MUNA ZAHIRAH AL MUTA***',
                    nomor_paspor: 'Passport  X5132178',
                    tanggal_lahir: '2000-04-19',
                    no_dokumen: 'E26-0003708852',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708852.png',
