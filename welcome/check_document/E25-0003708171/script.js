document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708171') {
                const d = {
                    nama_pemilik: 'MUHAMMAD FATIH ALKH***',
                    nomor_paspor: 'Passport  X8061164',
                    tanggal_lahir: '2019-09-18',
                    no_dokumen: 'E25-0003708171',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708171.png',
