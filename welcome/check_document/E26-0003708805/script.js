document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708805') {
                const d = {
                    nama_pemilik: 'NUR DAENG MANGA***',
                    nomor_paspor: 'Passport  X8578614',
                    tanggal_lahir: '1974-11-10',
                    no_dokumen: 'E26-0003708805',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708805.png',
