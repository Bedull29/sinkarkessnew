document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708754') {
                const d = {
                    nama_pemilik: 'HAETAMI SAN***',
                    nomor_paspor: 'Passport  X9559886',
                    tanggal_lahir: '1941-06-30',
                    no_dokumen: 'E26-0003708754',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708754.png',
