document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708111') {
                const d = {
                    nama_pemilik: 'NURLAILA ANGGRA***',
                    nomor_paspor: 'Passport X7731539',
                    tanggal_lahir: '1989-05-04',
                    no_dokumen: 'E25-0003708111',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708111new.png',
