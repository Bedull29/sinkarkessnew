document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708146') {
                const d = {
                    nama_pemilik: 'UJANG AHMADZENAL MUTA***',
                    nomor_paspor: 'Passport  C8383596',
                    tanggal_lahir: '1970-04-03',
                    no_dokumen: 'E25-0003708146',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708146.png',
