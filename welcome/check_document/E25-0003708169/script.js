document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708169') {
                const d = {
                    nama_pemilik: 'FAJAR ZULFI***',
                    nomor_paspor: 'Passport  X8061187',
                    tanggal_lahir: '1994-11-17',
                    no_dokumen: 'E25-0003708169',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708169.png',
