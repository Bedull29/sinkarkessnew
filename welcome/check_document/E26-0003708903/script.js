document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708903') {
                const d = {
                    nama_pemilik: 'AZIZAH MUHAMMAD ***',
                    nomor_paspor: 'Passport  X9261006',
                    tanggal_lahir: '1978-08-07',
                    no_dokumen: 'E26-0003708903',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708903.png',
