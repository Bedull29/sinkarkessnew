document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708525') {
                const d = {
                    nama_pemilik: 'KURNAIN HERN***',
                    nomor_paspor: 'Passport  X9032562',
                    tanggal_lahir: '1968-09-29',
                    no_dokumen: 'E26-0003708525',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708525.png',
