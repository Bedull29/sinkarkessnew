document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708151') {
                const d = {
                    nama_pemilik: 'SUMIYATIH SUDI JI***',
                    nomor_paspor: 'Passport  E1309083',
                    tanggal_lahir: '1969-07-14',
                    no_dokumen: 'E25-0003708151',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708151.png',
