document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708618') {
                const d = {
                    nama_pemilik: 'ZAINUDDIN MUHAMMAD YU***',
                    nomor_paspor: 'Passport  X8507117',
                    tanggal_lahir: '1990-11-13',
                    no_dokumen: 'E26-0003708618',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708618.png',
