document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708166') {
                const d = {
                    nama_pemilik: 'MUHAMMAD GUNA***',
                    nomor_paspor: 'Passport  X8061818',
                    tanggal_lahir: '2000-09-23',
                    no_dokumen: 'E25-0003708166',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708166.png',
