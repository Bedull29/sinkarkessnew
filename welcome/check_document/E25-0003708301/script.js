document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708301') {
                const d = {
                    nama_pemilik: 'AYU EVANDA WIDIYAW***',
                    nomor_paspor: 'Passport  E7020998',
                    tanggal_lahir: '1997-10-13',
                    no_dokumen: 'E25-0003708301',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708301.png',
