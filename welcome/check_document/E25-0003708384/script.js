document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708384') {
                const d = {
                    nama_pemilik: 'THOYYIB ANSH***',
                    nomor_paspor: 'Passport  X8514947',
                    tanggal_lahir: '1977-07-12',
                    no_dokumen: 'E25-0003708384',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708384.png',
