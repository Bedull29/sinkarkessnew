document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708431') {
                const d = {
                    nama_pemilik: 'AHMAD SO***',
                    nomor_paspor: 'Passport  X7814578',
                    tanggal_lahir: '1967-08-05',
                    no_dokumen: 'E25-0003708431',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708431.png',
