document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708863') {
                const d = {
                    nama_pemilik: 'AMIN HIDA***',
                    nomor_paspor: 'Passport  X7943186',
                    tanggal_lahir: '1956-01-21',
                    no_dokumen: 'E26-0003708863',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708863.png',
