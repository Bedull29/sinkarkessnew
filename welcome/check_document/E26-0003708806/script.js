document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708806') {
                const d = {
                    nama_pemilik: 'MISLAM BUSAI***',
                    nomor_paspor: 'Passport  X8578613',
                    tanggal_lahir: '1948-07-01',
                    no_dokumen: 'E26-0003708806',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708806.png',
