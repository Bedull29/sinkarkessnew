document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708253') {
                const d = {
                    nama_pemilik: 'YUL RAHMAN***',
                    nomor_paspor: 'Passport  X6662671',
                    tanggal_lahir: '1962-06-26',
                    no_dokumen: 'E25-0003708253',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708253.png',
