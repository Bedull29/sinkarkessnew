document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708719') {
                const d = {
                    nama_pemilik: 'SUPARJO PAI***',
                    nomor_paspor: 'Passport  X7136202',
                    tanggal_lahir: '1970-08-18',
                    no_dokumen: 'E26-0003708719',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708719.png',
