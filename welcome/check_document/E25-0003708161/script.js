document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708161') {
                const d = {
                    nama_pemilik: 'MUHAMMAD SYIB***',
                    nomor_paspor: 'Passport  X4818568',
                    tanggal_lahir: '2004-03-19',
                    no_dokumen: 'E25-0003708161',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708161.png',
