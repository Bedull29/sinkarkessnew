document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708405') {
                const d = {
                    nama_pemilik: 'REZY FAKHR***',
                    nomor_paspor: 'Passport  E3223264',
                    tanggal_lahir: '2006-05-22',
                    no_dokumen: 'E25-0003708405',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708405.png',
