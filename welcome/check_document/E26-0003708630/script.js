document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708630') {
                const d = {
                    nama_pemilik: 'MUHAMMAD RIZKY A***',
                    nomor_paspor: 'Passport  X8383219',
                    tanggal_lahir: '1999-01-01',
                    no_dokumen: 'E26-0003708630',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708630.png',
