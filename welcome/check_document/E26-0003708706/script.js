document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708706') {
                const d = {
                    nama_pemilik: 'AHMAT HUSIN BA***',
                    nomor_paspor: 'Passport  X7136107',
                    tanggal_lahir: '1964-09-15',
                    no_dokumen: 'E26-0003708706',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708706.png',
