document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709362') {
                const d = {
                    nama_pemilik: 'ARIATI A***',
                    nomor_paspor: 'Passport  X9005***',
                    tanggal_lahir: '1971-09-10',
                    no_dokumen: 'E26-0003709362',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709362.png',
