document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708784') {
                const d = {
                    nama_pemilik: 'SURIANO SITUH SI***',
                    nomor_paspor: 'Passport  X8375625',
                    tanggal_lahir: '1969-02-08',
                    no_dokumen: 'E26-0003708784',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708784.png',
