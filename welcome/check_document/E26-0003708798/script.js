document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708798') {
                const d = {
                    nama_pemilik: 'NUR A***',
                    nomor_paspor: 'Passport  X9698372',
                    tanggal_lahir: '1969-10-21',
                    no_dokumen: 'E26-0003708798',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708798.png',
