document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708586') {
                const d = {
                    nama_pemilik: 'SAIPUL KARIM AH***',
                    nomor_paspor: 'Passport  X8505238',
                    tanggal_lahir: '1973-02-03',
                    no_dokumen: 'E26-0003708586',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708586.png',
