document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708850') {
                const d = {
                    nama_pemilik: 'SAYYID ACHMAD MOH***',
                    nomor_paspor: 'Passport  X8572266',
                    tanggal_lahir: '2007-09-17',
                    no_dokumen: 'E26-0003708850',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708850.png',
