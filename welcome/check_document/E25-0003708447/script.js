document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708447') {
                const d = {
                    nama_pemilik: 'SASKIYA SILV***',
                    nomor_paspor: 'Passport  X7550875',
                    tanggal_lahir: '2003-05-25',
                    no_dokumen: 'E25-0003708447',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708447.png',
