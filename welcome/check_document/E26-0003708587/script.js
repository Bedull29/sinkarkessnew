document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708587') {
                const d = {
                    nama_pemilik: 'FIKRI HAIKAL SYAH***',
                    nomor_paspor: 'Passport  X8504676',
                    tanggal_lahir: '1998-06-16',
                    no_dokumen: 'E26-0003708587',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708587.png',
