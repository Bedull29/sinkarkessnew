document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708783') {
                const d = {
                    nama_pemilik: 'NURIWATI RASIDI PAO***',
                    nomor_paspor: 'Passport  X8375672',
                    tanggal_lahir: '1984-12-22',
                    no_dokumen: 'E26-0003708783',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708783.png',
