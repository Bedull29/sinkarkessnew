document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708112') {
                const d = {
                    nama_pemilik: 'FARIDAH ALI MUHAM***',
                    nomor_paspor: 'Passport X8170698',
                    tanggal_lahir: '1949-10-28',
                    no_dokumen: 'E25-0003708112',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708112new.png',
