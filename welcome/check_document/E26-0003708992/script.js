document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708992') {
                const d = {
                    nama_pemilik: 'NORLIYANTI M SA***',
                    nomor_paspor: 'Passport  X8504755',
                    tanggal_lahir: '1989-01-30',
                    no_dokumen: 'E26-0003708992',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708992.png',
