document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708296') {
                const d = {
                    nama_pemilik: 'WILDANI N***',
                    nomor_paspor: 'Passport  X6931514',
                    tanggal_lahir: '2005-10-19',
                    no_dokumen: 'E25-0003708296',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708296.png',
