document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708446') {
                const d = {
                    nama_pemilik: 'YUNITA KAIDIR MAH***',
                    nomor_paspor: 'Passport  C9536343',
                    tanggal_lahir: '1963-01-05',
                    no_dokumen: 'E25-0003708446',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-05-13',
                    valid_until: '2029-05-13',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708446.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-05-13',
                    valid_until2: '2027-05-13'
                };
