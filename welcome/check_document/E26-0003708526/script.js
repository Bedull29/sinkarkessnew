document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708526') {
                const d = {
                    nama_pemilik: 'RIDWAN ABDUL WA***',
                    nomor_paspor: 'Passport  X9032563',
                    tanggal_lahir: '1965-11-15',
                    no_dokumen: 'E26-0003708526',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708526.png',
