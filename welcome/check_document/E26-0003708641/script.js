document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708641') {
                const d = {
                    nama_pemilik: 'MUHAMMAD QALIY***',
                    nomor_paspor: 'Passport  X8506957',
                    tanggal_lahir: '2006-07-27',
                    no_dokumen: 'E26-0003708641',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708641.png',
