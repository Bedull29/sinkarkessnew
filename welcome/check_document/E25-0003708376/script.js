document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708376') {
                const d = {
                    nama_pemilik: 'KHAILA MARITZA ALE***',
                    nomor_paspor: 'Passport  E3338688',
                    tanggal_lahir: '2018-08-28',
                    no_dokumen: 'E25-0003708376',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708376.png',
