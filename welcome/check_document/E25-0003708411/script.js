document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708411') {
                const d = {
                    nama_pemilik: 'SELLI MARL***',
                    nomor_paspor: 'Passport  X8075845',
                    tanggal_lahir: '1994-09-07',
                    no_dokumen: 'E25-0003708411',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708411.png',
