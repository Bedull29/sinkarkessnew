document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708998') {
                const d = {
                    nama_pemilik: 'SAIDAH ARDI AT***',
                    nomor_paspor: 'Passport  X8505684',
                    tanggal_lahir: '1968-05-27',
                    no_dokumen: 'E26-0003708998',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708998.png',
