document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709373') {
                const d = {
                    nama_pemilik: 'NURBILQIS ABDULLAH ZAHR***',
                    nomor_paspor: 'Passport  C8533***',
                    tanggal_lahir: '1970-08-16',
                    no_dokumen: 'E26-0003709373',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-09-02',
                    valid_until: '2029-09-02',
                    faskes: 'Surabaya (Pelabuhan Laut Tg Perak) / Rsi Wonosobo /',
                    dokter: 'HENDRA IRMAWAN',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709373.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-09-02',
                    valid_until2: '-'
                };
                ...
                setText('res_vaksin2_batch', 'SANOFI 43751706');
