document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708854') {
                const d = {
                    nama_pemilik: 'SUGENG SUKA***',
                    nomor_paspor: 'Passport  E6464479',
                    tanggal_lahir: '1980-02-10',
                    no_dokumen: 'E26-0003708854',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2024-12-09',
                    valid_until: '2027-12-23',
                    faskes: 'RSI WONOSOBO',
                    dokter: 'dr. DIMYATI AHMAD, Sp.B',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708854.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-06-10',
                    valid_until2: '2027-06-10',
                    faskes2: 'KLINIK PMC',
                    dokter2: 'DR. FIDIANSJAH',
