document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708976') {
                const d = {
                    nama_pemilik: 'HERMA WATI HU***',
                    nomor_paspor: 'Passport  X8506722',
                    tanggal_lahir: '1982-05-17',
                    no_dokumen: 'E26-0003708976',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708976.png',
