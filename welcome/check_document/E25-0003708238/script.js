document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708238') {
                const d = {
                    nama_pemilik: 'RIZKA MU***',
                    nomor_paspor: 'Passport  X8185890',
                    tanggal_lahir: '1999-01-02',
                    no_dokumen: 'E25-0003708238',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708238.png',
