document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708925') {
                const d = {
                    nama_pemilik: 'SUJARWO SUP***',
                    nomor_paspor: 'Passport  X7136242',
                    tanggal_lahir: '1976-10-10',
                    no_dokumen: 'E26-0003708925',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708925.png',
