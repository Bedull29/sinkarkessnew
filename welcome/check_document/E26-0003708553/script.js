document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708553') {
                const d = {
                    nama_pemilik: 'NAZWA RIZQIA RAHMAD***',
                    nomor_paspor: 'Passport  X7533575',
                    tanggal_lahir: '2011-08-17',
                    no_dokumen: 'E26-0003708553',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708553.png',
