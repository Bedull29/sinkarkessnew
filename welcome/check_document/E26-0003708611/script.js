document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708611') {
                const d = {
                    nama_pemilik: 'ELAWATI LE***',
                    nomor_paspor: 'Passport  X8507033',
                    tanggal_lahir: '1996-11-24',
                    no_dokumen: 'E26-0003708611',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708611.png',
