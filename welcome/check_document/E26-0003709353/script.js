document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709353') {
                const d = {
                    nama_pemilik: 'MOCH MASYKUR AFA***',
                    nomor_paspor: 'Passport  X9493***',
                    tanggal_lahir: '1989-03-28',
                    no_dokumen: 'E26-0003709353',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-07-06',
                    valid_until: '2029-07-06',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709353.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-07-06',
                    valid_until2: '2027-07-06'
                };
