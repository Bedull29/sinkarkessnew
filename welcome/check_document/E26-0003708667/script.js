document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708667') {
                const d = {
                    nama_pemilik: 'HASANAH ABDUL G***',
                    nomor_paspor: 'Passport  X8507932',
                    tanggal_lahir: '1977-03-01',
                    no_dokumen: 'E26-0003708667',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708667.png',
