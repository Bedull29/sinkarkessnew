document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708495') {
                const d = {
                    nama_pemilik: 'MASRI SA***',
                    nomor_paspor: 'Passport  X8254119',
                    tanggal_lahir: '1949-08-17',
                    no_dokumen: 'E25-0003708495',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708495.png',
