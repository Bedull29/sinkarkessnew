document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708494') {
                const d = {
                    nama_pemilik: 'MUHAROM MA***',
                    nomor_paspor: 'Passport  E3933959',
                    tanggal_lahir: '1987-09-20',
                    no_dokumen: 'E25-0003708494',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708494.png',
