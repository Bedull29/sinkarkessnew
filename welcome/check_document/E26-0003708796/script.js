document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708796') {
                const d = {
                    nama_pemilik: 'NUR ISTIQA***',
                    nomor_paspor: 'Passport  X9698376',
                    tanggal_lahir: '1990-03-27',
                    no_dokumen: 'E26-0003708796',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708796.png',
