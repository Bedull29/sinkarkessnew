document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708953') {
                const d = {
                    nama_pemilik: 'HESTY KARIMAW***',
                    nomor_paspor: 'Passport  E4854672',
                    tanggal_lahir: '1985-04-10',
                    no_dokumen: 'E26-0003708953',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708953.png',
