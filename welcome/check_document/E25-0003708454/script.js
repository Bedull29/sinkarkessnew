document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708454') {
                const d = {
                    nama_pemilik: 'SITI ROH***',
                    nomor_paspor: 'Passport  X7820943',
                    tanggal_lahir: '1973-12-08',
                    no_dokumen: 'E25-0003708454',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708454.png',
