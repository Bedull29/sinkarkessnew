document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708780') {
                const d = {
                    nama_pemilik: 'HARIO A ASRAN LA***',
                    nomor_paspor: 'Passport  X8375671',
                    tanggal_lahir: '1951-11-25',
                    no_dokumen: 'E26-0003708780',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708780.png',
