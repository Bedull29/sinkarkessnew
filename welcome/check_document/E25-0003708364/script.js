document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708364') {
                const d = {
                    nama_pemilik: 'ARINI AZ***',
                    nomor_paspor: 'Passport  X9011360',
                    tanggal_lahir: '1997-01-18',
                    no_dokumen: 'E25-0003708364',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708364.png',
