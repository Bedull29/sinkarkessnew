document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708181') {
                const d = {
                    nama_pemilik: 'MARYATI MA***',
                    nomor_paspor: 'Passport  X7170470',
                    tanggal_lahir: '1955-07-01',
                    no_dokumen: 'E25-0003708181',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708181.png',
