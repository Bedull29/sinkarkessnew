document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708379') {
                const d = {
                    nama_pemilik: 'ANNANDYA SAVITRI SOETRI***',
                    nomor_paspor: 'Passport  C8107309',
                    tanggal_lahir: '1993-08-10',
                    no_dokumen: 'E25-0003708379',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2025-07-22',
                    valid_until: '2028-08-05',
                    faskes: 'Klinik InMedical',
                    dokter: 'dr. WISNU NURAGA, M.KKK',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708379.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-02-20',
                    valid_until2: '2027-02-20',
