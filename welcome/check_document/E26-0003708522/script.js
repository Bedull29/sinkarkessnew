document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708522') {
                const d = {
                    nama_pemilik: 'TUTI PRIHA***',
                    nomor_paspor: 'Passport  X9489023',
                    tanggal_lahir: '1970-10-10',
                    no_dokumen: 'E26-0003708522',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708522.png',
