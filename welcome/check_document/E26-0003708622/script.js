document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708622') {
                const d = {
                    nama_pemilik: 'MUNA US***',
                    nomor_paspor: 'Passport  X8507100',
                    tanggal_lahir: '1968-12-31',
                    no_dokumen: 'E26-0003708622',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708622.png',
