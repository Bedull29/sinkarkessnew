document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708788') {
                const d = {
                    nama_pemilik: 'RAWIYAH SALMAN IB***',
                    nomor_paspor: 'Passport  X8375645',
                    tanggal_lahir: '1969-08-03',
                    no_dokumen: 'E26-0003708788',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708788.png',
