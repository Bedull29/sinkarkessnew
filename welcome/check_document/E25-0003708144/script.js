document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708144') {
                const d = {
                    nama_pemilik: 'LALA JAMI***',
                    nomor_paspor: 'Passport  E2431924',
                    tanggal_lahir: '1986-08-29',
                    no_dokumen: 'E25-0003708144',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708144.png',
