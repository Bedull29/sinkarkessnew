document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708692') {
                const d = {
                    nama_pemilik: 'DUWIYANTO ABDUL ROC***',
                    nomor_paspor: 'Passport  X7136206',
                    tanggal_lahir: '1971-07-29',
                    no_dokumen: 'E26-0003708692',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708692.png',
