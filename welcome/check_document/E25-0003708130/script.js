document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708130') {
                const d = {
                    nama_pemilik: 'TEMU SA***',
                    nomor_paspor: 'Passport  X8130425',
                    tanggal_lahir: '1956-12-27',
                    no_dokumen: 'E25-0003708130',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708130.png',
