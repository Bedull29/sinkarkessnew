document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708927') {
                const d = {
                    nama_pemilik: 'SUMILAM SANI A***',
                    nomor_paspor: 'Passport  X9562882',
                    tanggal_lahir: '1963-03-03',
                    no_dokumen: 'E26-0003708927',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708927.png',
