document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708597') {
                const d = {
                    nama_pemilik: 'SUGIMAN SANDI HA***',
                    nomor_paspor: 'Passport  X8500437',
                    tanggal_lahir: '1967-07-05',
                    no_dokumen: 'E26-0003708597',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708597.png',
