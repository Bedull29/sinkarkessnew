document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708435') {
                const d = {
                    nama_pemilik: 'JAUDAH AHMAD SYARW***',
                    nomor_paspor: 'Passport  X8499705',
                    tanggal_lahir: '1981-03-11',
                    no_dokumen: 'E25-0003708435',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-05-02',
                    valid_until: '2029-05-02',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708435.png',
