document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708746') {
                const d = {
                    nama_pemilik: 'RIAN AH***',
                    nomor_paspor: 'Passport  E3949718',
                    tanggal_lahir: '1996-08-25',
                    no_dokumen: 'E26-0003708746',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708746.png',
