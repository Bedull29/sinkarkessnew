document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709000') {
                const d = {
                    nama_pemilik: 'SOLEH SUMARTO MURT***',
                    nomor_paspor: 'Passport  X8504747',
                    tanggal_lahir: '1970-05-06',
                    no_dokumen: 'E26-0003709000',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709000.png',
