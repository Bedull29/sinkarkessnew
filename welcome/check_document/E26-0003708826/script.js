document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708826') {
                const d = {
                    nama_pemilik: 'TARMIJI ***',
                    nomor_paspor: 'Passport  E9922565',
                    tanggal_lahir: '1953-12-12',
                    no_dokumen: 'E26-0003708826',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708826.png',
