document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708503') {
                const d = {
                    nama_pemilik: 'SULASTRI SASTRO SUMI***',
                    nomor_paspor: 'Passport  X8964899',
                    tanggal_lahir: '1962-03-29',
                    no_dokumen: 'E26-0003708503',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-06-08',
                    valid_until: '2029-06-08',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708503.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-06-08',
                    valid_until2: '2027-06-08'
                };
