document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708347') {
                const d = {
                    nama_pemilik: 'SURYANAH CECEP JUNA***',
                    nomor_paspor: 'Passport  X7702055',
                    tanggal_lahir: '1978-12-08',
                    no_dokumen: 'E25-0003708347',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-02-13',
                    valid_until: '2029-02-13',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708347.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-02-13',
                    valid_until2: '2027-02-13'
                };
