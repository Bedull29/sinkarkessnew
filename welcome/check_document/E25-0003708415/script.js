document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708415') {
                const d = {
                    nama_pemilik: 'LINDAWATI JUMARI ABDUL***',
                    nomor_paspor: 'Passport  X3070165',
                    tanggal_lahir: '1986-10-01',
                    no_dokumen: 'E25-0003708415',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-03-04',
                    valid_until: '2029-03-04',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708415.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-03-04',
                    valid_until2: '2027-03-04'
                };
