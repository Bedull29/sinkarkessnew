document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708332') {
                const d = {
                    nama_pemilik: 'FETTY RAHMAY***',
                    nomor_paspor: 'Passport  E4020350',
                    tanggal_lahir: '1987-02-27',
                    no_dokumen: 'E25-0003708332',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708332.png',
