document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708380') {
                const d = {
                    nama_pemilik: 'ADZHAN MAHDI ALI FA***',
                    nomor_paspor: 'Passport  A8979199',
                    tanggal_lahir: '1999-02-02',
                    no_dokumen: 'E25-0003708380',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708380.png',
