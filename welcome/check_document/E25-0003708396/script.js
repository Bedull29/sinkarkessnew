document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708396') {
                const d = {
                    nama_pemilik: 'MOANA KAR***',
                    nomor_paspor: 'Passport  X8530093',
                    tanggal_lahir: '1950-05-01',
                    no_dokumen: 'E25-0003708396',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708396.png',
