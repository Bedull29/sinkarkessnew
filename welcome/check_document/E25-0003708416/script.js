document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708416') {
                const d = {
                    nama_pemilik: 'SARTINI MU ***',
                    nomor_paspor: 'Passport  X8072429',
                    tanggal_lahir: '1962-12-31',
                    no_dokumen: 'E25-0003708416',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708416.png',
