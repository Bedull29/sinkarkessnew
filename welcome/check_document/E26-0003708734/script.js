document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708734') {
                const d = {
                    nama_pemilik: 'LILIS RI***',
                    nomor_paspor: 'Passport  X7132609',
                    tanggal_lahir: '1987-12-12',
                    no_dokumen: 'E26-0003708734',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708734.png',
