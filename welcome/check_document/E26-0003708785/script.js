document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708785') {
                const d = {
                    nama_pemilik: 'IDAE LUWI SU***',
                    nomor_paspor: 'Passport  X8375675',
                    tanggal_lahir: '1970-01-19',
                    no_dokumen: 'E26-0003708785',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708785.png',
