document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708487') {
                const d = {
                    nama_pemilik: 'MUHAMAD SO***',
                    nomor_paspor: 'Passport  X9442704',
                    tanggal_lahir: '1984-10-05',
                    no_dokumen: 'E25-0003708487',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708487.png',
