document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708201') {
                const d = {
                    nama_pemilik: 'SULASTRI E***',
                    nomor_paspor: 'Passport  X7789193',
                    tanggal_lahir: '1991-01-15',
                    no_dokumen: 'E25-0003708201',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708201.png',
