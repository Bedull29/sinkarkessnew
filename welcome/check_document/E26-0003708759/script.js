document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708759') {
                const d = {
                    nama_pemilik: 'NIKMAH RINTO HAR***',
                    nomor_paspor: 'Passport  X8375635',
                    tanggal_lahir: '2004-10-13',
                    no_dokumen: 'E26-0003708759',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708759.png',
