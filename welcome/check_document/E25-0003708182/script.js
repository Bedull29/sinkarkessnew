document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708182') {
                const d = {
                    nama_pemilik: 'M ZU***',
                    nomor_paspor: 'Passport  X8060425',
                    tanggal_lahir: '1978-07-10',
                    no_dokumen: 'E25-0003708182',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708182.png',
