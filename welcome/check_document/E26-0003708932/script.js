document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708932') {
                const d = {
                    nama_pemilik: 'YANTO RU***',
                    nomor_paspor: 'Passport  C8986668',
                    tanggal_lahir: '1973-07-08',
                    no_dokumen: 'E26-0003708932',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708932.png',
