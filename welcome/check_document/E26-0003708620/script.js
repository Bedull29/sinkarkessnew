document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708620') {
                const d = {
                    nama_pemilik: 'AHMADI NAN***',
                    nomor_paspor: 'Passport  X8507104',
                    tanggal_lahir: '1977-07-01',
                    no_dokumen: 'E26-0003708620',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708620.png',
