document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708567') {
                const d = {
                    nama_pemilik: 'MAHMUDAH JAMJURI MUHAM***',
                    nomor_paspor: 'Passport  X8504876',
                    tanggal_lahir: '1973-04-02',
                    no_dokumen: 'E26-0003708567',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708567.png',
