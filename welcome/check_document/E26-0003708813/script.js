document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708813') {
                const d = {
                    nama_pemilik: 'DG BUANAH DG N***',
                    nomor_paspor: 'Passport  X8577570',
                    tanggal_lahir: '1975-02-11',
                    no_dokumen: 'E26-0003708813',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708813.png',
