document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708404') {
                const d = {
                    nama_pemilik: 'FIZAN ALFIA***',
                    nomor_paspor: 'Passport  X8071687',
                    tanggal_lahir: '2002-07-01',
                    no_dokumen: 'E25-0003708404',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708404.png',
