document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708924') {
                const d = {
                    nama_pemilik: 'SULAINA N***',
                    nomor_paspor: 'Passport  X8132013',
                    tanggal_lahir: '1960-07-02',
                    no_dokumen: 'E26-0003708924',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-06-22',
                    valid_until: '2029-06-22',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708924.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-06-22',
                    valid_until2: '2027-06-22'
                };
