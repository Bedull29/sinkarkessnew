document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708556') {
                const d = {
                    nama_pemilik: 'RUKMINI SAU***',
                    nomor_paspor: 'Passport  X9297590',
                    tanggal_lahir: '1970-12-05',
                    no_dokumen: 'E26-0003708556',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708556.png',
