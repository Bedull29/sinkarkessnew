document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708513') {
                const d = {
                    nama_pemilik: 'SETYAWAN HERI SANT***',
                    nomor_paspor: 'Passport  X8964901',
                    tanggal_lahir: '1987-04-18',
                    no_dokumen: 'E26-0003708513',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708513.png',
