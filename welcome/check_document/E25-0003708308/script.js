document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708308') {
                const d = {
                    nama_pemilik: 'FIRMAN SAHI***',
                    nomor_paspor: 'Passport  X7931604',
                    tanggal_lahir: '1997-07-13',
                    no_dokumen: 'E25-0003708308',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708308.png',
