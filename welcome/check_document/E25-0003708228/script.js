document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708228') {
                const d = {
                    nama_pemilik: 'SUBHAN AKHMAD SYAR***',
                    nomor_paspor: 'Passport  X7693565',
                    tanggal_lahir: '1980-04-14',
                    no_dokumen: 'E25-0003708228',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708228.png',
