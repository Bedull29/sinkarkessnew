document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708537') {
                const d = {
                    nama_pemilik: 'FAJAR WIDA***',
                    nomor_paspor: 'Passport  X9031293',
                    tanggal_lahir: '1988-09-20',
                    no_dokumen: 'E26-0003708537',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708537.png',
