document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708515') {
                const d = {
                    nama_pemilik: 'TURIYAH JAYAWIKR***',
                    nomor_paspor: 'Passport  X9030892',
                    tanggal_lahir: '1945-03-04',
                    no_dokumen: 'E26-0003708515',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708515.png',
