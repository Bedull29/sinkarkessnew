document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708249') {
                const d = {
                    nama_pemilik: 'EKO HARY***',
                    nomor_paspor: 'Passport  X6647605',
                    tanggal_lahir: '1981-07-24',
                    no_dokumen: 'E25-0003708249',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708249.png',
