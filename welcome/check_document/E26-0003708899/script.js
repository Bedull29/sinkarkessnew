document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708899') {
                const d = {
                    nama_pemilik: 'NURBAITI HASYIM IBRA***',
                    nomor_paspor: 'Passport  E1702939',
                    tanggal_lahir: '1970-04-07',
                    no_dokumen: 'E26-0003708899',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708899.png',
