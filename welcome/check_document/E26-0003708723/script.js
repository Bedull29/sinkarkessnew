document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708723') {
                const d = {
                    nama_pemilik: 'MARIYAM SAD***',
                    nomor_paspor: 'Passport  X7136102',
                    tanggal_lahir: '1961-06-30',
                    no_dokumen: 'E26-0003708723',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708723.png',
