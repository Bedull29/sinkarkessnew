document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708974') {
                const d = {
                    nama_pemilik: 'HANAFI R***',
                    nomor_paspor: 'Passport  X8506617',
                    tanggal_lahir: '1980-07-01',
                    no_dokumen: 'E26-0003708974',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708974.png',
