document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708829') {
                const d = {
                    nama_pemilik: 'AMIR HASAN MASR***',
                    nomor_paspor: 'Passport  E9922569',
                    tanggal_lahir: '1967-08-05',
                    no_dokumen: 'E26-0003708829',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708829.png',
