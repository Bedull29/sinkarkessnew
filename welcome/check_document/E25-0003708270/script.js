document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708270') {
                const d = {
                    nama_pemilik: 'ARSIDI MA***',
                    nomor_paspor: 'Passport  X8699685',
                    tanggal_lahir: '1948-08-16',
                    no_dokumen: 'E25-0003708270',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708270.png',
