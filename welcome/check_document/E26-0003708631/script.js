document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708631') {
                const d = {
                    nama_pemilik: 'ASIT SANDI K***',
                    nomor_paspor: 'Passport  E4982793',
                    tanggal_lahir: '1970-01-07',
                    no_dokumen: 'E26-0003708631',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708631.png',
