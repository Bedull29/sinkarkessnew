document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708590') {
                const d = {
                    nama_pemilik: 'NORJANAH AHMAD KUS***',
                    nomor_paspor: 'Passport  C9877107',
                    tanggal_lahir: '1981-03-05',
                    no_dokumen: 'E26-0003708590',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708590.png',
