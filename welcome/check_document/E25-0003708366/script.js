document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708366') {
                const d = {
                    nama_pemilik: 'UMI KUL***',
                    nomor_paspor: 'Passport  X8770282',
                    tanggal_lahir: '1982-01-31',
                    no_dokumen: 'E25-0003708366',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-02-23',
                    valid_until: '2029-02-23',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708366.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-02-23',
                    valid_until2: '2027-02-23'
                };
