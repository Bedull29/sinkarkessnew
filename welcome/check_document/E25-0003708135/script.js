document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708135') {
                const d = {
                    nama_pemilik: 'DADANG NOP***',
                    nomor_paspor: 'Passport  X7555582',
                    tanggal_lahir: '1976-04-16',
                    no_dokumen: 'E25-0003708135',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708135.png',
