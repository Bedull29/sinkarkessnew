document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708136') {
                const d = {
                    nama_pemilik: 'ABDUL A***',
                    nomor_paspor: 'Passport  X7555875',
                    tanggal_lahir: '1984-12-11',
                    no_dokumen: 'E25-0003708136',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708136.png',
