document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708615') {
                const d = {
                    nama_pemilik: 'RATU TALHAH SAALU***',
                    nomor_paspor: 'Passport  X8507142',
                    tanggal_lahir: '1960-03-27',
                    no_dokumen: 'E26-0003708615',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708615.png',
