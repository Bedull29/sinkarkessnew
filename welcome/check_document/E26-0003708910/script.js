document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708910') {
                const d = {
                    nama_pemilik: 'REYHAN MUHAMMAD FAR***',
                    nomor_paspor: 'Passport  C9061267',
                    tanggal_lahir: '1965-10-06',
                    no_dokumen: 'E26-0003708910',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708910.png',
