document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709359') {
                const d = {
                    nama_pemilik: 'AKHTAR ZIVAN ALFAR***',
                    nomor_paspor: 'Passport  C9046***',
                    tanggal_lahir: '2019-09-30',
                    no_dokumen: 'E26-0003709359',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709359.png',
