document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708845') {
                const d = {
                    nama_pemilik: 'YANTI M***',
                    nomor_paspor: 'Passport  X8504426',
                    tanggal_lahir: '1971-01-31',
                    no_dokumen: 'E26-0003708845',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708845.png',
