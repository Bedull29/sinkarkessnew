document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708650') {
                const d = {
                    nama_pemilik: 'ARNI BASERI NA***',
                    nomor_paspor: 'Passport  X8507899',
                    tanggal_lahir: '1970-08-08',
                    no_dokumen: 'E26-0003708650',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708650.png',
