document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708608') {
                const d = {
                    nama_pemilik: 'BUDIANTO PAIJO ABDUL***',
                    nomor_paspor: 'Passport  E2487059',
                    tanggal_lahir: '1953-08-01',
                    no_dokumen: 'E26-0003708608',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708608.png',
