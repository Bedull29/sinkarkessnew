document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708561') {
                const d = {
                    nama_pemilik: 'ALI T***',
                    nomor_paspor: 'Passport  X9297592',
                    tanggal_lahir: '1962-12-31',
                    no_dokumen: 'E26-0003708561',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708561.png',
