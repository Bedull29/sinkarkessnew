document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708791') {
                const d = {
                    nama_pemilik: 'FINO SAFI***',
                    nomor_paspor: 'Passport  E9939104',
                    tanggal_lahir: '2001-06-01',
                    no_dokumen: 'E26-0003708791',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708791.png',
