document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708230') {
                const d = {
                    nama_pemilik: 'AFFAN ALF***',
                    nomor_paspor: 'Passport  C9762762',
                    tanggal_lahir: '1968-08-28',
                    no_dokumen: 'E25-0003708230',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708230.png',
