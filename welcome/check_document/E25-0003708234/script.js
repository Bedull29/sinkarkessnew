document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708234') {
                const d = {
                    nama_pemilik: 'IDARYANI T NUR***',
                    nomor_paspor: 'Passport  X3056510',
                    tanggal_lahir: '1979-12-27',
                    no_dokumen: 'E25-0003708234',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708234.png',
