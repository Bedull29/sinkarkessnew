document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708990') {
                const d = {
                    nama_pemilik: 'NORHASANAH JUMBERI ABDUL BA***',
                    nomor_paspor: 'Passport  X8504313',
                    tanggal_lahir: '1969-12-22',
                    no_dokumen: 'E26-0003708990',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708990.png',
