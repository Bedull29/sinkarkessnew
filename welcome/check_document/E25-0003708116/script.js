document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708116') {
                const d = {
                    nama_pemilik: 'ISFI ROBIATUL MAWAD***',
                    nomor_paspor: 'Passport  X8123287',
                    tanggal_lahir: '1995-07-22',
                    no_dokumen: 'E25-0003708116',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2025-12-19',
                    valid_until: '2028-12-20',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708116.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2025-12-19',
                    valid_until2: '2026-12-20'
                };
