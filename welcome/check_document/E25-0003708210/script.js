document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708210') {
                const d = {
                    nama_pemilik: 'ADE KUSTA***',
                    nomor_paspor: 'Passport  X7937586',
                    tanggal_lahir: '1954-01-21',
                    no_dokumen: 'E25-0003708210',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708210.png',
