document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708414') {
                const d = {
                    nama_pemilik: 'NURHAYANI BINTI YUS***',
                    nomor_paspor: 'Passport  E3474204',
                    tanggal_lahir: '1981-02-04',
                    no_dokumen: 'E25-0003708414',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708414.png',
