document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709351') {
                const d = {
                    nama_pemilik: 'MAPNASIR N***',
                    nomor_paspor: 'Passport  X9742***',
                    tanggal_lahir: '1958-09-10',
                    no_dokumen: 'E26-0003709351',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709351.png',
