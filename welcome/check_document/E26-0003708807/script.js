document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708807') {
                const d = {
                    nama_pemilik: 'SUHRIA SAN***',
                    nomor_paspor: 'Passport  X9700542',
                    tanggal_lahir: '1978-03-16',
                    no_dokumen: 'E26-0003708807',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708807.png',
