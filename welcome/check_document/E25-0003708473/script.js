document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708473') {
                const d = {
                    nama_pemilik: 'HIDAYAH SADIKIN L***',
                    nomor_paspor: 'Passport  X9009145',
                    tanggal_lahir: '1995-07-03',
                    no_dokumen: 'E25-0003708473',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708473.png',
