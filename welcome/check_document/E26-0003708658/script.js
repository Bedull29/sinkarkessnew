document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708658') {
                const d = {
                    nama_pemilik: 'FITRA RAMD***',
                    nomor_paspor: 'Passport  X7942429',
                    tanggal_lahir: '1998-01-27',
                    no_dokumen: 'E26-0003708658',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708658.png',
