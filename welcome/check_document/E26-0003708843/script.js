document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708843') {
                const d = {
                    nama_pemilik: 'SITI SARAH A***',
                    nomor_paspor: 'Passport  X8507863',
                    tanggal_lahir: '1971-03-03',
                    no_dokumen: 'E26-0003708843',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708843.png',
