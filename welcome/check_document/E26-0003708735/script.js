document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708735') {
                const d = {
                    nama_pemilik: 'ROSA SEPTIANI MARK***',
                    nomor_paspor: 'Passport  X7132628',
                    tanggal_lahir: '1986-09-10',
                    no_dokumen: 'E26-0003708735',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708735.png',
