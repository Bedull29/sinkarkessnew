document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708898') {
                const d = {
                    nama_pemilik: 'NASRUD***',
                    nomor_paspor: 'Passport  X9260997',
                    tanggal_lahir: '1981-07-01',
                    no_dokumen: 'E26-0003708898',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708898.png',
