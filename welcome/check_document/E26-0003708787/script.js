document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708787') {
                const d = {
                    nama_pemilik: 'MAENAH T***',
                    nomor_paspor: 'Passport  E5988757',
                    tanggal_lahir: '1958-05-03',
                    no_dokumen: 'E26-0003708787',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708787.png',
