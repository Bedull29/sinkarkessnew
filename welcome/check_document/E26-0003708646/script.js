document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708646') {
                const d = {
                    nama_pemilik: 'AHMAD TUHA***',
                    nomor_paspor: 'Passport  X8507935',
                    tanggal_lahir: '1966-07-01',
                    no_dokumen: 'E26-0003708646',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708646.png',
