document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708693') {
                const d = {
                    nama_pemilik: 'SRI WARINI NGATE***',
                    nomor_paspor: 'Passport  X7136207',
                    tanggal_lahir: '1966-03-14',
                    no_dokumen: 'E26-0003708693',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708693.png',
