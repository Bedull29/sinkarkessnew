document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708755') {
                const d = {
                    nama_pemilik: 'SAMIRAH SOLI***',
                    nomor_paspor: 'Passport  X9559840',
                    tanggal_lahir: '1948-06-30',
                    no_dokumen: 'E26-0003708755',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708755.png',
