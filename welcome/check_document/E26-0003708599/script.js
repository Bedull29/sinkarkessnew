document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708599') {
                const d = {
                    nama_pemilik: 'WASIKUN MARIADI MARTAR***',
                    nomor_paspor: 'Passport  X8502532',
                    tanggal_lahir: '1981-10-10',
                    no_dokumen: 'E26-0003708599',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708599.png',
