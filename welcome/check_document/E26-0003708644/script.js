document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708644') {
                const d = {
                    nama_pemilik: 'MUHAMMAD YAMANI SA***',
                    nomor_paspor: 'Passport  X8508214',
                    tanggal_lahir: '1997-12-05',
                    no_dokumen: 'E26-0003708644',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708644.png',
