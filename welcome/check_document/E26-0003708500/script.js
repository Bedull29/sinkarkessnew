document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708500') {
                const d = {
                    nama_pemilik: 'SURATMI KARS***',
                    nomor_paspor: 'Passport  X8469511',
                    tanggal_lahir: '1973-03-05',
                    no_dokumen: 'E26-0003708500',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708500.png',
