document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708900') {
                const d = {
                    nama_pemilik: 'SUSI SUNARYA SOF***',
                    nomor_paspor: 'Passport  X6963996',
                    tanggal_lahir: '1972-09-01',
                    no_dokumen: 'E26-0003708900',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-06-18',
                    valid_until: '2029-06-18',
                    faskes: 'Banda Aceh / Pos Instalasi Klinik Induk',
                    dokter: 'dr. Rita Rahayu',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708900.png',
