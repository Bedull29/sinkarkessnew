document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708504') {
                const d = {
                    nama_pemilik: 'SULCHAN SAN***',
                    nomor_paspor: 'Passport  X8964872',
                    tanggal_lahir: '1965-07-27',
                    no_dokumen: 'E26-0003708504',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708504.png',
