document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708358') {
                const d = {
                    nama_pemilik: 'ZUHRA MARW***',
                    nomor_paspor: 'Passport  E7460689',
                    tanggal_lahir: '2010-09-07',
                    no_dokumen: 'E25-0003708358',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708358.png',
