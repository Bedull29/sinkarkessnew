document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708391') {
                const d = {
                    nama_pemilik: 'RUFIAH RE***',
                    nomor_paspor: 'Passport  X8516619',
                    tanggal_lahir: '1959-11-01',
                    no_dokumen: 'E25-0003708391',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708391.png',
