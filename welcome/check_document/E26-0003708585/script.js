document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708585') {
                const d = {
                    nama_pemilik: 'SAMPURNA ABAS SUS***',
                    nomor_paspor: 'Passport  X8504660',
                    tanggal_lahir: '1962-10-01',
                    no_dokumen: 'E26-0003708585',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708585.png',
