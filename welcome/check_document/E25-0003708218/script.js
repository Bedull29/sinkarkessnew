document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708218') {
                const d = {
                    nama_pemilik: 'MARDHIAH IBRA***',
                    nomor_paspor: 'Passport  X8064677',
                    tanggal_lahir: '1970-06-01',
                    no_dokumen: 'E25-0003708218',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708218.png',
