document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708853') {
                const d = {
                    nama_pemilik: 'SAYYID FA***',
                    nomor_paspor: 'Passport  E3613880',
                    tanggal_lahir: '1995-08-08',
                    no_dokumen: 'E26-0003708853',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708853.png',
