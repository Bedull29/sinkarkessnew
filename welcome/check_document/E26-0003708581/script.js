document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708581') {
                const d = {
                    nama_pemilik: 'HARUNORASYID NAPIAH DJ***',
                    nomor_paspor: 'Passport  X8506417',
                    tanggal_lahir: '1970-04-30',
                    no_dokumen: 'E26-0003708581',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708581.png',
