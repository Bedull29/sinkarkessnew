document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708879') {
                const d = {
                    nama_pemilik: 'ZULFINA SAMSUN AZ***',
                    nomor_paspor: 'Passport  X9578824',
                    tanggal_lahir: '1983-09-23',
                    no_dokumen: 'E26-0003708879',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708879.png',
