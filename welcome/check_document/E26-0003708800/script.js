document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708800') {
                const d = {
                    nama_pemilik: 'BABUR RAH***',
                    nomor_paspor: 'Passport  X9698373',
                    tanggal_lahir: '1965-12-31',
                    no_dokumen: 'E26-0003708800',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708800.png',
