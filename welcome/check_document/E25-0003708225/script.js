document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708225') {
                const d = {
                    nama_pemilik: 'NURMALA HU***',
                    nomor_paspor: 'Passport  X7060843',
                    tanggal_lahir: '1952-04-21',
                    no_dokumen: 'E25-0003708225',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708225.png',
