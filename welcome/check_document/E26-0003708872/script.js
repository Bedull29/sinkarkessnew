document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708872') {
                const d = {
                    nama_pemilik: 'PUJA KHAIRUNNISA MUHAMMAD NAZARUL***',
                    nomor_paspor: 'Passport  X9260624',
                    tanggal_lahir: '1996-10-19',
                    no_dokumen: 'E26-0003708872',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-06-18',
                    valid_until: '2029-06-18',
                    faskes: 'Banda Aceh (Lampeuneurut Gampong) / Klinik Meurasi Batoh /',
                    dokter: 'dr.Novita Yuniwanda Islam',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708872.png',
