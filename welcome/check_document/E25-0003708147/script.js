document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708147') {
                const d = {
                    nama_pemilik: 'ZULFAJRI ABDUL***',
                    nomor_paspor: 'Passport  E8920990',
                    tanggal_lahir: '1983-11-12',
                    no_dokumen: 'E25-0003708147',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2025-01-16',
                    valid_until: '2027-01-30',
                    faskes: 'KLINIK SOFIE',
                    dokter: 'dr ARIS MAHFUZHI',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708147.png',
