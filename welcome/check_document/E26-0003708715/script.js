document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708715') {
                const d = {
                    nama_pemilik: 'PUJIATI JI***',
                    nomor_paspor: 'Passport  X7136210',
                    tanggal_lahir: '1970-04-28',
                    no_dokumen: 'E26-0003708715',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708715.png',
