document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708983') {
                const d = {
                    nama_pemilik: 'MASLIAN AMB***',
                    nomor_paspor: 'Passport  X8507286',
                    tanggal_lahir: '1970-08-04',
                    no_dokumen: 'E26-0003708983',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708983.png',
