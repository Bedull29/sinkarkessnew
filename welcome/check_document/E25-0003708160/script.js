document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708160') {
                const d = {
                    nama_pemilik: 'ZAKIUL FA***',
                    nomor_paspor: 'Passport  E6459593',
                    tanggal_lahir: '1998-09-18',
                    no_dokumen: 'E25-0003708160',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708160.png',
