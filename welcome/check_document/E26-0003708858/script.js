document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708858') {
                const d = {
                    nama_pemilik: 'DAYAT HIDAYAT SAHI***',
                    nomor_paspor: 'Passport  X7936302',
                    tanggal_lahir: '1956-06-28',
                    no_dokumen: 'E26-0003708858',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708858.png',
