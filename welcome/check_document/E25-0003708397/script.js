document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708397') {
                const d = {
                    nama_pemilik: 'SAMUJI BIN KAD***',
                    nomor_paspor: 'Passport  C8146230',
                    tanggal_lahir: '1961-03-15',
                    no_dokumen: 'E25-0003708397',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708397.png',
