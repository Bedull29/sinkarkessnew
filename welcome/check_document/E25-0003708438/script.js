document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708438') {
                const d = {
                    nama_pemilik: 'IRMA S***',
                    nomor_paspor: 'Passport  E6258184',
                    tanggal_lahir: '1996-06-26',
                    no_dokumen: 'E25-0003708438',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2024-02-16',
                    valid_until: '2027-02-16',
                    faskes: 'RUMAH SAKIT PELITA INSANI',
                    dokter: 'dr. Gabril Taufiq Basri, Sp.PD, FINASIM',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708438.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-05-02',
                    valid_until2: '2027-05-02',
