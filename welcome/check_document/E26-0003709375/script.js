document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709375') {
                const d = {
                    nama_pemilik: 'IMRAATUN NABI***',
                    nomor_paspor: 'Passport  Y0082***',
                    tanggal_lahir: '1989-04-20',
                    no_dokumen: 'E26-0003709375',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709375.png',
