document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708226') {
                const d = {
                    nama_pemilik: 'KHATIJAH HAS***',
                    nomor_paspor: 'Passport  X7060843',
                    tanggal_lahir: '1968-04-03',
                    no_dokumen: 'E25-0003708226',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708226.png',
