document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708655') {
                const d = {
                    nama_pemilik: 'HALIMAH TUG***',
                    nomor_paspor: 'Passport  X8506966',
                    tanggal_lahir: '1982-03-08',
                    no_dokumen: 'E26-0003708655',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708655.png',
