document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708193') {
                const d = {
                    nama_pemilik: 'UMU KUL***',
                    nomor_paspor: 'Passport  X6611548',
                    tanggal_lahir: '1980-04-27',
                    no_dokumen: 'E25-0003708193',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708193.png',
