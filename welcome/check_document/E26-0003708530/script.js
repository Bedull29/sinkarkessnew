document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708530') {
                const d = {
                    nama_pemilik: 'SUGENG ATMODIA***',
                    nomor_paspor: 'Passport  X8465371',
                    tanggal_lahir: '1959-07-01',
                    no_dokumen: 'E26-0003708530',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708530.png',
