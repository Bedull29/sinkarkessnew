document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708507') {
                const d = {
                    nama_pemilik: 'MUGIYATI BU***',
                    nomor_paspor: 'Passport  X8964903',
                    tanggal_lahir: '1972-07-06',
                    no_dokumen: 'E26-0003708507',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708507.png',
