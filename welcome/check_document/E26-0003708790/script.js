document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708790') {
                const d = {
                    nama_pemilik: 'MUHAMMAD BIN HUSEIN T***',
                    nomor_paspor: 'Passport  X8893089',
                    tanggal_lahir: '1996-07-23',
                    no_dokumen: 'E26-0003708790',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-06-10',
                    valid_until: '2029-06-10',
                    faskes: 'KLINIK PMC',
                    dokter: 'DR. FIDIANSJAH',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708790.png',
