document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708656') {
                const d = {
                    nama_pemilik: 'ILA NURL***',
                    nomor_paspor: 'Passport  X7942426',
                    tanggal_lahir: '1977-12-13',
                    no_dokumen: 'E26-0003708656',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708656.png',
