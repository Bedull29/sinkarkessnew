document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708299') {
                const d = {
                    nama_pemilik: 'HANIFAH HANAF***',
                    nomor_paspor: 'Passport  X6394515',
                    tanggal_lahir: '1971-05-10',
                    no_dokumen: 'E25-0003708299',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708299.png',
