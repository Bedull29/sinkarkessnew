document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708657') {
                const d = {
                    nama_pemilik: 'INTAN DEANIRA HIDA***',
                    nomor_paspor: 'Passport  X7942393',
                    tanggal_lahir: '1997-05-22',
                    no_dokumen: 'E26-0003708657',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708657.png',
