document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708844') {
                const d = {
                    nama_pemilik: 'MUHAMMAD T JANT***',
                    nomor_paspor: 'Passport  X8507864',
                    tanggal_lahir: '1971-08-30',
                    no_dokumen: 'E26-0003708844',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708844.png',
