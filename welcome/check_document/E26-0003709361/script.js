document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709361') {
                const d = {
                    nama_pemilik: 'AAN SEFTY***',
                    nomor_paspor: 'Passport  C9046***',
                    tanggal_lahir: '1991-05-14',
                    no_dokumen: 'E26-0003709361',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709361.png',
