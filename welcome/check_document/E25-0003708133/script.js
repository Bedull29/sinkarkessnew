document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708133') {
                const d = {
                    nama_pemilik: 'NITA AYUNINGTI***',
                    nomor_paspor: 'Passport  E7139756',
                    tanggal_lahir: '1993-08-19',
                    no_dokumen: 'E25-0003708133',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708133.png',
