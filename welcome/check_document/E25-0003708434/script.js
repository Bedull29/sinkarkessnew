document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708434') {
                const d = {
                    nama_pemilik: 'HOLIDAH SULAI***',
                    nomor_paspor: 'Passport  X8499744',
                    tanggal_lahir: '1957-12-31',
                    no_dokumen: 'E25-0003708434',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708434.png',
