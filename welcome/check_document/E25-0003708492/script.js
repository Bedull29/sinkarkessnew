document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708492') {
                const d = {
                    nama_pemilik: 'HENNY HARS***',
                    nomor_paspor: 'Passport  X1619655',
                    tanggal_lahir: '1975-04-15',
                    no_dokumen: 'E25-0003708492',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708492.png',
