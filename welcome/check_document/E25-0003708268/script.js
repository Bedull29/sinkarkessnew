document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708268') {
                const d = {
                    nama_pemilik: 'MUIDAH MUHAMAD N***',
                    nomor_paspor: 'Passport  X7353859',
                    tanggal_lahir: '1972-03-15',
                    no_dokumen: 'E25-0003708268',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708268.png',
