document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708965') {
                const d = {
                    nama_pemilik: 'SITI ROKAYAH MUSLI***',
                    nomor_paspor: 'Passport  E5139236',
                    tanggal_lahir: '1964-10-02',
                    no_dokumen: 'E26-0003708965',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708965.png',
