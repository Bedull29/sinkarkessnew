document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708865') {
                const d = {
                    nama_pemilik: 'ROHMAN FAUZAN NUGR***',
                    nomor_paspor: 'Passport  X2791480',
                    tanggal_lahir: '1984-12-31',
                    no_dokumen: 'E26-0003708865',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708865.png',
