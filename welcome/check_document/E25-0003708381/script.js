document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708381') {
                const d = {
                    nama_pemilik: 'TAMSUR BIN D***',
                    nomor_paspor: 'Passport  E7428086',
                    tanggal_lahir: '1960-01-14',
                    no_dokumen: 'E25-0003708381',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708381.png',
