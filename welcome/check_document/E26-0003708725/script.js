document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708725') {
                const d = {
                    nama_pemilik: 'MUJIATI MA***',
                    nomor_paspor: 'Passport  X7136108',
                    tanggal_lahir: '1971-04-04',
                    no_dokumen: 'E26-0003708725',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708725.png',
