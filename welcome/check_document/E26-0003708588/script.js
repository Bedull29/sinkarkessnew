document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708588') {
                const d = {
                    nama_pemilik: 'NOOR HAYATI ***',
                    nomor_paspor: 'Passport  X8506413',
                    tanggal_lahir: '1960-07-10',
                    no_dokumen: 'E26-0003708588',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708588.png',
