document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708199') {
                const d = {
                    nama_pemilik: 'DEDE AAN ISMAYA***',
                    nomor_paspor: 'Passport  C8870848',
                    tanggal_lahir: '1972-01-24',
                    no_dokumen: 'E25-0003708199',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2025-01-08',
                    valid_until: '2028-01-22',
                    faskes: 'Klinik Pratama Widya Medika',
                    dokter: 'dr. IRA WIDYA JAHRI',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708199.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-01-07',
                    valid_until2: '2027-01-15',
