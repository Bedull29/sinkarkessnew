document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708970') {
                const d = {
                    nama_pemilik: 'RUSILA ASLI JA***',
                    nomor_paspor: 'Passport  X8383284',
                    tanggal_lahir: '1973-06-01',
                    no_dokumen: 'E26-0003708970',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708970.png',
