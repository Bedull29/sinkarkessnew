document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708329') {
                const d = {
                    nama_pemilik: 'SUHA***',
                    nomor_paspor: 'Passport  X8065321',
                    tanggal_lahir: '2000-05-05',
                    no_dokumen: 'E25-0003708329',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708329.png',
