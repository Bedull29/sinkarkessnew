document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708821') {
                const d = {
                    nama_pemilik: 'AJ IJEN RAH***',
                    nomor_paspor: 'Passport  E2120783',
                    tanggal_lahir: '1950-04-07',
                    no_dokumen: 'E26-0003708821',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708821.png',
