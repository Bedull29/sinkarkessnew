document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708758') {
                const d = {
                    nama_pemilik: 'DEVI KURNIA***',
                    nomor_paspor: 'Passport  X9453093',
                    tanggal_lahir: '1996-10-15',
                    no_dokumen: 'E26-0003708758',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708758.png',
