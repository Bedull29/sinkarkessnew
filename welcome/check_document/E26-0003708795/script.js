document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708795') {
                const d = {
                    nama_pemilik: 'AHMAD HADIYA***',
                    nomor_paspor: 'Passport  X9698800',
                    tanggal_lahir: '1987-01-11',
                    no_dokumen: 'E26-0003708795',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708795.png',
