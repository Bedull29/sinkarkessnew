document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708281') {
                const d = {
                    nama_pemilik: 'MANSURDIN ABDUL MAD***',
                    nomor_paspor: 'Passport  E6172912',
                    tanggal_lahir: '1980-01-11',
                    no_dokumen: 'E25-0003708281',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708281.png',
