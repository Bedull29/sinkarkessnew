document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708265') {
                const d = {
                    nama_pemilik: 'SRI HAY***',
                    nomor_paspor: 'Passport  E5435752',
                    tanggal_lahir: '1983-03-16',
                    no_dokumen: 'E25-0003708265',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708265.png',
