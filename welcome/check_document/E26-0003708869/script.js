document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708869') {
                const d = {
                    nama_pemilik: 'RIAN DI CAP***',
                    nomor_paspor: 'Passport  X6826312',
                    tanggal_lahir: '2000-01-13',
                    no_dokumen: 'E26-0003708869',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708869.png',
