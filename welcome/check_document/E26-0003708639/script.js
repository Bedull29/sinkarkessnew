document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708639') {
                const d = {
                    nama_pemilik: 'BAHRAN DAH***',
                    nomor_paspor: 'Passport  X8506894',
                    tanggal_lahir: '1952-07-01',
                    no_dokumen: 'E26-0003708639',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708639.png',
