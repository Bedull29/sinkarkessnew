document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708809') {
                const d = {
                    nama_pemilik: 'HALPIYAH ALWI COK***',
                    nomor_paspor: 'Passport  E7598386',
                    tanggal_lahir: '1976-07-01',
                    no_dokumen: 'E26-0003708809',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708809.png',
