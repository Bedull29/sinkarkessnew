document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708698') {
                const d = {
                    nama_pemilik: 'SUMARLIK SU***',
                    nomor_paspor: 'Passport  X7136218',
                    tanggal_lahir: '1989-08-22',
                    no_dokumen: 'E26-0003708698',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708698.png',
