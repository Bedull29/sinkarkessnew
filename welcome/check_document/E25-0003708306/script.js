document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708306') {
                const d = {
                    nama_pemilik: 'SUPRIHATIN DARM***',
                    nomor_paspor: 'Passport  X8285599',
                    tanggal_lahir: '1969-12-12',
                    no_dokumen: 'E25-0003708306',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708306.png',
