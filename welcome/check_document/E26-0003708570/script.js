document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708570') {
                const d = {
                    nama_pemilik: 'MOH WESIL TA***',
                    nomor_paspor: 'Passport  X8525383',
                    tanggal_lahir: '1960-04-13',
                    no_dokumen: 'E26-0003708570',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708570.png',
