document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708401') {
                const d = {
                    nama_pemilik: 'ALI U***',
                    nomor_paspor: 'Passport  X8121695',
                    tanggal_lahir: '1966-03-04',
                    no_dokumen: 'E25-0003708401',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708401.png',
