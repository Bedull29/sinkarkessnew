document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708317') {
                const d = {
                    nama_pemilik: 'MASYITA NIMAS PAL***',
                    nomor_paspor: 'Passport  X2049729',
                    tanggal_lahir: '1986-07-13',
                    no_dokumen: 'E25-0003708317',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708317.png',
