document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708186') {
                const d = {
                    nama_pemilik: 'ROSNA HA***',
                    nomor_paspor: 'Passport  X7059678',
                    tanggal_lahir: '1957-07-01',
                    no_dokumen: 'E25-0003708186',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708186.png',
