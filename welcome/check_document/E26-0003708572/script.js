document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708572') {
                const d = {
                    nama_pemilik: 'HERNY REGINA AZ ZA***',
                    nomor_paspor: 'Passport  X8507558',
                    tanggal_lahir: '2015-01-30',
                    no_dokumen: 'E26-0003708572',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708572.png',
