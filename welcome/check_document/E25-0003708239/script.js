document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708239') {
                const d = {
                    nama_pemilik: 'NURLAILI ABD RAH***',
                    nomor_paspor: 'Passport  X8185874',
                    tanggal_lahir: '1979-10-10',
                    no_dokumen: 'E25-0003708239',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708239.png',
