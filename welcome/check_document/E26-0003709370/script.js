document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709370') {
                const d = {
                    nama_pemilik: 'SATRIA GENTALA DANISW***',
                    nomor_paspor: 'Passport  E6616***',
                    tanggal_lahir: '2014-08-05',
                    no_dokumen: 'E26-0003709370',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-07-07',
                    valid_until: '2029-07-07',
                    faskes: 'Pontianak / Klinik Dokter Keluarga',
                    dokter: 'DR. FERRY DIMYANTI',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709370.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-07-07',
                    valid_until2: '2027-07-07'
                };
