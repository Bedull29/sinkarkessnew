document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708648') {
                const d = {
                    nama_pemilik: 'HAYATI TARI***',
                    nomor_paspor: 'Passport  X8507965',
                    tanggal_lahir: '1972-11-22',
                    no_dokumen: 'E26-0003708648',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708648.png',
