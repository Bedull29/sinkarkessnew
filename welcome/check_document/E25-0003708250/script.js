document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708250') {
                const d = {
                    nama_pemilik: 'YAYAT MUHAYATURROFIAH MUHT***',
                    nomor_paspor: 'Passport  X8281740',
                    tanggal_lahir: '1964-08-05',
                    no_dokumen: 'E25-0003708250',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-01-23',
                    valid_until: '2029-01-23',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708250.png',
