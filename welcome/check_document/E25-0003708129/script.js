document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708129') {
                const d = {
                    nama_pemilik: 'KARTIB RAMI***',
                    nomor_paspor: 'Passport  X8130428',
                    tanggal_lahir: '1960-07-18',
                    no_dokumen: 'E25-0003708129',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708129.png',
