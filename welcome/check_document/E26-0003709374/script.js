document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709374') {
                const d = {
                    nama_pemilik: 'THAIFUR ALI W***',
                    nomor_paspor: 'Passport  C8533***',
                    tanggal_lahir: '1964-08-21',
                    no_dokumen: 'E26-0003709374',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709374.png',
