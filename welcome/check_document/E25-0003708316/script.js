document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708316') {
                const d = {
                    nama_pemilik: 'MUHAMMAD ZAKARIA S***',
                    nomor_paspor: 'Passport  X1827314',
                    tanggal_lahir: '1986-11-07',
                    no_dokumen: 'E25-0003708316',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-01-16',
                    valid_until: '2029-01-16',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708316.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-01-16',
                    valid_until2: '2027-01-16'
                };
