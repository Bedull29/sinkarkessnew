document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708498') {
                const d = {
                    nama_pemilik: 'MAMUN MU***',
                    nomor_paspor: 'Passport  E7079648',
                    tanggal_lahir: '1993-02-10',
                    no_dokumen: 'E25-0003708498',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708498.png',
