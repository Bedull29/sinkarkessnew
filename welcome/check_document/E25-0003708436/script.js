document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708436') {
                const d = {
                    nama_pemilik: 'MUHAMMAD RI***',
                    nomor_paspor: 'Passport  E4439071',
                    tanggal_lahir: '2003-09-30',
                    no_dokumen: 'E25-0003708436',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708436.png',
