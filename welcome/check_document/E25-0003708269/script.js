document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708269') {
                const d = {
                    nama_pemilik: 'DEWO PERM***',
                    nomor_paspor: 'Passport  X8703038',
                    tanggal_lahir: '1991-12-03',
                    no_dokumen: 'E25-0003708269',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708269.png',
