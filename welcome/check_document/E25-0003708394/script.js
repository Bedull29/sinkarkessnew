document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708394') {
                const d = {
                    nama_pemilik: 'ZAINAB RAM***',
                    nomor_paspor: 'Passport  E6529658',
                    tanggal_lahir: '1999-12-15',
                    no_dokumen: 'E25-0003708394',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708394.png',
