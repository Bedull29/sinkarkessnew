document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708422') {
                const d = {
                    nama_pemilik: 'SITI HIDAYATUL LITA SU***',
                    nomor_paspor: 'Passport  E1950734',
                    tanggal_lahir: '1985-11-30',
                    no_dokumen: 'E25-0003708422',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708422.png',
