document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708935') {
                const d = {
                    nama_pemilik: 'AISYAH SE***',
                    nomor_paspor: 'Passport  X9701729',
                    tanggal_lahir: '1962-07-02',
                    no_dokumen: 'E26-0003708935',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708935.png',
