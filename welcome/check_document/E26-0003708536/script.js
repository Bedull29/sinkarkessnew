document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708536') {
                const d = {
                    nama_pemilik: 'RESTIFA CHESA OKTA***',
                    nomor_paspor: 'Passport  X9031292',
                    tanggal_lahir: '2007-10-13',
                    no_dokumen: 'E26-0003708536',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708536.png',
