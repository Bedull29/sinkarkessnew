document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708128') {
                const d = {
                    nama_pemilik: 'KARSIU NING***',
                    nomor_paspor: 'Passport  X8130437',
                    tanggal_lahir: '1990-12-28',
                    no_dokumen: 'E25-0003708128',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708128.png',
