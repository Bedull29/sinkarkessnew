document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708471') {
                const d = {
                    nama_pemilik: 'HUMAIDI MUHAMAD IPI***',
                    nomor_paspor: 'Passport  X9009088',
                    tanggal_lahir: '1991-12-04',
                    no_dokumen: 'E25-0003708471',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708471.png',
