document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708348') {
                const d = {
                    nama_pemilik: 'ACIH ENG***',
                    nomor_paspor: 'Passport  X7709725',
                    tanggal_lahir: '1975-03-01',
                    no_dokumen: 'E25-0003708348',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708348.png',
