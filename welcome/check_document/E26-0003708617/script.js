document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708617') {
                const d = {
                    nama_pemilik: 'RAHMAH A***',
                    nomor_paspor: 'Passport  X8507142',
                    tanggal_lahir: '1985-08-16',
                    no_dokumen: 'E26-0003708617',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708617.png',
