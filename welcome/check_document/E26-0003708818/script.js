document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708818') {
                const d = {
                    nama_pemilik: 'ENDANG MUNAWAR MA***',
                    nomor_paspor: 'Passport  E8330431',
                    tanggal_lahir: '1959-09-17',
                    no_dokumen: 'E26-0003708818',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708818.png',
