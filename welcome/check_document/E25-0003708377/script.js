document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708377') {
                const d = {
                    nama_pemilik: 'MUHAMMAD KHALID ALH***',
                    nomor_paspor: 'Passport  E1701901',
                    tanggal_lahir: '2013-10-25',
                    no_dokumen: 'E25-0003708377',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-03-02',
                    valid_until: '2029-03-02',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708377.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-03-02',
                    valid_until2: '2027-03-02'
                };
