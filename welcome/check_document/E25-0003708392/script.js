document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708392') {
                const d = {
                    nama_pemilik: 'RAMLAN AHMAD M***',
                    nomor_paspor: 'Passport  X3601546',
                    tanggal_lahir: '1965-07-10',
                    no_dokumen: 'E25-0003708392',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708392.png',
