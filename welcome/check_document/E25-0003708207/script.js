document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708207') {
                const d = {
                    nama_pemilik: 'ELISNA W***',
                    nomor_paspor: 'Passport  X7793051',
                    tanggal_lahir: '1975-06-25',
                    no_dokumen: 'E25-0003708207',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708207.png',
