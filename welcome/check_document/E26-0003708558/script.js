document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708558') {
                const d = {
                    nama_pemilik: 'SULASTRI MB***',
                    nomor_paspor: 'Passport  E7194834',
                    tanggal_lahir: '1984-09-17',
                    no_dokumen: 'E26-0003708558',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708558.png',
