document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708372') {
                const d = {
                    nama_pemilik: 'IKA ROSTIKA GAD****',
                    nomor_paspor: 'Passport  X1925875',
                    tanggal_lahir: '1961-11-03',
                    no_dokumen: 'E25-0003708372',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708372.png',
