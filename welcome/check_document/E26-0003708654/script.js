document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708654') {
                const d = {
                    nama_pemilik: 'RINI ASTUTIK PONI***',
                    nomor_paspor: 'Passport  X9509637',
                    tanggal_lahir: '1976-05-29',
                    no_dokumen: 'E26-0003708654',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708654.png',
