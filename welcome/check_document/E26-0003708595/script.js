document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708595') {
                const d = {
                    nama_pemilik: 'BADRIYAH YAHRU***',
                    nomor_paspor: 'Passport  X8470394',
                    tanggal_lahir: '1968-05-10',
                    no_dokumen: 'E26-0003708595',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708595.png',
