document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708729') {
                const d = {
                    nama_pemilik: 'SURADAL SOMO WIY***',
                    nomor_paspor: 'Passport  X7136243',
                    tanggal_lahir: '1971-08-15',
                    no_dokumen: 'E26-0003708729',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708729.png',
