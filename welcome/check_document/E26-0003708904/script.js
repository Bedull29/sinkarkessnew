document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708904') {
                const d = {
                    nama_pemilik: 'BUNGA SETIA***',
                    nomor_paspor: 'Passport  X9044736',
                    tanggal_lahir: '2015-10-06',
                    no_dokumen: 'E26-0003708904',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708904.png',
