document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708740') {
                const d = {
                    nama_pemilik: 'PRADANTI AYU FRAHMAS***',
                    nomor_paspor: 'Passport  X8963898',
                    tanggal_lahir: '1989-06-28',
                    no_dokumen: 'E26-0003708740',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708740.png',
