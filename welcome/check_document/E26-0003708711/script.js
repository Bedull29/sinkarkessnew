document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708711') {
                const d = {
                    nama_pemilik: 'NGATI KARSO R***',
                    nomor_paspor: 'Passport  X7136208',
                    tanggal_lahir: '1955-09-05',
                    no_dokumen: 'E26-0003708711',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708711.png',
