document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708937') {
                const d = {
                    nama_pemilik: 'SOFIAH SEHABUD***',
                    nomor_paspor: 'Passport  X9701727',
                    tanggal_lahir: '1966-04-15',
                    no_dokumen: 'E26-0003708937',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708937.png',
