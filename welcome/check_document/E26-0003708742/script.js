document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708742') {
                const d = {
                    nama_pemilik: 'RIFQI SHIHAB NUR HIDA***',
                    nomor_paspor: 'Passport  X8954911',
                    tanggal_lahir: '2008-08-17',
                    no_dokumen: 'E26-0003708742',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708742.png',
