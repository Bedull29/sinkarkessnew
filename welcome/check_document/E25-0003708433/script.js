document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708433') {
                const d = {
                    nama_pemilik: 'NOR HIKMAH BINTI SAL***',
                    nomor_paspor: 'Passport  E6258183',
                    tanggal_lahir: '1975-03-06',
                    no_dokumen: 'E25-0003708433',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708433.png',
