document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708283') {
                const d = {
                    nama_pemilik: 'FATHONAH FAYUMI MA***',
                    nomor_paspor: 'Passport  E6172811',
                    tanggal_lahir: '1959-12-14',
                    no_dokumen: 'E25-0003708283',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708283.png',
