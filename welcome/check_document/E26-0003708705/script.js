document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708705') {
                const d = {
                    nama_pemilik: 'M RIFAI KHOIRU***',
                    nomor_paspor: 'Passport  X7136292',
                    tanggal_lahir: '1958-08-28',
                    no_dokumen: 'E26-0003708705',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708705.png',
