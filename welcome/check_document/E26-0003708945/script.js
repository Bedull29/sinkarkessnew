document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708945') {
                const d = {
                    nama_pemilik: 'MAWANA DE***',
                    nomor_paspor: 'Passport  X9702215',
                    tanggal_lahir: '1973-07-01',
                    no_dokumen: 'E26-0003708945',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708945.png',
