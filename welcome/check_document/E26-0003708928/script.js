document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708928') {
                const d = {
                    nama_pemilik: 'SUMIYATEN KA***',
                    nomor_paspor: 'Passport  X9562924',
                    tanggal_lahir: '1980-10-02',
                    no_dokumen: 'E26-0003708928',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708928.png',
