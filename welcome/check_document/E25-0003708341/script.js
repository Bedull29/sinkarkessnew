document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708341') {
                const d = {
                    nama_pemilik: 'ROHAMAH SA***',
                    nomor_paspor: 'Passport  X7356903',
                    tanggal_lahir: '1951-02-04',
                    no_dokumen: 'E25-0003708341',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708341.png',
