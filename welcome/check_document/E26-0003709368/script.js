document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709368') {
                const d = {
                    nama_pemilik: 'DENI YUNIYA***',
                    nomor_paspor: 'Passport  X7584***',
                    tanggal_lahir: '1991-01-23',
                    no_dokumen: 'E26-0003709368',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709368.png',
