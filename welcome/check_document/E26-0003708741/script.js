document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708741') {
                const d = {
                    nama_pemilik: 'ADI PURWA***',
                    nomor_paspor: 'Passport  E5649504',
                    tanggal_lahir: '1984-07-07',
                    no_dokumen: 'E26-0003708741',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708741.png',
