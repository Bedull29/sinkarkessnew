document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708891') {
                const d = {
                    nama_pemilik: 'AINON MAKZ***',
                    nomor_paspor: 'Passport  X9260719',
                    tanggal_lahir: '1969-07-01',
                    no_dokumen: 'E26-0003708891',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708891.png',
