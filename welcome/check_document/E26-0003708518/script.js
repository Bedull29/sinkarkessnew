document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708518') {
                const d = {
                    nama_pemilik: 'SUJILAH PAWIRO WID***',
                    nomor_paspor: 'Passport  X8469168',
                    tanggal_lahir: '1961-11-20',
                    no_dokumen: 'E26-0003708518',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708518.png',
