document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708198') {
                const d = {
                    nama_pemilik: 'TITIN SUHART***',
                    nomor_paspor: 'Passport  X7937492',
                    tanggal_lahir: '1983-05-14',
                    no_dokumen: 'E25-0003708198',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708198.png',
