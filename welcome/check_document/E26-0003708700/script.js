document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708700') {
                const d = {
                    nama_pemilik: 'SSAMIJAH TUNG***',
                    nomor_paspor: 'Passport  X7136217',
                    tanggal_lahir: '1950-07-01',
                    no_dokumen: 'E26-0003708700',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708700.png',
