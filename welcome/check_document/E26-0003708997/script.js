document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708997') {
                const d = {
                    nama_pemilik: 'RUSLAMIAH ABDURRASYID ABDUSSA***',
                    nomor_paspor: 'Passport  E6993296',
                    tanggal_lahir: '1953-09-12',
                    no_dokumen: 'E26-0003708997',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708997.png',
