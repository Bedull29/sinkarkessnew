document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708523') {
                const d = {
                    nama_pemilik: 'SRI REJEKI PUSPITAS***',
                    nomor_paspor: 'Passport  X9031009',
                    tanggal_lahir: '1986-09-06',
                    no_dokumen: 'E26-0003708523',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708523.png',
