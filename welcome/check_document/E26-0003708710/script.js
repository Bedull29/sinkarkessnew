document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708710') {
                const d = {
                    nama_pemilik: 'ALTINA KA***',
                    nomor_paspor: 'Passport  X7136104',
                    tanggal_lahir: '1976-04-05',
                    no_dokumen: 'E26-0003708710',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708710.png',
