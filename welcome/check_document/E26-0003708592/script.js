document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708592') {
                const d = {
                    nama_pemilik: 'SUKIRNO KOSIM SUM***',
                    nomor_paspor: 'Passport  X9491068',
                    tanggal_lahir: '1966-03-12',
                    no_dokumen: 'E26-0003708592',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708592.png',
