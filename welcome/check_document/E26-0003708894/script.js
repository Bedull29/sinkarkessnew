document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708894') {
                const d = {
                    nama_pemilik: 'AZKA DARA MAULI***',
                    nomor_paspor: 'Passport  C8616206',
                    tanggal_lahir: '2008-04-17',
                    no_dokumen: 'E26-0003708894',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708894.png',
