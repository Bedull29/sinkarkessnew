document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708857') {
                const d = {
                    nama_pemilik: 'MOMOH MIHA***',
                    nomor_paspor: 'Passport  X7943187',
                    tanggal_lahir: '1963-07-01',
                    no_dokumen: 'E26-0003708857',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708857.png',
