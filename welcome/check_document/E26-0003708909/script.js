document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708909') {
                const d = {
                    nama_pemilik: 'AI DE***',
                    nomor_paspor: 'Passport  X8985595',
                    tanggal_lahir: '1986-02-28',
                    no_dokumen: 'E26-0003708909',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708909.png',
