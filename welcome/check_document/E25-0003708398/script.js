document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708398') {
                const d = {
                    nama_pemilik: 'SITI MAISU***',
                    nomor_paspor: 'Passport  E7764849',
                    tanggal_lahir: '1970-09-12',
                    no_dokumen: 'E25-0003708398',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708398.png',
