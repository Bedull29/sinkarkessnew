document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708497') {
                const d = {
                    nama_pemilik: 'AZIZA NURFAZZILLA FANSY***',
                    nomor_paspor: 'Passport  X8022051',
                    tanggal_lahir: '2024-12-21',
                    no_dokumen: 'E25-0003708497',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708497.png',
