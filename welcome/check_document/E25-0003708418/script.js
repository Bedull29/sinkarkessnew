document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708418') {
                const d = {
                    nama_pemilik: 'FAIZAN ABDURRAH***',
                    nomor_paspor: 'Passport  X7215548',
                    tanggal_lahir: '2025-09-13',
                    no_dokumen: 'E25-0003708418',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708418.png',
