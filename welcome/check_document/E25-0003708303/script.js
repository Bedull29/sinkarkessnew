document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708303') {
                const d = {
                    nama_pemilik: 'RIFALDI SULFIANS***',
                    nomor_paspor: 'Passport  E7021201',
                    tanggal_lahir: '1998-01-10',
                    no_dokumen: 'E25-0003708303',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708303.png',
