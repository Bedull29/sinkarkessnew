document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708982') {
                const d = {
                    nama_pemilik: 'RAHILAH JANTERA ABDUL***',
                    nomor_paspor: 'Passport  X8499218',
                    tanggal_lahir: '1960-05-14',
                    no_dokumen: 'E26-0003708982',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708982.png',
