document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708921') {
                const d = {
                    nama_pemilik: 'PAOSAH MARLI***',
                    nomor_paspor: 'Passport  X8131773',
                    tanggal_lahir: '1988-07-01',
                    no_dokumen: 'E26-0003708921',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708921.png',
