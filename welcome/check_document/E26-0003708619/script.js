document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708619') {
                const d = {
                    nama_pemilik: 'NATA K***',
                    nomor_paspor: 'Passport  X8507106',
                    tanggal_lahir: '1966-07-01',
                    no_dokumen: 'E26-0003708619',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708619.png',
