document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708823') {
                const d = {
                    nama_pemilik: 'RIZKI ABDILAH SAMS***',
                    nomor_paspor: 'Passport  X6693043',
                    tanggal_lahir: '1955-07-27',
                    no_dokumen: 'E26-0003708823',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708823.png',
