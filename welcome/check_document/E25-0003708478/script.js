document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708478') {
                const d = {
                    nama_pemilik: 'RAHMAD FAUZI NAW***',
                    nomor_paspor: 'Passport  X9009022',
                    tanggal_lahir: '1986-05-24',
                    no_dokumen: 'E25-0003708478',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708478.png',
