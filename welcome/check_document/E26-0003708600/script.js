document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708600') {
                const d = {
                    nama_pemilik: 'RAHIMAH BASUNI ***',
                    nomor_paspor: 'Passport  X8502531',
                    tanggal_lahir: '1986-03-07',
                    no_dokumen: 'E26-0003708600',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708600.png',
