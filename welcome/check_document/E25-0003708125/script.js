document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708125') {
                const d = {
                    nama_pemilik: 'ALIMUN SI***',
                    nomor_paspor: 'Passport  X8130429',
                    tanggal_lahir: '1953-11-04',
                    no_dokumen: 'E25-0003708125',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708125.png',
