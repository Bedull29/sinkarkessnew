document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708598') {
                const d = {
                    nama_pemilik: 'PAIKEM MUSNI DONO R***',
                    nomor_paspor: 'Passport  X8500117',
                    tanggal_lahir: '1973-01-05',
                    no_dokumen: 'E26-0003708598',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708598.png',
