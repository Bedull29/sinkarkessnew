document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708676') {
                const d = {
                    nama_pemilik: 'MUHAMMAD YUSUF ABDUL WA***',
                    nomor_paspor: 'Passport  X8506493',
                    tanggal_lahir: '1957-03-14',
                    no_dokumen: 'E26-0003708676',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708676.png',
