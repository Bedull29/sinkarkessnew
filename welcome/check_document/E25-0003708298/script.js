document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708298') {
                const d = {
                    nama_pemilik: 'AMRIAH BINTI ABDUL***',
                    nomor_paspor: 'Passport  X6931516',
                    tanggal_lahir: '1971-09-07',
                    no_dokumen: 'E25-0003708298',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708298.png',
