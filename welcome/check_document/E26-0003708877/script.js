document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708877') {
                const d = {
                    nama_pemilik: 'JUNAIDI NASRUDDDIN KHAT***',
                    nomor_paspor: 'Passport  X9260704',
                    tanggal_lahir: '1975-07-17',
                    no_dokumen: 'E26-0003708877',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708877.png',
