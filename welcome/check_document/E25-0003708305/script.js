document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708305') {
                const d = {
                    nama_pemilik: 'KOBRI BIN YU***',
                    nomor_paspor: 'Passport  X8285600',
                    tanggal_lahir: '1965-06-27',
                    no_dokumen: 'E25-0003708305',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708305.png',
