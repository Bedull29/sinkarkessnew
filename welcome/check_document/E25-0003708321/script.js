document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708321') {
                const d = {
                    nama_pemilik: 'MUHAMMAD NUR FI***',
                    nomor_paspor: 'Passport  X2215236',
                    tanggal_lahir: '2009-08-21',
                    no_dokumen: 'E25-0003708321',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708321.png',
