document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708327') {
                const d = {
                    nama_pemilik: 'AMIN PAT***',
                    nomor_paspor: 'Passport  X8916747',
                    tanggal_lahir: '1949-01-05',
                    no_dokumen: 'E25-0003708327',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708327.png',
