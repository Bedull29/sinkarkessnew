document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708220') {
                const d = {
                    nama_pemilik: 'SURYATI MUHAMMAD ROS***',
                    nomor_paspor: 'Passport  E3337195',
                    tanggal_lahir: '1959-12-15',
                    no_dokumen: 'E25-0003708220',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708220.png',
