document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708633') {
                const d = {
                    nama_pemilik: 'AISYAH TUHA***',
                    nomor_paspor: 'Passport  X8506964',
                    tanggal_lahir: '1976-07-01',
                    no_dokumen: 'E26-0003708633',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708633.png',
