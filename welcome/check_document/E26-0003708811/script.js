document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708811') {
                const d = {
                    nama_pemilik: 'RAWIYAH MONAKIT MAS***',
                    nomor_paspor: 'Passport  C9523710',
                    tanggal_lahir: '1969-07-27',
                    no_dokumen: 'E26-0003708811',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708811.png',
