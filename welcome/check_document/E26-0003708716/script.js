document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708716') {
                const d = {
                    nama_pemilik: 'RUMINAH NAS***',
                    nomor_paspor: 'Passport  X7136221',
                    tanggal_lahir: '1974-12-20',
                    no_dokumen: 'E26-0003708716',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708716.png',
