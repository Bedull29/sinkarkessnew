document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708849') {
                const d = {
                    nama_pemilik: 'MUZANI H ABD F***',
                    nomor_paspor: 'Passport  X8572265',
                    tanggal_lahir: '1981-11-25',
                    no_dokumen: 'E26-0003708849',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708849.png',
