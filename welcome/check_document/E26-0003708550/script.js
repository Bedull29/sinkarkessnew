document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708550') {
                const d = {
                    nama_pemilik: 'ROSITA S***',
                    nomor_paspor: 'Passport  X7533642',
                    tanggal_lahir: '1994-04-08',
                    no_dokumen: 'E26-0003708550',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708550.png',
