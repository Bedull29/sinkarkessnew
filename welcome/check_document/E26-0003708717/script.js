document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708717') {
                const d = {
                    nama_pemilik: 'LISTYORINI SUPA***',
                    nomor_paspor: 'Passport  X7136203',
                    tanggal_lahir: '1980-06-17',
                    no_dokumen: 'E26-0003708717',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708717.png',
