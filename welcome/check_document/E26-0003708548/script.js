document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708548') {
                const d = {
                    nama_pemilik: 'SITI HAFI***',
                    nomor_paspor: 'Passport  E7079553',
                    tanggal_lahir: '2000-08-02',
                    no_dokumen: 'E26-0003708548',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708548.png',
