document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708964') {
                const d = {
                    nama_pemilik: 'LAILA MAWARNI KURDIANS***',
                    nomor_paspor: 'Passport  X8506457',
                    tanggal_lahir: '1982-07-12',
                    no_dokumen: 'E26-0003708964',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708964.png',
