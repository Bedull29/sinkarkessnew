document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708846') {
                const d = {
                    nama_pemilik: 'MUHAMMAD RHAYYAN AFWA***',
                    nomor_paspor: 'Passport  X8508312',
                    tanggal_lahir: '1996-08-26',
                    no_dokumen: 'E26-0003708846',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708846.png',
