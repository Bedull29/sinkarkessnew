document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708429') {
                const d = {
                    nama_pemilik: 'MUH AK***',
                    nomor_paspor: 'Passport  X5263299',
                    tanggal_lahir: '2003-05-10',
                    no_dokumen: 'E25-0003708429',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708429.png',
