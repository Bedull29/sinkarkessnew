document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708290') {
                const d = {
                    nama_pemilik: 'ZAINAL ABI***',
                    nomor_paspor: 'Passport  X8061881',
                    tanggal_lahir: '1959-12-30',
                    no_dokumen: 'E25-0003708290',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708290.png',
