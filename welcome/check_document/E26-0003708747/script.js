document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708747') {
                const d = {
                    nama_pemilik: 'AULIA AZIZAH M*** ',
                    nomor_paspor: 'Passport  E7000485',
                    tanggal_lahir: '1999-10-27',
                    no_dokumen: 'E26-0003708747',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2024-06-11',
                    valid_until: '2027-06-10',
                    faskes: 'KLINIK ADANI',
                    dokter: 'RASYIDAH, MD, M.Kes',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708747.png',
