document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708637') {
                const d = {
                    nama_pemilik: 'RIZKY WAHY***',
                    nomor_paspor: 'Passport  X8507151',
                    tanggal_lahir: '2010-05-16',
                    no_dokumen: 'E26-0003708637',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708637.png',
