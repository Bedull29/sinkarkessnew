document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708490') {
                const d = {
                    nama_pemilik: 'UYEN HERMAW***',
                    nomor_paspor: 'Passport  X8936704',
                    tanggal_lahir: '1975-05-14',
                    no_dokumen: 'E25-0003708490',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708490.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-05-29',
                    valid_until2: '2027-05-29'
                };
