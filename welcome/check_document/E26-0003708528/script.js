document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708528') {
                const d = {
                    nama_pemilik: 'DWI LISTIY***',
                    nomor_paspor: 'Passport  X9031295',
                    tanggal_lahir: '1990-06-02',
                    no_dokumen: 'E26-0003708528',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708528.png',
