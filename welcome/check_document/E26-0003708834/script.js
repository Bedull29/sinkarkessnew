document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708834') {
                const d = {
                    nama_pemilik: 'LASIAN ISKAN***',
                    nomor_paspor: 'Passport  E9922612',
                    tanggal_lahir: '1967-04-20',
                    no_dokumen: 'E26-0003708834',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708834.png',
