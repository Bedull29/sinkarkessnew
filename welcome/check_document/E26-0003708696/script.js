document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708696') {
                const d = {
                    nama_pemilik: 'CIPTO KARYO WIY***',
                    nomor_paspor: 'Passport  X7136294',
                    tanggal_lahir: '1964-10-19',
                    no_dokumen: 'E26-0003708696',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708696.png',
