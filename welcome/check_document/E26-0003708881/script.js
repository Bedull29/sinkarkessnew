document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708881') {
                const d = {
                    nama_pemilik: 'BAHRUL JAMIL SOF***',
                    nomor_paspor: 'Passport  X1358031',
                    tanggal_lahir: '1968-06-03',
                    no_dokumen: 'E26-0003708881',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708881.png',
