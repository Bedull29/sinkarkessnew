document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708370') {
                const d = {
                    nama_pemilik: 'VIVIEN SYLVI***',
                    nomor_paspor: 'Passport  E5502261',
                    tanggal_lahir: '1969-06-25',
                    no_dokumen: 'E25-0003708370',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-02-20',
                    valid_until: '2029-02-20',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708370.png',
