document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708885') {
                const d = {
                    nama_pemilik: 'PUTRI AIS***',
                    nomor_paspor: 'Passport  X9258536',
                    tanggal_lahir: '2009-11-23',
                    no_dokumen: 'E26-0003708885',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708885.png',
