document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708139') {
                const d = {
                    nama_pemilik: 'ENDI SUPE***',
                    nomor_paspor: 'Passport  X7571153',
                    tanggal_lahir: '1950-04-06',
                    no_dokumen: 'E25-0003708139',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708139.png',
