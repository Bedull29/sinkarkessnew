document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708708') {
                const d = {
                    nama_pemilik: 'WAGIYEM KROMO KA***',
                    nomor_paspor: 'Passport  X7136100',
                    tanggal_lahir: '1963-09-02',
                    no_dokumen: 'E26-0003708708',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708708.png',
