document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708833') {
                const d = {
                    nama_pemilik: 'MAWADDAH AHMAD MUJA***',
                    nomor_paspor: 'Passport  E9922610',
                    tanggal_lahir: '2008-01-28',
                    no_dokumen: 'E26-0003708833',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708833.png',
