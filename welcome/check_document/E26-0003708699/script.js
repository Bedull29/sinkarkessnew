document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708699') {
                const d = {
                    nama_pemilik: 'SATIMAN KARIYO KR***',
                    nomor_paspor: 'Passport  X7136219',
                    tanggal_lahir: '1948-04-12',
                    no_dokumen: 'E26-0003708699',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708699.png',
