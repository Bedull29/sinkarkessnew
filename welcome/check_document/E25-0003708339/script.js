document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708339') {
                const d = {
                    nama_pemilik: 'FEBRIYANSYAH SUHARMAN TANJ***',
                    nomor_paspor: 'Passport  X7356978',
                    tanggal_lahir: '1987-02-14',
                    no_dokumen: 'E25-0003708339',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708339.png',
