document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708184') {
                const d = {
                    nama_pemilik: 'ZULFA***',
                    nomor_paspor: 'Passport  X3713604',
                    tanggal_lahir: '1994-07-11',
                    no_dokumen: 'E25-0003708184',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708184.png',
