document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708944') {
                const d = {
                    nama_pemilik: 'MURIYA DE***',
                    nomor_paspor: 'Passport  X9701728',
                    tanggal_lahir: '1958-09-10',
                    no_dokumen: 'E26-0003708944',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708944.png',
