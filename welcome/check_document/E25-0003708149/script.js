document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708149') {
                const d = {
                    nama_pemilik: 'NURUN NA***',
                    nomor_paspor: 'Passport  X1392806',
                    tanggal_lahir: '1985-08-10',
                    no_dokumen: 'E25-0003708149',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708149.png',
