document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708282') {
                const d = {
                    nama_pemilik: 'FAKHRUDDIN SUFIYAN SI***',
                    nomor_paspor: 'Passport  E6179085',
                    tanggal_lahir: '1975-08-04',
                    no_dokumen: 'E25-0003708282',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708282.png',
