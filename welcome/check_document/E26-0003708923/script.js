document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708923') {
                const d = {
                    nama_pemilik: 'SARNA AK***',
                    nomor_paspor: 'Passport  X8131838',
                    tanggal_lahir: '1970-07-01',
                    no_dokumen: 'E26-0003708923',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708923.png',
