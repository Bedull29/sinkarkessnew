document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708403') {
                const d = {
                    nama_pemilik: 'SALMAN FAK***',
                    nomor_paspor: 'Passport  X3069484',
                    tanggal_lahir: '1979-07-22',
                    no_dokumen: 'E25-0003708403',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708403.png',
