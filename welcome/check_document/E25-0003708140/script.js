document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708140') {
                const d = {
                    nama_pemilik: 'WIWI WINARNING***',
                    nomor_paspor: 'Passport  X7256620',
                    tanggal_lahir: '1967-01-04',
                    no_dokumen: 'E25-0003708140',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708140.png',
