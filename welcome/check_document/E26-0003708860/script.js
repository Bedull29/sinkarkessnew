document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708860') {
                const d = {
                    nama_pemilik: 'NIA KUR***',
                    nomor_paspor: 'Passport  X7937570',
                    tanggal_lahir: '2000-01-17',
                    no_dokumen: 'E26-0003708860',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708860.png',
