document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708745') {
                const d = {
                    nama_pemilik: 'MUZLI YURNA***',
                    nomor_paspor: 'Passport  X7784575',
                    tanggal_lahir: '1969-04-14',
                    no_dokumen: 'E26-0003708745',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708745.png',
