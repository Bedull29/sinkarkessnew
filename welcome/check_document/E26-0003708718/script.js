document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708718') {
                const d = {
                    nama_pemilik: 'MUHAMMAD YUSUF KA***',
                    nomor_paspor: 'Passport  X7136103',
                    tanggal_lahir: '1971-07-20',
                    no_dokumen: 'E26-0003708718',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708718.png',
