document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708516') {
                const d = {
                    nama_pemilik: 'MARYATI MARYA***',
                    nomor_paspor: 'Passport  X9030888',
                    tanggal_lahir: '1978-06-08',
                    no_dokumen: 'E26-0003708516',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708516.png',
