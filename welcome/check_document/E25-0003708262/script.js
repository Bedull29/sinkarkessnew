document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708262') {
                const d = {
                    nama_pemilik: 'RAYYA AHMAD RAMAD***',
                    nomor_paspor: 'Passport  X8700672',
                    tanggal_lahir: '2004-10-29',
                    no_dokumen: 'E25-0003708262',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708262.png',
