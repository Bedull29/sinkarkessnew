document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708383') {
                const d = {
                    nama_pemilik: 'SITI CHODIJAH ABDUL ROH***',
                    nomor_paspor: 'Passport  X8520177',
                    tanggal_lahir: '1956-06-05',
                    no_dokumen: 'E25-0003708383',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-02-28',
                    valid_until: '2029-02-28',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708383.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-02-28',
                    valid_until2: '2027-02-28'
                };
