document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708702') {
                const d = {
                    nama_pemilik: 'KATIMEN KASAN MA***',
                    nomor_paspor: 'Passport  X7136293',
                    tanggal_lahir: '1956-06-15',
                    no_dokumen: 'E26-0003708702',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708702.png',
