document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708240') {
                const d = {
                    nama_pemilik: 'SITI BAL***',
                    nomor_paspor: 'Passport  X4897575',
                    tanggal_lahir: '2002-01-22',
                    no_dokumen: 'E25-0003708240',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708240.png',
