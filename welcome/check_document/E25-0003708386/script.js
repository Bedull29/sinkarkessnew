document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708386') {
                const d = {
                    nama_pemilik: 'ABD BASIT BIN NORC***',
                    nomor_paspor: 'Passport  E6872556',
                    tanggal_lahir: '1971-10-15',
                    no_dokumen: 'E25-0003708386',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708386.png',
