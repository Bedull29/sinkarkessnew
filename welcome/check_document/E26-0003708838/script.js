document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708838') {
                const d = {
                    nama_pemilik: 'MASKUNI BAS***',
                    nomor_paspor: 'Passport  E9922572',
                    tanggal_lahir: '1967-06-11',
                    no_dokumen: 'E26-0003708838',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708838.png',
