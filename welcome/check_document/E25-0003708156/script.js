document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708156') {
                const d = {
                    nama_pemilik: 'FARIZA SAFA AZ***',
                    nomor_paspor: 'Passport  E8617546',
                    tanggal_lahir: '2007-03-19',
                    no_dokumen: 'E25-0003708156',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708156.png',
