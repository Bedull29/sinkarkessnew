document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708511') {
                const d = {
                    nama_pemilik: 'NURYANTO KA***',
                    nomor_paspor: 'Passport  X8964905',
                    tanggal_lahir: '1970-01-07',
                    no_dokumen: 'E26-0003708511',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708511.png',
