document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708709') {
                const d = {
                    nama_pemilik: 'SUBUR SA***',
                    nomor_paspor: 'Passport  X7136290',
                    tanggal_lahir: '1971-11-19',
                    no_dokumen: 'E26-0003708709',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708709.png',
