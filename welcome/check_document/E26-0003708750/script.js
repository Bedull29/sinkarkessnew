document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708750') {
                const d = {
                    nama_pemilik: 'AHMAD WIL***',
                    nomor_paspor: 'Passport  E5987215',
                    tanggal_lahir: '2008-09-28',
                    no_dokumen: 'E26-0003708750',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708750.png',
