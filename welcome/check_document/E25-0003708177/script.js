document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708177') {
                const d = {
                    nama_pemilik: 'NURAFIDAH MUHAM***',
                    nomor_paspor: 'Passport  X8061173',
                    tanggal_lahir: '1972-08-30',
                    no_dokumen: 'E25-0003708177',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708177.png',
