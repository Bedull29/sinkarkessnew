document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708847') {
                const d = {
                    nama_pemilik: 'WILDA YA***',
                    nomor_paspor: 'Passport  X8507776',
                    tanggal_lahir: '1997-12-24',
                    no_dokumen: 'E26-0003708847',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708847.png',
