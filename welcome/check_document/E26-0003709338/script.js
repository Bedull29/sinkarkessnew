document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709338') {
                const d = {
                    nama_pemilik: 'ANDRI ROS***',
                    nomor_paspor: 'Passport  X3158***',
                    tanggal_lahir: '1975-12-30',
                    no_dokumen: 'E26-0003709338',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709338.png',
