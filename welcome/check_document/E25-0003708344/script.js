document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708344') {
                const d = {
                    nama_pemilik: 'LISNA D***',
                    nomor_paspor: 'Passport  X8060507',
                    tanggal_lahir: '1995-01-06',
                    no_dokumen: 'E25-0003708344',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708344.png',
