document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709384') {
                const d = {
                    nama_pemilik: 'SHEZAN ZEA SFAL***',
                    nomor_paspor: 'Passport  E4571***',
                    tanggal_lahir: '2017-04-19',
                    no_dokumen: 'E26-0003709384',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709384.png',
