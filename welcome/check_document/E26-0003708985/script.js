document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708985') {
                const d = {
                    nama_pemilik: 'NURHAYATI DADI SA***',
                    nomor_paspor: 'Passport E8600010',
                    tanggal_lahir: '1986-06-09',
                    no_dokumen: 'E26-0003708985',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2025-03-07',
                    valid_until: '2028-03-07',
                    faskes: 'Klinik Griya Husada',
                    dokter: 'dr.Fakhri Haidar Anis',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708985.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-06-24',
                    valid_until2: '2027-06-24',
                ...
                // Use separate faskes/dokter for Polio
