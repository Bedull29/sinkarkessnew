document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708786') {
                const d = {
                    nama_pemilik: 'RIANIE DEMAR LA***',
                    nomor_paspor: 'Passport  X8375634',
                    tanggal_lahir: '1967-11-05',
                    no_dokumen: 'E26-0003708786',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708786.png',
