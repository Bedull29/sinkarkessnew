document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708190') {
                const d = {
                    nama_pemilik: 'MARSUKI MAR***',
                    nomor_paspor: 'Passport  X6609145',
                    tanggal_lahir: '1955-11-07',
                    no_dokumen: 'E25-0003708190',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708190.png',
