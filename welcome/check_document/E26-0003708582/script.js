document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708582') {
                const d = {
                    nama_pemilik: 'SAMSUDDIN SIAN KA***',
                    nomor_paspor: 'Passport  X8506386',
                    tanggal_lahir: '1950-06-17',
                    no_dokumen: 'E26-0003708582',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708582.png',
