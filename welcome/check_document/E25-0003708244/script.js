document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708244') {
                const d = {
                    nama_pemilik: 'ZETRI***',
                    nomor_paspor: 'Passport  E8734177',
                    tanggal_lahir: '1964-08-28',
                    no_dokumen: 'E25-0003708244',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708244.png',
