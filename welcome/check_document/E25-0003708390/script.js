document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708390') {
                const d = {
                    nama_pemilik: 'ROHMAH TUR***',
                    nomor_paspor: 'Passport  X8514058',
                    tanggal_lahir: '1965-05-15',
                    no_dokumen: 'E25-0003708390',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708390.png',
