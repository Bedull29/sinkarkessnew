document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708781') {
                const d = {
                    nama_pemilik: 'ARKUYIN NYANGAN I***',
                    nomor_paspor: 'Passport  X8375658',
                    tanggal_lahir: '1965-10-10',
                    no_dokumen: 'E26-0003708781',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708781.png',
