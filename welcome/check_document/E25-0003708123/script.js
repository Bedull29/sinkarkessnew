document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708123') {
                const d = {
                    nama_pemilik: 'DEDEH NIDAUL HASA***',
                    nomor_paspor: 'Passport  E0167991',
                    tanggal_lahir: '1966-08-15',
                    no_dokumen: 'E25-0003708123',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2025-12-28',
                    valid_until: '2028-12-28',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708123.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2025-12-28',
                    valid_until2: '2026-12-28'
                };
