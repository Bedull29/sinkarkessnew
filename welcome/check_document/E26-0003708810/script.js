document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708810') {
                const d = {
                    nama_pemilik: 'HASANA DULHA***',
                    nomor_paspor: 'Passport  X9698378',
                    tanggal_lahir: '1968-02-16',
                    no_dokumen: 'E26-0003708810',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708810.png',
