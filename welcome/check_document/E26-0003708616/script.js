document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708616') {
                const d = {
                    nama_pemilik: 'ARBAYAH ABDUL***',
                    nomor_paspor: 'Passport  X8507105',
                    tanggal_lahir: '1969-11-14',
                    no_dokumen: 'E26-0003708616',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708616.png',
