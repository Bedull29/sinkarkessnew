document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708486') {
                const d = {
                    nama_pemilik: 'SOPIAH AHMAD UM***',
                    nomor_paspor: 'Passport  X4610485',
                    tanggal_lahir: '1987-08-20',
                    no_dokumen: 'E25-0003708486',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2025-05-14',
                    valid_until: '2028-05-14',
                    faskes: 'Klinik Family Care',
                    dokter: 'dr. Zainul Muttaqin, M.M',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708486.png',
