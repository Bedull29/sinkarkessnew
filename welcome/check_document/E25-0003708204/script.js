document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708204') {
                const d = {
                    nama_pemilik: 'SUYATMI KARTO SENT***',
                    nomor_paspor: 'Passport  X6637936',
                    tanggal_lahir: '1967-01-27',
                    no_dokumen: 'E25-0003708204',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708204.png',
