document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708450') {
                const d = {
                    nama_pemilik: 'MARDIANA A***',
                    nomor_paspor: 'Passport  X8318772',
                    tanggal_lahir: '1971-03-30',
                    no_dokumen: 'E25-0003708450',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708450.png',
