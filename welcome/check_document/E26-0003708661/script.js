document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708661') {
                const d = {
                    nama_pemilik: 'ALLURA ZEA NAFE***',
                    nomor_paspor: 'Passport  X7942427',
                    tanggal_lahir: '2025-05-05',
                    no_dokumen: 'E26-0003708661',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708661.png',
