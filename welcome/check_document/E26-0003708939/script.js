document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708939') {
                const d = {
                    nama_pemilik: 'SAINI MAR***',
                    nomor_paspor: 'Passport  X9701730',
                    tanggal_lahir: '1959-07-01',
                    no_dokumen: 'E26-0003708939',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708939.png',
