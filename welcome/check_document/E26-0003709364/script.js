document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709364') {
                const d = {
                    nama_pemilik: 'SYAHERMAN SYAH***',
                    nomor_paspor: 'Passport  X9005***',
                    tanggal_lahir: '1962-10-02',
                    no_dokumen: 'E26-0003709364',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709364.png',
