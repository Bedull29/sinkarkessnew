document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708314') {
                const d = {
                    nama_pemilik: 'MUHAMMAD AFI ABHARU***',
                    nomor_paspor: 'Passport  X6663258',
                    tanggal_lahir: '2013-07-16',
                    no_dokumen: 'E25-0003708314',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708314.png',
