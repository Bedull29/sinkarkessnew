document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708684') {
                const d = {
                    nama_pemilik: 'ANAINAH HASANI SA***',
                    nomor_paspor: 'Passport  X8397600',
                    tanggal_lahir: '1967-11-10',
                    no_dokumen: 'E26-0003708684',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708684.png',
