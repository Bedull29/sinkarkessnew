document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708731') {
                const d = {
                    nama_pemilik: 'MAK MURI***',
                    nomor_paspor: 'Passport  X9137913',
                    tanggal_lahir: '1974-08-14',
                    no_dokumen: 'E26-0003708731',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708731.png',
