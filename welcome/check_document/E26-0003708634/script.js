document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708634') {
                const d = {
                    nama_pemilik: 'NORAIDA MUHAMMAD ARI***',
                    nomor_paspor: 'Passport  X8507336',
                    tanggal_lahir: '2000-12-07',
                    no_dokumen: 'E26-0003708634',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708634.png',
