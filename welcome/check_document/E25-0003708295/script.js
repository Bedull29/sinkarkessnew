document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708295') {
                const d = {
                    nama_pemilik: 'WILDANA N***',
                    nomor_paspor: 'Passport  X6931511',
                    tanggal_lahir: '2005-10-19',
                    no_dokumen: 'E25-0003708295',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708295.png',
