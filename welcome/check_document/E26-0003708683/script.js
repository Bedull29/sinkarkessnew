document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708683') {
                const d = {
                    nama_pemilik: 'MULIAH AINI A***',
                    nomor_paspor: 'Passport  X8397576',
                    tanggal_lahir: '1954-04-04',
                    no_dokumen: 'E26-0003708683',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708683.png',
