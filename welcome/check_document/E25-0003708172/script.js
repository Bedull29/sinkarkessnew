document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708172') {
                const d = {
                    nama_pemilik: 'MUTIA SAL***',
                    nomor_paspor: 'Passport  X8061165',
                    tanggal_lahir: '1992-09-12',
                    no_dokumen: 'E25-0003708172',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708172.png',
