document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708176') {
                const d = {
                    nama_pemilik: 'WAHYUNA M A***',
                    nomor_paspor: 'Passport  E8979820',
                    tanggal_lahir: '1969-03-12',
                    no_dokumen: 'E25-0003708176',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708176.png',
