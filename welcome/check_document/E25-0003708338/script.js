document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708338') {
                const d = {
                    nama_pemilik: 'DJASNIMAR JANI***',
                    nomor_paspor: 'Passport  X7356905',
                    tanggal_lahir: '1965-03-04',
                    no_dokumen: 'E25-0003708338',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708338.png',
