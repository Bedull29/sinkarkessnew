document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708407') {
                const d = {
                    nama_pemilik: 'HENDRI SAPU***',
                    nomor_paspor: 'Passport  X8072720',
                    tanggal_lahir: '1980-10-30',
                    no_dokumen: 'E25-0003708407',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708407.png',
