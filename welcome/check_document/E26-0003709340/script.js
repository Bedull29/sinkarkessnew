document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709340') {
                const d = {
                    nama_pemilik: 'ABU FA***',
                    nomor_paspor: 'Passport  X8997***',
                    tanggal_lahir: '1965-04-21',
                    no_dokumen: 'E26-0003709340',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709340.png',
