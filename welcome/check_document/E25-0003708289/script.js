document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708289') {
                const d = {
                    nama_pemilik: 'ERMAYANI SYAR***',
                    nomor_paspor: 'Passport  E3651872',
                    tanggal_lahir: '1957-01-30',
                    no_dokumen: 'E25-0003708289',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2025-02-03',
                    valid_until: '2028-02-17',
                    faskes: 'RSAB Harapan Kita',
                    dokter: 'Dr. IRMA JULIASARI',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708289.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-01-23',
                    valid_until2: '2027-01-23',
