document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708148') {
                const d = {
                    nama_pemilik: 'UCI SANUSI MA***',
                    nomor_paspor: 'Passport  X4452231',
                    tanggal_lahir: '1964-10-01',
                    no_dokumen: 'E25-0003708148',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2025-02-15',
                    valid_until: '2028-02-15',
                    faskes: 'KLINIK SOFIE',
                    dokter: 'RS FATMAWATI',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708148.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2025-12-26',
                    valid_until2: '2026-12-26',
