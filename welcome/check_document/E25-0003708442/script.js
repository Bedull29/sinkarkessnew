document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708442') {
                const d = {
                    nama_pemilik: 'AHMAD DUMI***',
                    nomor_paspor: 'Passport  X7819558',
                    tanggal_lahir: '1971-03-21',
                    no_dokumen: 'E25-0003708442',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708442.png',
