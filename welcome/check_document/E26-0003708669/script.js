document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708669') {
                const d = {
                    nama_pemilik: 'AHMAD SAIRAJI MUHAMMAD SAB***',
                    nomor_paspor: 'Passport  X8508158',
                    tanggal_lahir: '1984-01-29',
                    no_dokumen: 'E26-0003708669',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708669.png',
