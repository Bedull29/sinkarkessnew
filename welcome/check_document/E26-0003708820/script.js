document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708820') {
                const d = {
                    nama_pemilik: 'ADAM ABDUL ROH***',
                    nomor_paspor: 'Passport  X7942599',
                    tanggal_lahir: '1998-07-31',
                    no_dokumen: 'E26-0003708820',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708820.png',
