document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708302') {
                const d = {
                    nama_pemilik: 'FARIDA AHMAD IBRA***',
                    nomor_paspor: 'Passport  E1874784',
                    tanggal_lahir: '1970-03-01',
                    no_dokumen: 'E25-0003708302',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708302.png',
