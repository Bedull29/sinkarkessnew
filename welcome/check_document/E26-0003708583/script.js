document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708583') {
                const d = {
                    nama_pemilik: 'PARIDAH ARJAN SULAI***',
                    nomor_paspor: 'Passport  X8506875',
                    tanggal_lahir: '1974-05-05',
                    no_dokumen: 'E26-0003708583',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708583.png',
