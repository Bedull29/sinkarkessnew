document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708911') {
                const d = {
                    nama_pemilik: 'KUSNO NGATI***',
                    nomor_paspor: 'Passport  X8255020',
                    tanggal_lahir: '1965-07-17',
                    no_dokumen: 'E26-0003708911',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708911.png',
