document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708837') {
                const d = {
                    nama_pemilik: 'ALUI U***',
                    nomor_paspor: 'Passport  E9922614',
                    tanggal_lahir: '1957-12-10',
                    no_dokumen: 'E26-0003708837',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708837.png',
