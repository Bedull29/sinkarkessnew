document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708278') {
                const d = {
                    nama_pemilik: 'SOLIHAT AZHARI BAHRU***',
                    nomor_paspor: 'Passport  X8148400',
                    tanggal_lahir: '1987-11-29',
                    no_dokumen: 'E25-0003708278',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708278.png',
