document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708916') {
                const d = {
                    nama_pemilik: 'RIBUT SUSANTO SUNI***',
                    nomor_paspor: 'Passport  X9562935',
                    tanggal_lahir: '1963-09-04',
                    no_dokumen: 'E26-0003708916',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708916.png',
