document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708579') {
                const d = {
                    nama_pemilik: 'MAHRITA SALAD***',
                    nomor_paspor: 'Passport  X8506874',
                    tanggal_lahir: '1962-07-01',
                    no_dokumen: 'E26-0003708579',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708579.png',
