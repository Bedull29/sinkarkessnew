document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708150') {
                const d = {
                    nama_pemilik: 'HASAN FA***',
                    nomor_paspor: 'Passport  X1392945',
                    tanggal_lahir: '1979-01-10',
                    no_dokumen: 'E25-0003708150',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708150.png',
