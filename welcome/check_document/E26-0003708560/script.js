document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708560') {
                const d = {
                    nama_pemilik: 'ADI N***',
                    nomor_paspor: 'Passport  X9297588',
                    tanggal_lahir: '1971-09-27',
                    no_dokumen: 'E26-0003708560',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708560.png',
