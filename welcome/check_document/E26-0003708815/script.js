document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708815') {
                const d = {
                    nama_pemilik: 'UU EN***',
                    nomor_paspor: 'Passport  X7938086',
                    tanggal_lahir: '1953-04-28',
                    no_dokumen: 'E26-0003708815',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708815.png',
