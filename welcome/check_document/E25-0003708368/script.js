document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708368') {
                const d = {
                    nama_pemilik: 'SUSI SURY***',
                    nomor_paspor: 'Passport  X8934102',
                    tanggal_lahir: '1969-06-11',
                    no_dokumen: 'E25-0003708368',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-02-26',
                    valid_until: '2029-02-26',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708368.png',
