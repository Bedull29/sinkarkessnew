document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708212') {
                const d = {
                    nama_pemilik: 'AAH SURY***',
                    nomor_paspor: 'Passport  X7937592',
                    tanggal_lahir: '1975-02-06',
                    no_dokumen: 'E25-0003708212',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708212.png',
