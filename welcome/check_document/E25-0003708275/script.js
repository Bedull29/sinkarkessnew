document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708275') {
                const d = {
                    nama_pemilik: 'WAHYUDIN DADANG K***',
                    nomor_paspor: 'Passport  E2134831',
                    tanggal_lahir: '1993-10-20',
                    no_dokumen: 'E25-0003708275',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708275.png',
