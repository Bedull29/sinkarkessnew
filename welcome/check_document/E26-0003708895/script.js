document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708895') {
                const d = {
                    nama_pemilik: 'KAYYISA FAR***',
                    nomor_paspor: 'Passport  X9257658',
                    tanggal_lahir: '2008-07-12',
                    no_dokumen: 'E26-0003708895',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708895.png',
