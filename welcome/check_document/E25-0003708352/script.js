document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708352') {
                const d = {
                    nama_pemilik: 'MULYANI MAH***',
                    nomor_paspor: 'Passport  X7708701',
                    tanggal_lahir: '1980-02-01',
                    no_dokumen: 'E25-0003708352',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708352.png',
