document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708258') {
                const d = {
                    nama_pemilik: 'ALI M***',
                    nomor_paspor: 'Passport  X4860289',
                    tanggal_lahir: '1977-02-20',
                    no_dokumen: 'E25-0003708258',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708258.png',
