document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708704') {
                const d = {
                    nama_pemilik: 'JUMI RUKI***',
                    nomor_paspor: 'Passport  X7136289',
                    tanggal_lahir: '1970-07-01',
                    no_dokumen: 'E26-0003708704',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708704.png',
