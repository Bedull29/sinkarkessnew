document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708227') {
                const d = {
                    nama_pemilik: 'SUPRIYANTO SUPIT DURA***',
                    nomor_paspor: 'Passport  X8279371',
                    tanggal_lahir: '1982-05-01',
                    no_dokumen: 'E25-0003708227',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708227.png',
