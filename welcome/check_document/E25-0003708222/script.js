document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708222') {
                const d = {
                    nama_pemilik: 'TESAL BIN M NA***',
                    nomor_paspor: 'Passport  X7058045',
                    tanggal_lahir: '1985-04-24',
                    no_dokumen: 'E25-0003708222',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708222.png',
