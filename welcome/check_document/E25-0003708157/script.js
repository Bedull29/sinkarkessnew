document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708157') {
                const d = {
                    nama_pemilik: 'SYAFAAT RHOMAD***',
                    nomor_paspor: 'Passport  E4230205',
                    tanggal_lahir: '2003-11-19',
                    no_dokumen: 'E25-0003708157',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708157.png',
