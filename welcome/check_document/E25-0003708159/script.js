document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708159') {
                const d = {
                    nama_pemilik: 'M MISBAHKHUL MU***',
                    nomor_paspor: 'Passport  X7186761',
                    tanggal_lahir: '2001-12-13',
                    no_dokumen: 'E25-0003708159',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708159.png',
