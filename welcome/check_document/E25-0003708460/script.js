document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708460') {
                const d = {
                    nama_pemilik: 'SIHMAN MARNO MULY***',
                    nomor_paspor: 'Passport  X9539639',
                    tanggal_lahir: '1973-05-03',
                    no_dokumen: 'E25-0003708460',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-05-21',
                    valid_until: '2029-05-21',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708460.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-05-21',
                    valid_until2: '2027-05-21'
                };
