document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708610') {
                const d = {
                    nama_pemilik: 'NORMAHAYANI BAKERI BAHAU***',
                    nomor_paspor: 'Passport  E2487071',
                    tanggal_lahir: '1961-02-08',
                    no_dokumen: 'E26-0003708610',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708610.png',
