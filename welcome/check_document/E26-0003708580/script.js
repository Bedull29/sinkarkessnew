document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708580') {
                const d = {
                    nama_pemilik: 'M IBNU R***',
                    nomor_paspor: 'Passport  X8506422',
                    tanggal_lahir: '2007-12-12',
                    no_dokumen: 'E26-0003708580',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708580.png',
