document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708544') {
                const d = {
                    nama_pemilik: 'RUDY MULYANI MURJ***',
                    nomor_paspor: 'Passport  X8507248',
                    tanggal_lahir: '1988-12-03',
                    no_dokumen: 'E26-0003708544',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708544.png',
