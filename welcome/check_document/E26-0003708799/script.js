document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708799') {
                const d = {
                    nama_pemilik: 'ZAINABUN GURBA SI***',
                    nomor_paspor: 'Passport  X1562649',
                    tanggal_lahir: '1962-07-01',
                    no_dokumen: 'E26-0003708799',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708799.png',
