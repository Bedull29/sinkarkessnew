document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708753') {
                const d = {
                    nama_pemilik: 'EVA SARI SUMA***',
                    nomor_paspor: 'Passport  X9559892',
                    tanggal_lahir: '1985-09-06',
                    no_dokumen: 'E26-0003708753',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708753.png',
