document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708412') {
                const d = {
                    nama_pemilik: 'FATHIRA SYAHNAB***',
                    nomor_paspor: 'Passport  X8802609',
                    tanggal_lahir: '2006-01-20',
                    no_dokumen: 'E25-0003708412',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708412.png',
