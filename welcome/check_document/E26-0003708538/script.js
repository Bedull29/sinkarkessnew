document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708538') {
                const d = {
                    nama_pemilik: 'KUSMIJAH SUWA***',
                    nomor_paspor: 'Passport  X9032605',
                    tanggal_lahir: '1949-01-01',
                    no_dokumen: 'E26-0003708538',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708538.png',
