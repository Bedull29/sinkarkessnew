document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708940') {
                const d = {
                    nama_pemilik: 'ADI SUCIPTO MOH AD***',
                    nomor_paspor: 'Passport  X9701726',
                    tanggal_lahir: '1958-03-10',
                    no_dokumen: 'E26-0003708940',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708940.png',
