document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708280') {
                const d = {
                    nama_pemilik: 'SRI UMY***',
                    nomor_paspor: 'Passport  X8168455',
                    tanggal_lahir: '1973-03-18',
                    no_dokumen: 'E25-0003708280',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708280.png',
