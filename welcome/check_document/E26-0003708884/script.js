document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708884') {
                const d = {
                    nama_pemilik: 'AHMAD WALI ALKHAL***',
                    nomor_paspor: 'Passport  X9257750',
                    tanggal_lahir: '2013-09-05',
                    no_dokumen: 'E26-0003708884',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708884.png',
