document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708870') {
                const d = {
                    nama_pemilik: 'MAHANI JA***',
                    nomor_paspor: 'Passport  E8547504',
                    tanggal_lahir: '1979-07-01',
                    no_dokumen: 'E26-0003708870',
                    jenis_vaksin: '',
                    tanggal_vaksin: '',
                    valid_until: '',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708870.png',
                ...
                setText('res_valid_polio', formatDate('2026-06-17'));
