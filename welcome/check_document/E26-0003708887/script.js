document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708887') {
                const d = {
                    nama_pemilik: 'AULA MAGHFI***',
                    nomor_paspor: 'Passport  X9261142',
                    tanggal_lahir: '2002-10-20',
                    no_dokumen: 'E26-0003708887',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708887.png',
