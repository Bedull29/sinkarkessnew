document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709363') {
                const d = {
                    nama_pemilik: 'SUPARMAN ABDUL***',
                    nomor_paspor: 'Passport  X7764***',
                    tanggal_lahir: '1983-07-25',
                    no_dokumen: 'E26-0003709363',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709363.png',
