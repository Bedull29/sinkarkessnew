document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708322') {
                const d = {
                    nama_pemilik: 'TAING NURACHMI NAW***',
                    nomor_paspor: 'Passport  X3944361',
                    tanggal_lahir: '1958-06-06',
                    no_dokumen: 'E25-0003708322',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708322.png',
