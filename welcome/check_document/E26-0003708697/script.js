document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708697') {
                const d = {
                    nama_pemilik: 'SATIYEM KASIYO JOKA***',
                    nomor_paspor: 'Passport  X7136214',
                    tanggal_lahir: '1948-10-22',
                    no_dokumen: 'E26-0003708697',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708697.png',
