document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708173') {
                const d = {
                    nama_pemilik: 'MULIA NAD***',
                    nomor_paspor: 'Passport  X8061196',
                    tanggal_lahir: '1997-10-23',
                    no_dokumen: 'E25-0003708173',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708173.png',
