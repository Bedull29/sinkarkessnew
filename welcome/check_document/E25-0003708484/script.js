document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708484') {
                const d = {
                    nama_pemilik: 'MAISYA HUMAIRA RAHMAD FA***',
                    nomor_paspor: 'Passport  X9009021',
                    tanggal_lahir: '2020-06-03',
                    no_dokumen: 'E25-0003708484',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708484.png',
