document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708864') {
                const d = {
                    nama_pemilik: 'N R SITI MAR***',
                    nomor_paspor: 'Passport  X7936303',
                    tanggal_lahir: '1974-08-06',
                    no_dokumen: 'E26-0003708864',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708864.png',
