document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708902') {
                const d = {
                    nama_pemilik: 'MUHAMMAD NA***',
                    nomor_paspor: 'Passport  X9260971',
                    tanggal_lahir: '1987-08-03',
                    no_dokumen: 'E26-0003708902',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708902.png',
