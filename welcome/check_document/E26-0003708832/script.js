document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708832') {
                const d = {
                    nama_pemilik: 'AHMAD JURJANI ISKAN***',
                    nomor_paspor: 'Passport  E9922609',
                    tanggal_lahir: '1979-08-07',
                    no_dokumen: 'E26-0003708832',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708832.png',
