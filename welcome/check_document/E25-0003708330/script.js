document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708330') {
                const d = {
                    nama_pemilik: 'MHD ALFA***',
                    nomor_paspor: 'Passport  X7446267',
                    tanggal_lahir: '1997-01-04',
                    no_dokumen: 'E25-0003708330',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708330.png',
