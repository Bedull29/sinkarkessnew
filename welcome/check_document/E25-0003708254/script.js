document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708254') {
                const d = {
                    nama_pemilik: 'DJAMALUDIN MUS***',
                    nomor_paspor: 'Passport  X6662670',
                    tanggal_lahir: '1956-07-17',
                    no_dokumen: 'E25-0003708254',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708254.png',
