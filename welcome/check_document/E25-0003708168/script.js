document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708168') {
                const d = {
                    nama_pemilik: 'IBNU FA***',
                    nomor_paspor: 'Passport  X8061185',
                    tanggal_lahir: '1981-12-12',
                    no_dokumen: 'E25-0003708168',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708168.png',
