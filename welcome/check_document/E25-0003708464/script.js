document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708464') {
                const d = {
                    nama_pemilik: 'DARI INDAR AR***',
                    nomor_paspor: 'Passport  X9008403',
                    tanggal_lahir: '1977-08-10',
                    no_dokumen: 'E25-0003708464',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708464.png',
