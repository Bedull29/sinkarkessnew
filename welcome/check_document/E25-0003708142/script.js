document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708142') {
                const d = {
                    nama_pemilik: 'YAYAH SYAMS***',
                    nomor_paspor: 'Passport  X7706017',
                    tanggal_lahir: '1959-06-03',
                    no_dokumen: 'E25-0003708142',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708142.png',
