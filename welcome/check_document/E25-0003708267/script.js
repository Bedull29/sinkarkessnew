document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708267') {
                const d = {
                    nama_pemilik: 'BARKAH M***',
                    nomor_paspor: 'Passport  X8699684',
                    tanggal_lahir: '1971-12-25',
                    no_dokumen: 'E25-0003708267',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708267.png',
