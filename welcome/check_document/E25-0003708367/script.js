document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708367') {
                const d = {
                    nama_pemilik: 'SITI ROBIYATUSSAN***',
                    nomor_paspor: 'Passport  X9040110',
                    tanggal_lahir: '2001-07-20',
                    no_dokumen: 'E25-0003708367',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708367.png',
