document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708913') {
                const d = {
                    nama_pemilik: 'MUJI SURIPTO WAR***',
                    nomor_paspor: 'Passport  X9562936',
                    tanggal_lahir: '1963-09-09',
                    no_dokumen: 'E26-0003708913',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708913.png',
