document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708476') {
                const d = {
                    nama_pemilik: 'MUHAMMAD ZAINAL I***',
                    nomor_paspor: 'Passport  X9009023',
                    tanggal_lahir: '2007-11-21',
                    no_dokumen: 'E25-0003708476',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708476.png',
