document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708955') {
                const d = {
                    nama_pemilik: 'SUHERNI SUKA***',
                    nomor_paspor: 'Passport  X9689446',
                    tanggal_lahir: '1976-07-03',
                    no_dokumen: 'E26-0003708955',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708955.png',
