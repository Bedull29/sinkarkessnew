document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708559') {
                const d = {
                    nama_pemilik: 'SITI AIS***',
                    nomor_paspor: 'Passport  X9297589',
                    tanggal_lahir: '1979-03-01',
                    no_dokumen: 'E26-0003708559',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708559.png',
