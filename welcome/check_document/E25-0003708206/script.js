document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708206') {
                const d = {
                    nama_pemilik: 'SRI SULARNI***',
                    nomor_paspor: 'Passport  X6297986',
                    tanggal_lahir: '1965-09-18',
                    no_dokumen: 'E25-0003708206',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708206.png',
