document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708874') {
                const d = {
                    nama_pemilik: 'ARIF RISKI HIDAYATUL***',
                    nomor_paspor: 'Passport  X9260626',
                    tanggal_lahir: '1997-11-09',
                    no_dokumen: 'E26-0003708874',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708874.png',
