document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708889') {
                const d = {
                    nama_pemilik: 'MUHAMMAD HAF***',
                    nomor_paspor: 'Passport  X9261179',
                    tanggal_lahir: '1991-05-06',
                    no_dokumen: 'E26-0003708889',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708889.png',
