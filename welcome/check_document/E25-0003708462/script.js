document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708462') {
                const d = {
                    nama_pemilik: 'ABDURRAHMAN NAWAWI KA***',
                    nomor_paspor: 'Passport  X9009019',
                    tanggal_lahir: '1982-04-13',
                    no_dokumen: 'E25-0003708462',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708462.png',
