document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709367') {
                const d = {
                    nama_pemilik: 'SITI RATMAYAH SABAN',
                    nomor_paspor: 'Passport  X9742***',
                    tanggal_lahir: '1983-01-24',
                    no_dokumen: 'E26-0003709367',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709367.png',
