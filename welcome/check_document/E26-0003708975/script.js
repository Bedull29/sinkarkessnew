document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708975') {
                const d = {
                    nama_pemilik: 'SARAH HA***',
                    nomor_paspor: 'Passport  X8506576',
                    tanggal_lahir: '1962-07-01',
                    no_dokumen: 'E26-0003708975',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708975.png',
