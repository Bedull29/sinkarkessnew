document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708508') {
                const d = {
                    nama_pemilik: 'ICHSAN IQBAL TRIHAR***',
                    nomor_paspor: 'Passport  X4596527',
                    tanggal_lahir: '2000-12-20',
                    no_dokumen: 'E26-0003708508',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708508.png',
