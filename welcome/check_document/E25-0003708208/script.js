document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708208') {
                const d = {
                    nama_pemilik: 'MAKBULLAH MAISAN KAT***',
                    nomor_paspor: 'Passport  E4247704',
                    tanggal_lahir: '1961-02-25',
                    no_dokumen: 'E25-0003708208',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708208.png',
