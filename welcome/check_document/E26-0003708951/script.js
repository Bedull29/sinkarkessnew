document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708951') {
                const d = {
                    nama_pemilik: 'ERVAL GEUSAN RAMA SAT***',
                    nomor_paspor: 'Passport  X3440840',
                    tanggal_lahir: '1998-11-20',
                    no_dokumen: 'E26-0003708951',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708951.png',
