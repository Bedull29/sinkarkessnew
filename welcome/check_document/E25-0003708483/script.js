document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708483') {
                const d = {
                    nama_pemilik: 'MUHAMMAD FIKRY SURY***',
                    nomor_paspor: 'Passport  X9008394',
                    tanggal_lahir: '2018-10-11',
                    no_dokumen: 'E25-0003708483',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708483.png',
