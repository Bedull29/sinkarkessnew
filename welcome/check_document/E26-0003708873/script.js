document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708873') {
                const d = {
                    nama_pemilik: 'YENNI ROSWITA ZAINUD***',
                    nomor_paspor: 'Passport  X9260627',
                    tanggal_lahir: '1974-11-27',
                    no_dokumen: 'E26-0003708873',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708873.png',
