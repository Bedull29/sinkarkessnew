document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708213') {
                const d = {
                    nama_pemilik: 'KARLI M***',
                    nomor_paspor: 'Passport  X7937593',
                    tanggal_lahir: '1966-10-28',
                    no_dokumen: 'E25-0003708213',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708213.png',
