document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708958') {
                const d = {
                    nama_pemilik: 'MUNIRAH PAR***',
                    nomor_paspor: 'Passport  X8497922',
                    tanggal_lahir: '1964-06-01',
                    no_dokumen: 'E26-0003708958',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708958.png',
