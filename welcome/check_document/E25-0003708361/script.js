document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708361') {
                const d = {
                    nama_pemilik: 'RISYAD AL YAS***',
                    nomor_paspor: 'Passport  E3051245',
                    tanggal_lahir: '2017-01-26',
                    no_dokumen: 'E25-0003708361',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708361.png',
