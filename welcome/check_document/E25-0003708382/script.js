document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708382') {
                const d = {
                    nama_pemilik: 'MASROYATI REB***',
                    nomor_paspor: 'Passport  E7428085',
                    tanggal_lahir: '1970-02-03',
                    no_dokumen: 'E25-0003708382',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708382.png',
