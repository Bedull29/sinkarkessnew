document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708122') {
                const d = {
                    nama_pemilik: 'UMMU YASA***',
                    nomor_paspor: 'Passport  X6612957',
                    tanggal_lahir: '1978-09-15',
                    no_dokumen: 'E25-0003708122',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2025-12-25',
                    valid_until: '2028-12-25',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708122.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2025-12-25',
                    valid_until2: '2026-12-25'
                };
