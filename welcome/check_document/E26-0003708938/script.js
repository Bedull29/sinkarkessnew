document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708938') {
                const d = {
                    nama_pemilik: 'DIAN LEST***',
                    nomor_paspor: 'Passport  X9702222',
                    tanggal_lahir: '2013-09-12',
                    no_dokumen: 'E26-0003708938',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708938.png',
