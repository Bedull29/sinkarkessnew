document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708318') {
                const d = {
                    nama_pemilik: 'HADI ***',
                    nomor_paspor: 'Passport  X2215242',
                    tanggal_lahir: '1987-10-28',
                    no_dokumen: 'E25-0003708318',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708318.png',
