document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708636') {
                const d = {
                    nama_pemilik: 'MURSIDI B BASE***',
                    nomor_paspor: 'Passport  X8506887',
                    tanggal_lahir: '1970-06-03',
                    no_dokumen: 'E26-0003708636',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708636.png',
