document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708510') {
                const d = {
                    nama_pemilik: 'SUKEMI ND***',
                    nomor_paspor: 'Passport  X8964884',
                    tanggal_lahir: '1977-05-10',
                    no_dokumen: 'E26-0003708510',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708510.png',
