document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708942') {
                const d = {
                    nama_pemilik: 'BAYANNIN TOM***',
                    nomor_paspor: 'Passport  X9701733',
                    tanggal_lahir: '1960-07-01',
                    no_dokumen: 'E26-0003708942',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708942.png',
