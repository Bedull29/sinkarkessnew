document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708612') {
                const d = {
                    nama_pemilik: 'MARLINA KARNA MAJ***',
                    nomor_paspor: 'Passport  X4646064',
                    tanggal_lahir: '1991-05-21',
                    no_dokumen: 'E26-0003708612',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708612.png',
