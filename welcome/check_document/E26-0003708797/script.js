document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708797') {
                const d = {
                    nama_pemilik: 'SUKARJO ABDUL A***',
                    nomor_paspor: 'Passport  X1562653',
                    tanggal_lahir: '1953-07-01',
                    no_dokumen: 'E26-0003708797',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708797.png',
