document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708703') {
                const d = {
                    nama_pemilik: 'ISMINAH ISM***',
                    nomor_paspor: 'Passport  X7136291',
                    tanggal_lahir: '1961-07-10',
                    no_dokumen: 'E26-0003708703',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708703.png',
