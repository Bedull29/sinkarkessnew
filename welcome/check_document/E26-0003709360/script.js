document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709360') {
                const d = {
                    nama_pemilik: 'RISA FA***',
                    nomor_paspor: 'Passport  C9046***',
                    tanggal_lahir: '1991-10-19',
                    no_dokumen: 'E26-0003709360',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709360.png',
