document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708519') {
                const d = {
                    nama_pemilik: 'RETNO PRAT***',
                    nomor_paspor: 'Passport  X9490379',
                    tanggal_lahir: '1966-07-23',
                    no_dokumen: 'E26-0003708519',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708519.png',
