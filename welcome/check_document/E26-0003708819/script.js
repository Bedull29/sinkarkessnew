document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708819') {
                const d = {
                    nama_pemilik: 'HAPSOH MUNIR DIMY***',
                    nomor_paspor: 'Passport  E8330348',
                    tanggal_lahir: '1968-08-06',
                    no_dokumen: 'E26-0003708819',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708819.png',
