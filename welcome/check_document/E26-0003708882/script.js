document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708882') {
                const d = {
                    nama_pemilik: 'RAHMIFIA USMAN MARHA***',
                    nomor_paspor: 'Passport  X8391932',
                    tanggal_lahir: '1990-01-08',
                    no_dokumen: 'E26-0003708882',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708882.png',
