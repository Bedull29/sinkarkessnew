document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708354') {
                const d = {
                    nama_pemilik: 'ABDULLAH AZYAM DHIYAA UL***',
                    nomor_paspor: 'Passport  E7171564',
                    tanggal_lahir: '2001-01-23',
                    no_dokumen: 'E25-0003708354',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708354.png',
