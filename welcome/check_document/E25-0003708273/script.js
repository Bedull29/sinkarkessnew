document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708273') {
                const d = {
                    nama_pemilik: 'SUDARNO SUMA***',
                    nomor_paspor: 'Passport  X7315254',
                    tanggal_lahir: '1974-11-10',
                    no_dokumen: 'E25-0003708273',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708273.png',
