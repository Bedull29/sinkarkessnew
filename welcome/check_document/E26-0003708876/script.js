document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708876') {
                const d = {
                    nama_pemilik: 'RUSDI ABDURRAHMAN BAN***',
                    nomor_paspor: 'Passport  E1163585',
                    tanggal_lahir: '1968-10-07',
                    no_dokumen: 'E26-0003708876',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708876.png',
