document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708555') {
                const d = {
                    nama_pemilik: 'AHMAD L***',
                    nomor_paspor: 'Passport  X9297587',
                    tanggal_lahir: '1969-04-23',
                    no_dokumen: 'E26-0003708555',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708555.png',
