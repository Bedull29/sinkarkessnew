document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708601') {
                const d = {
                    nama_pemilik: 'GAZALI TUTUNG U***',
                    nomor_paspor: 'Passport  E8004316',
                    tanggal_lahir: '1968-08-06',
                    no_dokumen: 'E26-0003708601',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708601.png',
