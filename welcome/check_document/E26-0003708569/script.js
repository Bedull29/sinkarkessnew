document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708569') {
                const d = {
                    nama_pemilik: 'MULIADI JAMJURI MUHAM***',
                    nomor_paspor: 'Passport  X8504875',
                    tanggal_lahir: '1968-04-20',
                    no_dokumen: 'E26-0003708569',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708569.png',
