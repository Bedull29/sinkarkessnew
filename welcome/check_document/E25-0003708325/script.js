document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708325') {
                const d = {
                    nama_pemilik: 'WARSI NUGRAHANI FAR***',
                    nomor_paspor: 'Passport  E5513343',
                    tanggal_lahir: '1983-02-15',
                    no_dokumen: 'E25-0003708325',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708325.png',
