document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708643') {
                const d = {
                    nama_pemilik: 'MAHRIANI TARIANI PU***',
                    nomor_paspor: 'Passport  X8508213',
                    tanggal_lahir: '1981-06-06',
                    no_dokumen: 'E26-0003708643',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708643.png',
