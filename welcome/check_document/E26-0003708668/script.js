document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708668') {
                const d = {
                    nama_pemilik: 'BASNIAH MASRI DA***',
                    nomor_paspor: 'Passport  X8508159',
                    tanggal_lahir: '1962-08-20',
                    no_dokumen: 'E26-0003708668',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708668.png',
