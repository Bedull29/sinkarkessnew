document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708137') {
                const d = {
                    nama_pemilik: 'HERU IBNU ATHOIL***',
                    nomor_paspor: 'Passport  X7555576',
                    tanggal_lahir: '2004-06-08',
                    no_dokumen: 'E25-0003708137',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708137.png',
