document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708614') {
                const d = {
                    nama_pemilik: 'FITRIANI ***',
                    nomor_paspor: 'Passport  X8507162',
                    tanggal_lahir: '1980-05-28',
                    no_dokumen: 'E26-0003708614',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708614.png',
