document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708520') {
                const d = {
                    nama_pemilik: 'SRI SULISTYOW***',
                    nomor_paspor: 'Passport  X9490354',
                    tanggal_lahir: '1974-02-25',
                    no_dokumen: 'E26-0003708520',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708520.png',
