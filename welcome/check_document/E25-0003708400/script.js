document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708400') {
                const d = {
                    nama_pemilik: 'GUNAWAN BIN JUM***',
                    nomor_paspor: 'Passport  X8075841',
                    tanggal_lahir: '1990-08-01',
                    no_dokumen: 'E25-0003708400',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708400.png',
