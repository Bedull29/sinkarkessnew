document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708459') {
                const d = {
                    nama_pemilik: 'SRI LEST***',
                    nomor_paspor: 'Passport  X9055812',
                    tanggal_lahir: '1972-01-21',
                    no_dokumen: 'E25-0003708459',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708459.png',
