document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708836') {
                const d = {
                    nama_pemilik: 'SITI MARD***',
                    nomor_paspor: 'Passport  E9922613',
                    tanggal_lahir: '1998-02-10',
                    no_dokumen: 'E26-0003708836',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708836.png',
