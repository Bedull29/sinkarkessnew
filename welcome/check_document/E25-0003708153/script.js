document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708153') {
                const d = {
                    nama_pemilik: 'SAMIYAH ABDUL RAZAK HAI***',
                    nomor_paspor: 'Passport  X1572395',
                    tanggal_lahir: '1974-10-27',
                    no_dokumen: 'E25-0003708153',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2025-12-26',
                    valid_until: '2028-12-26',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708153.png',
