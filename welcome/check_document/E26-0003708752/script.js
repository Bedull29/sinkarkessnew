document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708752') {
                const d = {
                    nama_pemilik: 'MARPUAH IN***',
                    nomor_paspor: 'Passport  X9559891',
                    tanggal_lahir: '1970-05-27',
                    no_dokumen: 'E26-0003708752',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708752.png',
