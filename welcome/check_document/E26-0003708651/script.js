document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708651') {
                const d = {
                    nama_pemilik: 'JARMAN JA***',
                    nomor_paspor: 'Passport  X8507897',
                    tanggal_lahir: '1942-08-01',
                    no_dokumen: 'E26-0003708651',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708651.png',
