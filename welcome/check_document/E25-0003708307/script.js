document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708307') {
                const d = {
                    nama_pemilik: 'HARUN WAHYU***',
                    nomor_paspor: 'Passport  X7931756',
                    tanggal_lahir: '1996-12-26',
                    no_dokumen: 'E25-0003708307',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708307.png',
