document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709337') {
                const d = {
                    nama_pemilik: 'SUCI ROKH***',
                    nomor_paspor: 'Passport  X9436***',
                    tanggal_lahir: '1985-05-28',
                    no_dokumen: 'E26-0003709337',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709337.png',
