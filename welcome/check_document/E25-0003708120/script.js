document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708120') {
                const d = {
                    nama_pemilik: 'RISNALDI ZAI***',
                    nomor_paspor: 'Passport  X5816500',
                    tanggal_lahir: '1965-10-11',
                    no_dokumen: 'E25-0003708120',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2025-12-24',
                    valid_until: '2028-12-24',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708120.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2025-12-24',
                    valid_until2: '2026-12-24'
                };
