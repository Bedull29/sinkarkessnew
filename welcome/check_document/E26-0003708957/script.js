document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708957') {
                const d = {
                    nama_pemilik: 'RUDI HERIYANTO ANANG SARK***',
                    nomor_paspor: 'Passport  X8490240',
                    tanggal_lahir: '1973-07-07',
                    no_dokumen: 'E26-0003708957',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708957.png',
