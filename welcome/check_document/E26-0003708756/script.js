document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708756') {
                const d = {
                    nama_pemilik: 'SUMARDI G MARTO DIHA***',
                    nomor_paspor: 'Passport  X9559839',
                    tanggal_lahir: '1950-05-10',
                    no_dokumen: 'E26-0003708756',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708756.png',
