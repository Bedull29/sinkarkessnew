document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708509') {
                const d = {
                    nama_pemilik: 'DHIAN TRI HAR***',
                    nomor_paspor: 'Passport  C9082630',
                    tanggal_lahir: '1973-03-25',
                    no_dokumen: 'E26-0003708509',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708509.png',
