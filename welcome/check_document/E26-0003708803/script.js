document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708803') {
                const d = {
                    nama_pemilik: 'SALMA KANNE HA***',
                    nomor_paspor: 'Passport  X8578611',
                    tanggal_lahir: '1952-02-02',
                    no_dokumen: 'E26-0003708803',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708803.png',
