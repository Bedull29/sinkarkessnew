document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708989') {
                const d = {
                    nama_pemilik: 'NAJMATUNNUR ABDUL***',
                    nomor_paspor: 'Passport  E6994239',
                    tanggal_lahir: '1972-06-29',
                    no_dokumen: 'E26-0003708989',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708989.png',
