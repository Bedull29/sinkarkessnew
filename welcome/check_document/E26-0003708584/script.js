document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708584') {
                const d = {
                    nama_pemilik: 'FADLI IRAM SA***',
                    nomor_paspor: 'Passport  X8505177',
                    tanggal_lahir: '1958-08-01',
                    no_dokumen: 'E26-0003708584',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708584.png',
