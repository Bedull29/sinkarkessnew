document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709382') {
                const d = {
                    nama_pemilik: 'JEVI AR***',
                    nomor_paspor: 'Passport  E0257***',
                    tanggal_lahir: '1985-04-12',
                    no_dokumen: 'E26-0003709382',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709382.png',
