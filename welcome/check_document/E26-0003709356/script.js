document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709356') {
                const d = {
                    nama_pemilik: 'WARNI JAMI TOKR***',
                    nomor_paspor: 'Passport  E8441***',
                    tanggal_lahir: '1979-07-18',
                    no_dokumen: 'E26-0003709356',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709356.png',
