document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708743') {
                const d = {
                    nama_pemilik: 'HISAMUDIN UMARROGHIB SAR***',
                    nomor_paspor: 'Passport  X8954909',
                    tanggal_lahir: '1969-06-20',
                    no_dokumen: 'E26-0003708743',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708743.png',
