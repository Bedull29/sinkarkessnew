document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708623') {
                const d = {
                    nama_pemilik: 'MASITAH MAH***',
                    nomor_paspor: 'Passport  X8507590',
                    tanggal_lahir: '1975-05-10',
                    no_dokumen: 'E26-0003708623',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708623.png',
