document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708286') {
                const d = {
                    nama_pemilik: 'AMIEN SUHENDRA KE***',
                    nomor_paspor: 'Passport  X3518622',
                    tanggal_lahir: '1974-07-06',
                    no_dokumen: 'E25-0003708286',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2024-08-22',
                    valid_until: '2027-09-05',
                    faskes: 'KLINIK KIMIA FARMA CIPONDOH',
                    dokter: 'DR. SAMSU BUNTORO',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708286.png',
