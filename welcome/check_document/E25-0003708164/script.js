document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708164') {
                const d = {
                    nama_pemilik: 'SYARIFAH ALI***',
                    nomor_paspor: 'Passport  X7601121',
                    tanggal_lahir: '1974-07-07',
                    no_dokumen: 'E25-0003708164',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-01-05',
                    valid_until: '2029-01-05',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708164.png',

                    // Polio data
                    jenis_vaksin2: 'POLIO',
                    tanggal_vaksin2: '2026-01-05',
                    valid_until2: '2027-01-05'
                };
