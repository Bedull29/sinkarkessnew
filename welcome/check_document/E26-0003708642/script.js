document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708642') {
                const d = {
                    nama_pemilik: 'AHMAD FA***',
                    nomor_paspor: 'Passport  X8506965',
                    tanggal_lahir: '2000-08-15',
                    no_dokumen: 'E26-0003708642',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708642.png',
