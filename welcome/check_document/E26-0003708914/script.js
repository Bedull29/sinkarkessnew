document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708914') {
                const d = {
                    nama_pemilik: 'MASTIANAH MUR***',
                    nomor_paspor: 'Passport  X9781203',
                    tanggal_lahir: '1972-10-20',
                    no_dokumen: 'E26-0003708914',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708914.png',
