document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708514') {
                const d = {
                    nama_pemilik: 'NURYATUN KA***',
                    nomor_paspor: 'Passport  X8964930',
                    tanggal_lahir: '1965-12-27',
                    no_dokumen: 'E26-0003708514',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708514.png',
