document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708645') {
                const d = {
                    nama_pemilik: 'HAMI JAMA***',
                    nomor_paspor: 'Passport  X8507896',
                    tanggal_lahir: '1963-07-01',
                    no_dokumen: 'E26-0003708645',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708645.png',
