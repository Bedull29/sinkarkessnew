document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708794') {
                const d = {
                    nama_pemilik: 'IBNU KA***',
                    nomor_paspor: 'Passport  X9700543',
                    tanggal_lahir: '1962-12-07',
                    no_dokumen: 'E26-0003708794',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708794.png',
