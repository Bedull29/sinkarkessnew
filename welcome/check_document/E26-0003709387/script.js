document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709387') {
                const d = {
                    nama_pemilik: 'MUHAMMAD KHAIZAN ISMAIL MA***',
                    nomor_paspor: 'Passport  X7340***',
                    tanggal_lahir: '2025-06-25',
                    no_dokumen: 'E26-0003709387',
                    jenis_vaksin: 'MENINGITIS MENINGOCOCCUS',
                    tanggal_vaksin: '2026-09-03',
                    valid_until: '2029-09-03',
                    faskes: 'Klinik Utama CT-Klinik',
                    dokter: 'MASAYU PRAKASITA, MD',
                    // Use the image currently in the HTML
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709387.png',
