document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708506') {
                const d = {
                    nama_pemilik: 'SRI MUHAR***',
                    nomor_paspor: 'Passport  X8964880',
                    tanggal_lahir: '1962-07-06',
                    no_dokumen: 'E26-0003708506',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708506.png',
