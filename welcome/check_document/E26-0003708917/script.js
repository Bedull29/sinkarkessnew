document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708917') {
                const d = {
                    nama_pemilik: 'ROJALIK AH***',
                    nomor_paspor: 'Passport  X9781234',
                    tanggal_lahir: '1972-11-02',
                    no_dokumen: 'E26-0003708917',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708917.png',
