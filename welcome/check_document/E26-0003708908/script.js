document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708908') {
                const d = {
                    nama_pemilik: 'UNDANG HOLIL A***',
                    nomor_paspor: 'Passport  X8985576',
                    tanggal_lahir: '1953-10-03',
                    no_dokumen: 'E26-0003708908',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708908.png',
