document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708255') {
                const d = {
                    nama_pemilik: 'NURAMALA MAH***',
                    nomor_paspor: 'Passport  X5354590',
                    tanggal_lahir: '1968-07-10',
                    no_dokumen: 'E25-0003708255',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708255.png',
