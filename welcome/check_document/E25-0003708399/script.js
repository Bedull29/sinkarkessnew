document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708399') {
                const d = {
                    nama_pemilik: 'AFANDI HA***',
                    nomor_paspor: 'Passport  X8526530',
                    tanggal_lahir: '1979-02-24',
                    no_dokumen: 'E25-0003708399',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708399.png',
