document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708542') {
                const d = {
                    nama_pemilik: 'AHMAD ADH***',
                    nomor_paspor: 'Passport  X8507289',
                    tanggal_lahir: '1992-06-11',
                    no_dokumen: 'E26-0003708542',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708542.png',
