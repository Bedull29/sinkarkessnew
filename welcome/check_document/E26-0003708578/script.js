document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708578') {
                const d = {
                    nama_pemilik: 'AHMAD RISWAN KURNIA***',
                    nomor_paspor: 'Passport  X8506423',
                    tanggal_lahir: '2004-04-16',
                    no_dokumen: 'E26-0003708578',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708578.png',
