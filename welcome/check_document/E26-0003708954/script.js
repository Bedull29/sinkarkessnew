document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708954') {
                const d = {
                    nama_pemilik: 'ERLI ANTA***',
                    nomor_paspor: 'Passport  X9689447',
                    tanggal_lahir: '1966-07-05',
                    no_dokumen: 'E26-0003708954',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708954.png',
