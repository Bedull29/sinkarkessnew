document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708546') {
                const d = {
                    nama_pemilik: 'SALMAN AL FARISI RUS***',
                    nomor_paspor: 'Passport  E8369501',
                    tanggal_lahir: '2002-10-07',
                    no_dokumen: 'E26-0003708546',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708546.png',
