document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708840') {
                const d = {
                    nama_pemilik: 'AHMAD SANUSI MAS***',
                    nomor_paspor: 'Passport  E4982491',
                    tanggal_lahir: '1978-02-21',
                    no_dokumen: 'E26-0003708840',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708840.png',
