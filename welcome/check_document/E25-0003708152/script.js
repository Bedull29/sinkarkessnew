document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708152') {
                const d = {
                    nama_pemilik: 'MURTANIH MINUN KE***',
                    nomor_paspor: 'Passport  C9734416',
                    tanggal_lahir: '1962-05-07',
                    no_dokumen: 'E25-0003708152',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708152.png',
