document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708300') {
                const d = {
                    nama_pemilik: 'FURQON MIS***',
                    nomor_paspor: 'Passport  X8063947',
                    tanggal_lahir: '1998-11-17',
                    no_dokumen: 'E25-0003708300',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708300.png',
