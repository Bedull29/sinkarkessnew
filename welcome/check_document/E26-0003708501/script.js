document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708501') {
                const d = {
                    nama_pemilik: 'MUHAMMAD ROCH***',
                    nomor_paspor: 'Passport  X8470126',
                    tanggal_lahir: '1968-07-10',
                    no_dokumen: 'E26-0003708501',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708501.png',
