document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708552') {
                const d = {
                    nama_pemilik: 'ENTIN DULMUTI A***',
                    nomor_paspor: 'Passport  X8921776',
                    tanggal_lahir: '1964-02-12',
                    no_dokumen: 'E26-0003708552',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708552.png',
