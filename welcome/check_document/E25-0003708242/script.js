document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708242') {
                const d = {
                    nama_pemilik: 'MUIZ SIROJUL MU***',
                    nomor_paspor: 'Passport  X7040003',
                    tanggal_lahir: '1997-02-04',
                    no_dokumen: 'E25-0003708242',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708242.png',
