document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708694') {
                const d = {
                    nama_pemilik: 'WAKIYEM RESO PAW***',
                    nomor_paspor: 'Passport  X7136209',
                    tanggal_lahir: '1950-09-07',
                    no_dokumen: 'E26-0003708694',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708694.png',
