document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708613') {
                const d = {
                    nama_pemilik: 'NOR ANN***',
                    nomor_paspor: 'Passport  X8383217',
                    tanggal_lahir: '2000-03-11',
                    no_dokumen: 'E26-0003708613',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708613.png',
