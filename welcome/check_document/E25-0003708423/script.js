document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708423') {
                const d = {
                    nama_pemilik: 'MOH SURYA ALDZI***',
                    nomor_paspor: 'Passport  E9398922',
                    tanggal_lahir: '2010-05-16',
                    no_dokumen: 'E25-0003708423',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708423.png',
