document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708677') {
                const d = {
                    nama_pemilik: 'JAINAH A***',
                    nomor_paspor: 'Passport  X8506491',
                    tanggal_lahir: '1975-12-18',
                    no_dokumen: 'E26-0003708677',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708677.png',
