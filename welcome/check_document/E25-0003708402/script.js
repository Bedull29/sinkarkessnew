document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708402') {
                const d = {
                    nama_pemilik: 'CANDRA WIJAYA SIN***',
                    nomor_paspor: 'Passport  X8075889',
                    tanggal_lahir: '1992-10-15',
                    no_dokumen: 'E25-0003708402',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708402.png',
