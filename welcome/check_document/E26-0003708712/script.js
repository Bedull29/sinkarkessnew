document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708712') {
                const d = {
                    nama_pemilik: 'NURJANAH KAL***',
                    nomor_paspor: 'Passport  X7136079',
                    tanggal_lahir: '1965-10-05',
                    no_dokumen: 'E26-0003708712',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708712.png',
