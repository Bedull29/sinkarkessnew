document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708141') {
                const d = {
                    nama_pemilik: 'MUHAMAD TAUFIQUR RAH***',
                    nomor_paspor: 'Passport  X7256634',
                    tanggal_lahir: '2002-07-29',
                    no_dokumen: 'E25-0003708141',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708141.png',
