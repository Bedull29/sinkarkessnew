document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708862') {
                const d = {
                    nama_pemilik: 'DIAH LU***',
                    nomor_paspor: 'Passport  X7940718',
                    tanggal_lahir: '1952-07-16',
                    no_dokumen: 'E26-0003708862',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708862.png',
