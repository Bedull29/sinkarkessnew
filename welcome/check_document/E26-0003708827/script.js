document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708827') {
                const d = {
                    nama_pemilik: 'RAHIMAH A***',
                    nomor_paspor: 'Passport  E9922563',
                    tanggal_lahir: '1976-10-05',
                    no_dokumen: 'E26-0003708827',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708827.png',
