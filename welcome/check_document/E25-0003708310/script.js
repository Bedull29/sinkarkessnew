document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708310') {
                const d = {
                    nama_pemilik: 'AZIZAH ROMDHONI SYA***',
                    nomor_paspor: 'Passport  X7315966',
                    tanggal_lahir: '1959-08-11',
                    no_dokumen: 'E25-0003708310',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708310.png',
