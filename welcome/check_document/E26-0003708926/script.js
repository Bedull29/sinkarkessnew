document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708926') {
                const d = {
                    nama_pemilik: 'SUPRAPTI SUTA***',
                    nomor_paspor: 'Passport  X7136245',
                    tanggal_lahir: '1979-09-20',
                    no_dokumen: 'E26-0003708926',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708926.png',
