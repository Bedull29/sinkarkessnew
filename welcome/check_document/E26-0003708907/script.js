document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708907') {
                const d = {
                    nama_pemilik: 'OOM SUKANDAR IMYA***',
                    nomor_paspor: 'Passport  X8986737',
                    tanggal_lahir: '1959-08-05',
                    no_dokumen: 'E26-0003708907',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708907.png',
