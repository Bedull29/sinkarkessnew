document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709339') {
                const d = {
                    nama_pemilik: 'SUBAEDA HAMAL ABUL***',
                    nomor_paspor: 'Passport  X8997***',
                    tanggal_lahir: '1965-07-20',
                    no_dokumen: 'E26-0003709339',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709339.png',
