document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708730') {
                const d = {
                    nama_pemilik: 'JAIKUN KROMO R***',
                    nomor_paspor: 'Passport  X7136211',
                    tanggal_lahir: '1959-08-10',
                    no_dokumen: 'E26-0003708730',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708730.png',
