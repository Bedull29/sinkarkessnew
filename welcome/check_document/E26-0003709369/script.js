document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709369') {
                const d = {
                    nama_pemilik: 'ARLITA BANING SETIA J***',
                    nomor_paspor: 'Passport  X7584***',
                    tanggal_lahir: '1991-10-10',
                    no_dokumen: 'E26-0003709369',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709369.png',
