document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708154') {
                const d = {
                    nama_pemilik: 'MANTO PARTO SENT***',
                    nomor_paspor: 'Passport  X7258452',
                    tanggal_lahir: '1971-08-10',
                    no_dokumen: 'E25-0003708154',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708154.png',
