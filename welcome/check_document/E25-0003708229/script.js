document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708229') {
                const d = {
                    nama_pemilik: 'ARINI SETIAW***',
                    nomor_paspor: 'Passport  X7693569',
                    tanggal_lahir: '1988-04-30',
                    no_dokumen: 'E25-0003708229',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708229.png',
