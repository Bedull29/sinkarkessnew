document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708814') {
                const d = {
                    nama_pemilik: 'JUHAINI GASS***',
                    nomor_paspor: 'Passport  X8578612',
                    tanggal_lahir: '1947-01-01',
                    no_dokumen: 'E26-0003708814',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708814.png',
