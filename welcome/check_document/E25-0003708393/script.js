document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708393') {
                const d = {
                    nama_pemilik: 'SUYATI JA***',
                    nomor_paspor: 'Passport  X3601521',
                    tanggal_lahir: '1973-04-24',
                    no_dokumen: 'E25-0003708393',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708393.png',
