document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708666') {
                const d = {
                    nama_pemilik: 'MUSTAFA RAH***',
                    nomor_paspor: 'Passport  E8378650',
                    tanggal_lahir: '1964-04-13',
                    no_dokumen: 'E26-0003708666',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708666.png',
