document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003709377') {
                const d = {
                    nama_pemilik: 'MOH SAHIRUN MUKA***',
                    nomor_paspor: 'Passport  E5899***',
                    tanggal_lahir: '1965-05-13',
                    no_dokumen: 'E26-0003709377',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003709377.png',
