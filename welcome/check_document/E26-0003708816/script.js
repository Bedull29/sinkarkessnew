document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708816') {
                const d = {
                    nama_pemilik: 'NY ICIH YA***',
                    nomor_paspor: 'Passport  E2120782',
                    tanggal_lahir: '1955-06-09',
                    no_dokumen: 'E26-0003708816',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708816.png',
