document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E25-0003708408') {
                const d = {
                    nama_pemilik: 'JUMARI MULIODIM***',
                    nomor_paspor: 'Passport  X8072428',
                    tanggal_lahir: '1959-12-31',
                    no_dokumen: 'E25-0003708408',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E25-0003708408.png',
