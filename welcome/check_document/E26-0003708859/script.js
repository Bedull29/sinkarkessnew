document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnCari) {
        btnCari.addEventListener("click", function (e) {
            ...
            if (jenisDokumen === 'icv' && noDokumen === 'E26-0003708859') {
                const d = {
                    nama_pemilik: 'ADE ROHYA***',
                    nomor_paspor: 'Passport  X7938087',
                    tanggal_lahir: '1968-08-11',
                    no_dokumen: 'E26-0003708859',
                    ...
                    qr_code: 'https://raw.githubusercontent.com/sinkarkess/subdomain/refs/heads/main/QR/qr-E26-0003708859.png',
